...
@DebugMetadata(c = "com.rootguard.app.data.local.IsolationDataStore$saveIsolationConfigs$2", f = "IsolationDataStore.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: C:\Users\Administrator\Desktop\新建文件夹 (2)\installed_decode\classes10.dex */
final class IsolationDataStore$saveIsolationConfigs$2 extends SuspendLambda implements Function2<MutablePreferences, Continuation<? super Unit>, Object> {
    final /* synthetic */ List<IsolationConfig> $configs;
    ...
    public IsolationDataStore$saveIsolationConfigs$2(List<IsolationConfig> list, IsolationDataStore isolationDataStore, Continuation<? super IsolationDataStore$saveIsolationConfigs$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        Continuation<Unit> isolationDataStore$saveIsolationConfigs$2 = new IsolationDataStore$saveIsolationConfigs$2(this.$configs, this.this$0, continuation);
        isolationDataStore$saveIsolationConfigs$2.L$0 = obj;
        return isolationDataStore$saveIsolationConfigs$2;
    }
        ...
        switch (this.label) {
            case 0:
                ...
                try {
                    ...
                    Iterable $this$forEach$iv = this.$configs;
                    for (Object element$iv : $this$forEach$iv) {
                        final IsolationConfig newConfig = (IsolationConfig) element$iv;
                        CollectionsKt.removeAll(configList, new Function1<IsolationConfig, Boolean>() { // from class: com.rootguard.app.data.local.IsolationDataStore$saveIsolationConfigs$2$1$1
                            /* JADX INFO: Access modifiers changed from: package-private */
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            {
                                super(1);
                            ...
                            public final Boolean invoke(IsolationConfig it) {
                                ...
                                return Boolean.valueOf(Intrinsics.areEqual(it.getPackageName(), newConfig.getPackageName()));
                            }
                        });
                    }
                    configList.addAll(this.$configs);
                    ...
                    Logger.INSTANCE.d("Batch saved " + this.$configs.size() + " isolation configs");
                } catch (Exception e2) {
                    Logger.INSTANCE.e("Failed to batch save isolation configs", e2);
                }
