...
.method public bridge synthetic invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, v0}, Landroidx/compose/foundation/gestures/TransformableKt$transformable$$inlined$debugInspectorInfo$1;->invoke(Landroidx/compose/ui/platform/InspectorInfo;)V
...
.method public final invoke(Landroidx/compose/ui/platform/InspectorInfo;)V
    ...
    .local v0, "$this$transformable_u24lambda_u240":Landroidx/compose/ui/platform/InspectorInfo;
    const/4 v1, 0x0

    .line 171
    .local v1, "$i$a$-debugInspectorInfo-TransformableKt$transformable$2":I
    const-string/jumbo v2, "transformable"
    ...
    iget-object v4, p0, Landroidx/compose/foundation/gestures/TransformableKt$transformable$$inlined$debugInspectorInfo$1;->$state$inlined:Landroidx/compose/foundation/gestures/TransformableState;
    ...
    const-string/jumbo v3, "canPan"

    iget-object v4, p0, Landroidx/compose/foundation/gestures/TransformableKt$transformable$$inlined$debugInspectorInfo$1;->$canPan$inlined:Lkotlin/jvm/functions/Function0;
    ...
    iget-boolean v3, p0, Landroidx/compose/foundation/gestures/TransformableKt$transformable$$inlined$debugInspectorInfo$1;->$enabled$inlined:Z
    ...
    iget-boolean v3, p0, Landroidx/compose/foundation/gestures/TransformableKt$transformable$$inlined$debugInspectorInfo$1;->$lockRotationOnZoomPan$inlined:Z

    invoke-static {v3}, Ljava/lang/Boolean;->valueOf(Z)Ljava/lang/Boolean;

    move-result-object v3

    const-string/jumbo v4, "lockRotationOnZoomPan"
    ...
    .line 135
    .end local v0    # "$this$transformable_u24lambda_u240":Landroidx/compose/ui/platform/InspectorInfo;
    .end local v1    # "$i$a$-debugInspectorInfo-TransformableKt$transformable$2":I
    return-void
.end method
