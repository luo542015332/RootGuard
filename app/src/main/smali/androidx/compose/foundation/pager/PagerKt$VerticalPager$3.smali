...
.method constructor <init>(ILandroidx/compose/ui/Modifier;Landroidx/compose/foundation/pager/PagerState;Landroidx/compose/foundation/layout/PaddingValues;Landroidx/compose/foundation/pager/PageSize;IFLandroidx/compose/ui/Alignment$Horizontal;Landroidx/compose/foundation/gestures/snapping/SnapFlingBehavior;ZZLkotlin/jvm/functions/Function1;Landroidx/compose/ui/input/nestedscroll/NestedScrollConnection;Lkotlin/jvm/functions/Function4;III)V
    ...
    iput-object v2, v0, Landroidx/compose/foundation/pager/PagerKt$VerticalPager$3;->$modifier:Landroidx/compose/ui/Modifier;

    move-object/from16 v3, p3

    iput-object v3, v0, Landroidx/compose/foundation/pager/PagerKt$VerticalPager$3;->$state:Landroidx/compose/foundation/pager/PagerState;

    move-object/from16 v4, p4

    iput-object v4, v0, Landroidx/compose/foundation/pager/PagerKt$VerticalPager$3;->$contentPadding:Landroidx/compose/foundation/layout/PaddingValues;

    move-object/from16 v5, p5

    iput-object v5, v0, Landroidx/compose/foundation/pager/PagerKt$VerticalPager$3;->$pageSize:Landroidx/compose/foundation/pager/PageSize;

    move/from16 v6, p6

    iput v6, v0, Landroidx/compose/foundation/pager/PagerKt$VerticalPager$3;->$beyondBoundsPageCount:I

    move/from16 v7, p7

    iput v7, v0, Landroidx/compose/foundation/pager/PagerKt$VerticalPager$3;->$pageSpacing:F

    move-object/from16 v8, p8

    iput-object v8, v0, Landroidx/compose/foundation/pager/PagerKt$VerticalPager$3;->$horizontalAlignment:Landroidx/compose/ui/Alignment$Horizontal;

    move-object/from16 v9, p9

    iput-object v9, v0, Landroidx/compose/foundation/pager/PagerKt$VerticalPager$3;->$flingBehavior:Landroidx/compose/foundation/gestures/snapping/SnapFlingBehavior;

    move/from16 v10, p10

    iput-boolean v10, v0, Landroidx/compose/foundation/pager/PagerKt$VerticalPager$3;->$userScrollEnabled:Z

    move/from16 v11, p11

    iput-boolean v11, v0, Landroidx/compose/foundation/pager/PagerKt$VerticalPager$3;->$reverseLayout:Z

    move-object/from16 v12, p12

    iput-object v12, v0, Landroidx/compose/foundation/pager/PagerKt$VerticalPager$3;->$key:Lkotlin/jvm/functions/Function1;

    move-object/from16 v13, p13

    iput-object v13, v0, Landroidx/compose/foundation/pager/PagerKt$VerticalPager$3;->$pageNestedScrollConnection:Landroidx/compose/ui/input/nestedscroll/NestedScrollConnection;

    move-object/from16 v14, p14

    iput-object v14, v0, Landroidx/compose/foundation/pager/PagerKt$VerticalPager$3;->$pageContent:Lkotlin/jvm/functions/Function4;

    move/from16 v15, p15

    iput v15, v0, Landroidx/compose/foundation/pager/PagerKt$VerticalPager$3;->$$changed:I
...
.method public bridge synthetic invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, v0, v1}, Landroidx/compose/foundation/pager/PagerKt$VerticalPager$3;->invoke(Landroidx/compose/runtime/Composer;I)V
