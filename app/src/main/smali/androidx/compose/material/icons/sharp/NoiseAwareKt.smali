...
.method public static final getNoiseAware(Landroidx/compose/material/icons/Icons$Sharp;)Landroidx/compose/ui/graphics/vector/ImageVector;
    ...
    .local v2, "$this$_get_NoiseAware__u24lambda_u2416":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v3, 0x0

    .line 30
    .local v3, "$i$a$-materialIcon-NoiseAwareKt$NoiseAware$1":I
    move-object v4, v2
    ...
    invoke-virtual {v15, v0, v9}, Landroidx/compose/ui/graphics/vector/PathBuilder;->moveToRelative(FF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .local v13, "$this$_get_NoiseAware__u24lambda_u2416_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v22, 0x0
    ...
    .end local v13    # "$this$_get_NoiseAware__u24lambda_u2416_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .local v13, "$this$_get_NoiseAware__u24lambda_u2416_u24lambda_u243":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v22, 0x0
    ...
    .end local v13    # "$this$_get_NoiseAware__u24lambda_u2416_u24lambda_u243":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .local v13, "$this$_get_NoiseAware__u24lambda_u2416_u24lambda_u244":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v22, 0x0
    ...
    .end local v13    # "$this$_get_NoiseAware__u24lambda_u2416_u24lambda_u244":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .local v13, "$this$_get_NoiseAware__u24lambda_u2416_u24lambda_u245":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v22, 0x0
    ...
    invoke-virtual {v13, v15, v1}, Landroidx/compose/ui/graphics/vector/PathBuilder;->lineTo(FF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .end local v13    # "$this$_get_NoiseAware__u24lambda_u2416_u24lambda_u245":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 89
    .local v13, "$i$a$-materialPath-YwgOQQI$default-NoiseAwareKt$NoiseAware$1$7":I
    ...
    const v50, 0x3ee147ae    # 0.44f

    const v51, 0x3ff9999a    # 1.95f
    ...
    .line 93
    const v46, 0x4088a3d7    # 4.27f

    const v47, 0x4161eb85    # 14.12f

    const v48, 0x4083851f    # 4.11f

    const v49, 0x4157851f    # 13.47f

    const v50, 0x408147ae    # 4.04f

    const v51, 0x414ca3d7    # 12.79f
    ...
    .end local v13    # "$i$a$-materialPath-YwgOQQI$default-NoiseAwareKt$NoiseAware$1$7":I
    ...
    .local v13, "$this$_get_NoiseAware__u24lambda_u2416_u24lambda_u247":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v17, 0x0
    ...
    .line 98
    const v46, -0x40ee147b    # -0.57f

    const v47, -0x414ccccd    # -0.35f

    const v48, -0x406a3d71    # -1.17f

    const v49, -0x40dc28f6    # -0.64f
    ...
    .end local v13    # "$this$_get_NoiseAware__u24lambda_u2416_u24lambda_u247":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 105
    .local v13, "$i$a$-materialPath-YwgOQQI$default-NoiseAwareKt$NoiseAware$1$9":I
    ...
    .line 107
    const v46, 0x414ab852    # 12.67f

    const v47, 0x400147ae    # 2.02f

    const v48, 0x414570a4    # 12.34f
    ...
    .end local v3    # "$i$a$-materialIcon-NoiseAwareKt$NoiseAware$1":I
    .local v52, "$i$a$-materialIcon-NoiseAwareKt$NoiseAware$1":I
    const v3, 0x3ca3d70a    # 0.02f

    invoke-virtual {v12, v1, v3, v15, v0}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveToRelative(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 110
    const v46, 0x413547ae    # 11.33f

    const v47, 0x4080f5c3    # 4.03f

    const v48, 0x413a8f5c    # 11.66f
    ...
    invoke-virtual {v12, v3, v0, v15, v1}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveTo(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .end local v13    # "$i$a$-materialPath-YwgOQQI$default-NoiseAwareKt$NoiseAware$1$9":I
    sget-object v0, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;
    ...
    invoke-virtual {v11, v13, v15, v0, v1}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveTo(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 129
    const v46, 0x419f1eb8    # 19.89f

    const v47, 0x4157851f    # 13.47f

    const v48, 0x419dd70a    # 19.73f

    const v49, 0x4161eb85    # 14.12f

    const v50, 0x419c147b    # 19.51f

    const v51, 0x416bd70a    # 14.74f
    ...
    .line 137
    const v46, 0x419dd70a    # 19.73f

    const v47, 0x411e147b    # 9.88f

    const v48, 0x419f1eb8    # 19.89f

    const v49, 0x41287ae1    # 10.53f

    const v50, 0x419fae14    # 19.96f

    const v51, 0x41335c29    # 11.21f
    ...
    .line 145
    const v44, 0x4193c28f    # 18.47f

    const v45, 0x4185d70a    # 16.73f

    const v46, 0x41906666    # 18.05f

    const v47, 0x418a147b    # 17.26f

    const v48, 0x418ca3d7    # 17.58f

    const v49, 0x418dd70a    # 17.73f
    ...
    const v48, 0x3fe66666    # 1.8f

    const v49, 0x3f5eb852    # 0.87f
    ...
    const v48, -0x4019999a    # -1.8f

    const v49, -0x40a147ae    # -0.87f
    ...
    .line 161
    const v44, 0x417c7ae1    # 15.78f

    const v45, 0x41988f5c    # 19.07f

    const v46, 0x4172e148    # 15.18f

    const v47, 0x419ae148    # 19.36f

    const v48, 0x4168a3d7    # 14.54f

    const v49, 0x419ca3d7    # 19.58f
    ...
    .line 178
    .end local v2    # "$this$_get_NoiseAware__u24lambda_u2416":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .end local v52    # "$i$a$-materialIcon-NoiseAwareKt$NoiseAware$1":I
