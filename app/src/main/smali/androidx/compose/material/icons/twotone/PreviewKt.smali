...
.method public static final getPreview(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;
    ...
    .local v2, "$this$_get_Preview__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v3, 0x0

    .line 30
    .local v3, "$i$a$-materialIcon-PreviewKt$Preview$1":I
    ...
    const v11, 0x4168a3d7    # 14.54f

    move/from16 v42, v3

    .end local v3    # "$i$a$-materialIcon-PreviewKt$Preview$1":I
    .local v42, "$i$a$-materialIcon-PreviewKt$Preview$1":I
    ...
    invoke-virtual {v0, v1, v11, v3, v4}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveTo(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    invoke-virtual {v0, v3, v4, v11, v1}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveToRelative(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    invoke-virtual {v0, v3, v4, v11, v4}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveToRelative(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .local v15, "$this$_get_Preview__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v22, 0x0

    .line 57
    .local v22, "$i$a$-materialPath-YwgOQQI$default-PreviewKt$Preview$1$2":I
    ...
    .end local v15    # "$this$_get_Preview__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v3, "$this$_get_Preview__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    invoke-virtual {v3, v15, v11, v1, v0}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveToRelative(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    invoke-virtual {v3, v1, v0, v11, v0}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveToRelative(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 167
    .end local v3    # "$this$_get_Preview__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v22    # "$i$a$-materialPath-YwgOQQI$default-PreviewKt$Preview$1$2":I
    nop
    ...
    .line 98
    .end local v2    # "$this$_get_Preview__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .end local v42    # "$i$a$-materialIcon-PreviewKt$Preview$1":I
