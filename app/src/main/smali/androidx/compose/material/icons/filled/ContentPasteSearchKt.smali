...
.method public static final getContentPasteSearch(Landroidx/compose/material/icons/Icons$Filled;)Landroidx/compose/ui/graphics/vector/ImageVector;
    ...
    .local v2, "$this$_get_ContentPasteSearch__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v3, 0x0

    .line 30
    .local v3, "$i$a$-materialIcon-ContentPasteSearchKt$ContentPasteSearch$1":I
    move-object v4, v2
    ...
    .local v9, "$this$_get_ContentPasteSearch__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .end local v3    # "$i$a$-materialIcon-ContentPasteSearchKt$ContentPasteSearch$1":I
    .local v42, "$i$a$-materialIcon-ContentPasteSearchKt$ContentPasteSearch$1":I
    invoke-virtual {v9, v1, v12, v0, v3}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveTo(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    invoke-virtual {v9, v1, v3}, Landroidx/compose/ui/graphics/vector/PathBuilder;->moveTo(FF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    invoke-virtual {v9, v3, v0, v12, v0}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveToRelative(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;

    .line 56
    invoke-virtual {v9, v12, v3, v12, v12}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveToRelative(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    invoke-virtual {v9, v0, v3, v1, v3}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveTo(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 115
    .end local v9    # "$this$_get_ContentPasteSearch__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 61
    .local v13, "$i$a$-materialPath-YwgOQQI$default-ContentPasteSearchKt$ContentPasteSearch$1$2":I
    ...
    .end local v13    # "$i$a$-materialPath-YwgOQQI$default-ContentPasteSearchKt$ContentPasteSearch$1$2":I
    nop
    ...
    .line 84
    .end local v2    # "$this$_get_ContentPasteSearch__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .end local v42    # "$i$a$-materialIcon-ContentPasteSearchKt$ContentPasteSearch$1":I
