...
.method private final getLookaheadOffset-F1C5BW0()J
    ...
    .line 73
    .local v1, "$i$a$-let-LookaheadLayoutCoordinatesImpl$lookaheadOffset$1":I
    ...
    invoke-virtual {p0, v2, v3, v4}, Landroidx/compose/ui/layout/LookaheadLayoutCoordinatesImpl;->localPositionOf-R5De75A(Landroidx/compose/ui/layout/LayoutCoordinates;J)J
    ...
    .end local v1    # "$i$a$-let-LookaheadLayoutCoordinatesImpl$lookaheadOffset$1":I
    nop
...
.method public getParentCoordinates()Landroidx/compose/ui/layout/LayoutCoordinates;
    ...
    .line 64
    .local v0, "$i$a$-check-LookaheadLayoutCoordinatesImpl$parentCoordinates$1":I
    nop

    .end local v0    # "$i$a$-check-LookaheadLayoutCoordinatesImpl$parentCoordinates$1":I
...
.method public getParentLayoutCoordinates()Landroidx/compose/ui/layout/LayoutCoordinates;
    ...
    .line 59
    .local v2, "$i$a$-let-LookaheadLayoutCoordinatesImpl$parentLayoutCoordinates$2":I
    invoke-virtual {v0}, Landroidx/compose/ui/node/NodeCoordinator;->getLookaheadDelegate()Landroidx/compose/ui/node/LookaheadDelegate;
    ...
    .line 57
    .local v0, "$i$a$-check-LookaheadLayoutCoordinatesImpl$parentLayoutCoordinates$1":I
    nop

    .end local v0    # "$i$a$-check-LookaheadLayoutCoordinatesImpl$parentLayoutCoordinates$1":I
    new-instance v0, Ljava/lang/IllegalStateException;
...
.method public getSize-YbymL2g()J
    ...
    .line 51
    .local v1, "$i$a$-let-LookaheadLayoutCoordinatesImpl$size$1":I
    ...
    .end local v0    # "it":Landroidx/compose/ui/node/LookaheadDelegate;
    .end local v1    # "$i$a$-let-LookaheadLayoutCoordinatesImpl$size$1":I
    return-wide v0
.end method
...
.method public localPositionOf-R5De75A(Landroidx/compose/ui/layout/LayoutCoordinates;J)J
    ...
    const-string/jumbo v2, "sourceCoordinates"
    ...
    check-cast v2, Landroidx/compose/ui/layout/LookaheadLayoutCoordinatesImpl;

    iget-object v2, v2, Landroidx/compose/ui/layout/LookaheadLayoutCoordinatesImpl;->lookaheadDelegate:Landroidx/compose/ui/node/LookaheadDelegate;

    .line 92
    .local v2, "source":Landroidx/compose/ui/node/LookaheadDelegate;
    invoke-virtual {v2}, Landroidx/compose/ui/node/LookaheadDelegate;->getCoordinator()Landroidx/compose/ui/node/NodeCoordinator;

    move-result-object v3

    invoke-virtual {v3}, Landroidx/compose/ui/node/NodeCoordinator;->onCoordinatesUsed$ui_release()V

    .line 93
    invoke-virtual/range {p0 .. p0}, Landroidx/compose/ui/layout/LookaheadLayoutCoordinatesImpl;->getCoordinator()Landroidx/compose/ui/node/NodeCoordinator;
    ...
    invoke-virtual {v3, v4}, Landroidx/compose/ui/node/NodeCoordinator;->findCommonAncestor$ui_release(Landroidx/compose/ui/node/NodeCoordinator;)Landroidx/compose/ui/node/NodeCoordinator;

    move-result-object v3

    .line 95
    .local v3, "commonAncestor":Landroidx/compose/ui/node/NodeCoordinator;
    ...
    .line 97
    .local v5, "$i$a$-let-LookaheadLayoutCoordinatesImpl$localPositionOf$1":I
    invoke-virtual {v2, v4}, Landroidx/compose/ui/node/LookaheadDelegate;->positionIn-Bjo55l4$ui_release(Landroidx/compose/ui/node/LookaheadDelegate;)J

    move-result-wide v6

    move-wide/from16 v8, p2

    .local v8, "$this$round_u2dk_u2d4lQ0M$iv":J
    const/4 v10, 0x0

    .line 150
    .local v10, "$i$f$round-k-4lQ0M":I
    ...
    .line 97
    .end local v8    # "$this$round_u2dk_u2d4lQ0M$iv":J
    .end local v10    # "$i$f$round-k-4lQ0M":I
    nop
    ...
    iget-object v8, v0, Landroidx/compose/ui/layout/LookaheadLayoutCoordinatesImpl;->lookaheadDelegate:Landroidx/compose/ui/node/LookaheadDelegate;

    invoke-virtual {v8, v4}, Landroidx/compose/ui/node/LookaheadDelegate;->positionIn-Bjo55l4$ui_release(Landroidx/compose/ui/node/LookaheadDelegate;)J
    ...
    .restart local v8    # "other$iv":J
    const/4 v10, 0x0

    .line 152
    .local v10, "$i$f$minus-qkQi6aY":I
    invoke-static {v6, v7}, Landroidx/compose/ui/unit/IntOffset;->getX-impl(J)I
    ...
    .end local v6    # "arg0$iv":J
    .end local v8    # "other$iv":J
    .end local v10    # "$i$f$minus-qkQi6aY":I
    nop

    .local v6, "$this$toOffset_u2d_u2dgyyYBs$iv":J
    const/4 v8, 0x0

    .line 153
    .local v8, "$i$f$toOffset--gyyYBs":I
    invoke-static {v6, v7}, Landroidx/compose/ui/unit/IntOffset;->getX-impl(J)I
    ...
    .line 98
    .end local v6    # "$this$toOffset_u2d_u2dgyyYBs$iv":J
    .end local v8    # "$i$f$toOffset--gyyYBs":I
    nop

    .line 95
    .end local v4    # "ancestor":Landroidx/compose/ui/node/LookaheadDelegate;
    .end local v5    # "$i$a$-let-LookaheadLayoutCoordinatesImpl$localPositionOf$1":I
    ...
    .line 101
    .local v5, "$i$a$-let-LookaheadLayoutCoordinatesImpl$localPositionOf$2":I
    ...
    invoke-virtual {v2, v6}, Landroidx/compose/ui/node/LookaheadDelegate;->positionIn-Bjo55l4$ui_release(Landroidx/compose/ui/node/LookaheadDelegate;)J
    ...
    .local v9, "$this$round_u2dk_u2d4lQ0M$iv":J
    const/4 v11, 0x0

    .line 155
    .local v11, "$i$f$round-k-4lQ0M":I
    ...
    .line 102
    .end local v9    # "$this$round_u2dk_u2d4lQ0M$iv":J
    .end local v11    # "$i$f$round-k-4lQ0M":I
    nop
    ...
    .end local v9    # "other$iv":J
    .end local v11    # "$i$f$plus-qkQi6aY":I
    iget-object v9, v0, Landroidx/compose/ui/layout/LookaheadLayoutCoordinatesImpl;->lookaheadDelegate:Landroidx/compose/ui/node/LookaheadDelegate;

    .local v9, "$this$localPositionOf_R5De75A_u24lambda_u247_u24lambda_u246":Landroidx/compose/ui/node/LookaheadDelegate;
    const/4 v10, 0x0

    .line 105
    .local v10, "$i$a$-with-LookaheadLayoutCoordinatesImpl$localPositionOf$2$relativePosition$1":I
    invoke-static {v9}, Landroidx/compose/ui/layout/LookaheadLayoutCoordinatesKt;->getRootLookaheadDelegate(Landroidx/compose/ui/node/LookaheadDelegate;)Landroidx/compose/ui/node/LookaheadDelegate;

    move-result-object v11

    invoke-virtual {v9, v11}, Landroidx/compose/ui/node/LookaheadDelegate;->positionIn-Bjo55l4$ui_release(Landroidx/compose/ui/node/LookaheadDelegate;)J
    ...
    invoke-virtual {v13}, Landroidx/compose/ui/node/LookaheadDelegate;->getPosition-nOcc-ac()J
    ...
    .end local v2    # "source":Landroidx/compose/ui/node/LookaheadDelegate;
    .local v18, "source":Landroidx/compose/ui/node/LookaheadDelegate;
    add-int v2, v16, v17
    ...
    .end local v3    # "commonAncestor":Landroidx/compose/ui/node/NodeCoordinator;
    .local v19, "commonAncestor":Landroidx/compose/ui/node/NodeCoordinator;
    add-int v3, v16, v17
    ...
    .line 104
    .end local v9    # "$this$localPositionOf_R5De75A_u24lambda_u247_u24lambda_u246":Landroidx/compose/ui/node/LookaheadDelegate;
    .end local v10    # "$i$a$-with-LookaheadLayoutCoordinatesImpl$localPositionOf$2$relativePosition$1":I
    nop
    ...
    iget-object v7, v0, Landroidx/compose/ui/layout/LookaheadLayoutCoordinatesImpl;->lookaheadDelegate:Landroidx/compose/ui/node/LookaheadDelegate;

    invoke-static {v7}, Landroidx/compose/ui/layout/LookaheadLayoutCoordinatesKt;->getRootLookaheadDelegate(Landroidx/compose/ui/node/LookaheadDelegate;)Landroidx/compose/ui/node/LookaheadDelegate;
    ...
    invoke-virtual {v7}, Landroidx/compose/ui/node/NodeCoordinator;->getWrappedBy$ui_release()Landroidx/compose/ui/node/NodeCoordinator;
    ...
    invoke-virtual {v8}, Landroidx/compose/ui/node/NodeCoordinator;->getWrappedBy$ui_release()Landroidx/compose/ui/node/NodeCoordinator;
    ...
    .line 158
    .local v11, "$i$f$toOffset--gyyYBs":I
    invoke-static {v9, v10}, Landroidx/compose/ui/unit/IntOffset;->getX-impl(J)I
    ...
    .end local v11    # "$i$f$toOffset--gyyYBs":I
    invoke-virtual {v7, v8, v9, v10}, Landroidx/compose/ui/node/NodeCoordinator;->localPositionOf-R5De75A(Landroidx/compose/ui/layout/LayoutCoordinates;J)J
    ...
    .end local v5    # "$i$a$-let-LookaheadLayoutCoordinatesImpl$localPositionOf$2":I
    ...
    .line 118
    .local v2, "rootDelegate":Landroidx/compose/ui/node/LookaheadDelegate;
    ...
    invoke-virtual {v0, v3, v4, v5}, Landroidx/compose/ui/layout/LookaheadLayoutCoordinatesImpl;->localPositionOf-R5De75A(Landroidx/compose/ui/layout/LayoutCoordinates;J)J
    ...
    invoke-interface {v3, v1, v8, v9}, Landroidx/compose/ui/layout/LayoutCoordinates;->localPositionOf-R5De75A(Landroidx/compose/ui/layout/LayoutCoordinates;J)J
