.class final Lcom/pandasu/turbo/data/local/IsolationDataStore$saveIsolationConfig$2;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/pandasu/turbo/data/local/IsolationDataStore;->saveIsolationConfig(Lcom/pandasu/turbo/data/model/IsolationConfig;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
.end annotation
...
.annotation runtime Lkotlin/coroutines/jvm/internal/DebugMetadata;
    c = "com.pandasu.turbo.data.local.IsolationDataStore$saveIsolationConfig$2"
...
# direct methods
.method constructor <init>(Lcom/pandasu/turbo/data/model/IsolationConfig;Lcom/pandasu/turbo/data/local/IsolationDataStore;Lkotlin/coroutines/Continuation;)V
    .registers 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            ...
            "Lkotlin/coroutines/Continuation<",
            "-",
            "Lcom/pandasu/turbo/data/local/IsolationDataStore$saveIsolationConfig$2;",
            ">;)V"
        }
    .end annotation

    iput-object p1, p0, Lcom/pandasu/turbo/data/local/IsolationDataStore$saveIsolationConfig$2;->$config:Lcom/pandasu/turbo/data/model/IsolationConfig;

    iput-object p2, p0, Lcom/pandasu/turbo/data/local/IsolationDataStore$saveIsolationConfig$2;->this$0:Lcom/pandasu/turbo/data/local/IsolationDataStore;
...
.method public final create(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;
    ...
    new-instance v0, Lcom/pandasu/turbo/data/local/IsolationDataStore$saveIsolationConfig$2;

    iget-object v1, p0, Lcom/pandasu/turbo/data/local/IsolationDataStore$saveIsolationConfig$2;->$config:Lcom/pandasu/turbo/data/model/IsolationConfig;

    iget-object v2, p0, Lcom/pandasu/turbo/data/local/IsolationDataStore$saveIsolationConfig$2;->this$0:Lcom/pandasu/turbo/data/local/IsolationDataStore;

    invoke-direct {v0, v1, v2, p2}, Lcom/pandasu/turbo/data/local/IsolationDataStore$saveIsolationConfig$2;-><init>(Lcom/pandasu/turbo/data/model/IsolationConfig;Lcom/pandasu/turbo/data/local/IsolationDataStore;Lkotlin/coroutines/Continuation;)V

    iput-object p1, v0, Lcom/pandasu/turbo/data/local/IsolationDataStore$saveIsolationConfig$2;->L$0:Ljava/lang/Object;
...
.method public final invoke(Landroidx/datastore/preferences/core/MutablePreferences;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Lcom/pandasu/turbo/data/local/IsolationDataStore$saveIsolationConfig$2;->create(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;

    move-result-object v0

    check-cast v0, Lcom/pandasu/turbo/data/local/IsolationDataStore$saveIsolationConfig$2;

    sget-object v1, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;

    invoke-virtual {v0, v1}, Lcom/pandasu/turbo/data/local/IsolationDataStore$saveIsolationConfig$2;->invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public bridge synthetic invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Lcom/pandasu/turbo/data/local/IsolationDataStore$saveIsolationConfig$2;->invoke(Landroidx/datastore/preferences/core/MutablePreferences;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 91
    iget v0, p0, Lcom/pandasu/turbo/data/local/IsolationDataStore$saveIsolationConfig$2;->label:I
    ...
    .local v0, "this":Lcom/pandasu/turbo/data/local/IsolationDataStore$saveIsolationConfig$2;
    .local p1, "$result":Ljava/lang/Object;
    iget-object v1, v0, Lcom/pandasu/turbo/data/local/IsolationDataStore$saveIsolationConfig$2;->L$0:Ljava/lang/Object;
    ...
    iget-object v4, v0, Lcom/pandasu/turbo/data/local/IsolationDataStore$saveIsolationConfig$2;->this$0:Lcom/pandasu/turbo/data/local/IsolationDataStore;
    ...
    :try_end_4c
    .catch Ljava/lang/Exception; {:try_start_19 .. :try_end_4c} :catch_102
    ...
    .line 95
    .local v10, "$i$a$-mapNotNull-IsolationDataStore$saveIsolationConfig$2$configList$1":I
    nop
    ...
    .line 344
    .end local v10    # "$i$a$-mapNotNull-IsolationDataStore$saveIsolationConfig$2$configList$1":I
    if-eqz v13, :cond_70
    ...
    new-instance v3, Lcom/pandasu/turbo/data/local/IsolationDataStore$saveIsolationConfig$2$1;

    iget-object v4, v0, Lcom/pandasu/turbo/data/local/IsolationDataStore$saveIsolationConfig$2;->$config:Lcom/pandasu/turbo/data/model/IsolationConfig;

    invoke-direct {v3, v4}, Lcom/pandasu/turbo/data/local/IsolationDataStore$saveIsolationConfig$2$1;-><init>(Lcom/pandasu/turbo/data/model/IsolationConfig;)V
    ...
    .line 105
    iget-object v3, v0, Lcom/pandasu/turbo/data/local/IsolationDataStore$saveIsolationConfig$2;->$config:Lcom/pandasu/turbo/data/model/IsolationConfig;
    ...
    iget-object v5, v0, Lcom/pandasu/turbo/data/local/IsolationDataStore$saveIsolationConfig$2;->this$0:Lcom/pandasu/turbo/data/local/IsolationDataStore;
    ...
    .line 109
    .local v10, "$i$a$-map-IsolationDataStore$saveIsolationConfig$2$2":I
    # getter for: Lcom/pandasu/turbo/data/local/IsolationDataStore;->json:Lkotlinx/serialization/json/Json;
    ...
    .end local v10    # "$i$a$-map-IsolationDataStore$saveIsolationConfig$2$2":I
    ...
    iget-object v2, v0, Lcom/pandasu/turbo/data/local/IsolationDataStore$saveIsolationConfig$2;->$config:Lcom/pandasu/turbo/data/model/IsolationConfig;

    invoke-virtual {v2}, Lcom/pandasu/turbo/data/model/IsolationConfig;->getPackageName()Ljava/lang/String;
    ...
    const-string v4, "Saved isolation config for "
    ...
    :try_end_101
    .catch Ljava/lang/Exception; {:try_start_6d .. :try_end_101} :catch_102
    ...
    const-string v3, "Failed to save isolation config"
