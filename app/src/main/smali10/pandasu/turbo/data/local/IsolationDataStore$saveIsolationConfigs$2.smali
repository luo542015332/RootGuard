.class final Lcom/pandasu/turbo/data/local/IsolationDataStore$saveIsolationConfigs$2;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/pandasu/turbo/data/local/IsolationDataStore;->saveIsolationConfigs(Ljava/util/List;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
.end annotation
...
.annotation runtime Lkotlin/coroutines/jvm/internal/DebugMetadata;
    c = "com.pandasu.turbo.data.local.IsolationDataStore$saveIsolationConfigs$2"
...
# direct methods
.method constructor <init>(Ljava/util/List;Lcom/pandasu/turbo/data/local/IsolationDataStore;Lkotlin/coroutines/Continuation;)V
    .registers 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            ...
            "Lkotlin/coroutines/Continuation<",
            "-",
            "Lcom/pandasu/turbo/data/local/IsolationDataStore$saveIsolationConfigs$2;",
            ">;)V"
        }
    .end annotation

    iput-object p1, p0, Lcom/pandasu/turbo/data/local/IsolationDataStore$saveIsolationConfigs$2;->$configs:Ljava/util/List;

    iput-object p2, p0, Lcom/pandasu/turbo/data/local/IsolationDataStore$saveIsolationConfigs$2;->this$0:Lcom/pandasu/turbo/data/local/IsolationDataStore;
...
.method public final create(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;
    ...
    new-instance v0, Lcom/pandasu/turbo/data/local/IsolationDataStore$saveIsolationConfigs$2;

    iget-object v1, p0, Lcom/pandasu/turbo/data/local/IsolationDataStore$saveIsolationConfigs$2;->$configs:Ljava/util/List;

    iget-object v2, p0, Lcom/pandasu/turbo/data/local/IsolationDataStore$saveIsolationConfigs$2;->this$0:Lcom/pandasu/turbo/data/local/IsolationDataStore;

    invoke-direct {v0, v1, v2, p2}, Lcom/pandasu/turbo/data/local/IsolationDataStore$saveIsolationConfigs$2;-><init>(Ljava/util/List;Lcom/pandasu/turbo/data/local/IsolationDataStore;Lkotlin/coroutines/Continuation;)V

    iput-object p1, v0, Lcom/pandasu/turbo/data/local/IsolationDataStore$saveIsolationConfigs$2;->L$0:Ljava/lang/Object;
...
.method public final invoke(Landroidx/datastore/preferences/core/MutablePreferences;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Lcom/pandasu/turbo/data/local/IsolationDataStore$saveIsolationConfigs$2;->create(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;

    move-result-object v0

    check-cast v0, Lcom/pandasu/turbo/data/local/IsolationDataStore$saveIsolationConfigs$2;

    sget-object v1, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;

    invoke-virtual {v0, v1}, Lcom/pandasu/turbo/data/local/IsolationDataStore$saveIsolationConfigs$2;->invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public bridge synthetic invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Lcom/pandasu/turbo/data/local/IsolationDataStore$saveIsolationConfigs$2;->invoke(Landroidx/datastore/preferences/core/MutablePreferences;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 260
    iget v0, p0, Lcom/pandasu/turbo/data/local/IsolationDataStore$saveIsolationConfigs$2;->label:I
    ...
    .local v0, "this":Lcom/pandasu/turbo/data/local/IsolationDataStore$saveIsolationConfigs$2;
    .local p1, "$result":Ljava/lang/Object;
    iget-object v1, v0, Lcom/pandasu/turbo/data/local/IsolationDataStore$saveIsolationConfigs$2;->L$0:Ljava/lang/Object;
    ...
    iget-object v4, v0, Lcom/pandasu/turbo/data/local/IsolationDataStore$saveIsolationConfigs$2;->this$0:Lcom/pandasu/turbo/data/local/IsolationDataStore;
    ...
    :try_end_4c
    .catch Ljava/lang/Exception; {:try_start_19 .. :try_end_4c} :catch_122
    ...
    .line 264
    .local v10, "$i$a$-mapNotNull-IsolationDataStore$saveIsolationConfigs$2$configList$1":I
    nop
    ...
    .line 344
    .end local v10    # "$i$a$-mapNotNull-IsolationDataStore$saveIsolationConfigs$2$configList$1":I
    if-eqz v13, :cond_70
    ...
    iget-object v3, v0, Lcom/pandasu/turbo/data/local/IsolationDataStore$saveIsolationConfigs$2;->$configs:Ljava/util/List;
    ...
    .local v6, "newConfig":Lcom/pandasu/turbo/data/model/IsolationConfig;
    const/4 v7, 0x0

    .line 273
    .local v7, "$i$a$-forEach-IsolationDataStore$saveIsolationConfigs$2$1":I
    new-instance v8, Lcom/pandasu/turbo/data/local/IsolationDataStore$saveIsolationConfigs$2$1$1;

    invoke-direct {v8, v6}, Lcom/pandasu/turbo/data/local/IsolationDataStore$saveIsolationConfigs$2$1$1;-><init>(Lcom/pandasu/turbo/data/model/IsolationConfig;)V
    ...
    .end local v6    # "newConfig":Lcom/pandasu/turbo/data/model/IsolationConfig;
    .end local v7    # "$i$a$-forEach-IsolationDataStore$saveIsolationConfigs$2$1":I
    goto :goto_87
    ...
    iget-object v5, v0, Lcom/pandasu/turbo/data/local/IsolationDataStore$saveIsolationConfigs$2;->this$0:Lcom/pandasu/turbo/data/local/IsolationDataStore;
    ...
    .line 281
    .local v10, "$i$a$-map-IsolationDataStore$saveIsolationConfigs$2$2":I
    # getter for: Lcom/pandasu/turbo/data/local/IsolationDataStore;->json:Lkotlinx/serialization/json/Json;
    ...
    .end local v10    # "$i$a$-map-IsolationDataStore$saveIsolationConfigs$2$2":I
    ...
    iget-object v2, v0, Lcom/pandasu/turbo/data/local/IsolationDataStore$saveIsolationConfigs$2;->$configs:Ljava/util/List;
    ...
    const-string v3, " isolation configs"
    ...
    :try_end_121
    .catch Ljava/lang/Exception; {:try_start_6d .. :try_end_121} :catch_122
    ...
    const-string v3, "Failed to batch save isolation configs"
