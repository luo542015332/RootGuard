...
.method private final getMatchingPathArguments(Ljava/util/regex/Matcher;Landroid/os/Bundle;Ljava/util/Map;)Z
    ...
    :try_end_53
    .catch Ljava/lang/IllegalArgumentException; {:try_start_4d .. :try_end_53} :catch_6c
    ...
    move-result v0
    :try_end_5b
    .catch Ljava/lang/IllegalArgumentException; {:try_start_57 .. :try_end_5b} :catch_6a
...
.method private final getMatchingUriFragment(Ljava/lang/String;Landroid/os/Bundle;Ljava/util/Map;)V
    ...
    :try_end_6a
    .catch Ljava/lang/IllegalArgumentException; {:try_start_64 .. :try_end_6a} :catch_87
    ...
    move-result v0
    :try_end_76
    .catch Ljava/lang/IllegalArgumentException; {:try_start_72 .. :try_end_76} :catch_85
...
.method private final parseInputParams(Ljava/util/List;Landroidx/navigation/NavDeepLink$ParamQuery;Landroid/os/Bundle;Ljava/util/Map;)Z
    ...
    :try_end_71
    .catch Ljava/lang/IllegalArgumentException; {:try_start_4b .. :try_end_71} :catch_11b
    ...
    invoke-static {}, Lkotlin/collections/CollectionsKt;->throwIndexOverflow()V
    :try_end_78
    .catch Ljava/lang/IllegalArgumentException; {:try_start_75 .. :try_end_78} :catch_79
    ...
    move-result-object v0
    :try_end_92
    .catch Ljava/lang/IllegalArgumentException; {:try_start_84 .. :try_end_92} :catch_11b
    ...
    const-string v0, ""
    :try_end_96
    .catch Ljava/lang/IllegalArgumentException; {:try_start_94 .. :try_end_96} :catch_79
    ...
    :try_end_a0
    .catch Ljava/lang/IllegalArgumentException; {:try_start_9b .. :try_end_a0} :catch_101
    ...
    move-result v23
    :try_end_b6
    .catch Ljava/lang/IllegalArgumentException; {:try_start_a8 .. :try_end_b6} :catch_fb
    ...
    :try_end_bf
    .catch Ljava/lang/IllegalArgumentException; {:try_start_ba .. :try_end_bf} :catch_e3
    ...
    :try_end_118
    .catch Ljava/lang/IllegalArgumentException; {:try_start_c3 .. :try_end_118} :catch_119
