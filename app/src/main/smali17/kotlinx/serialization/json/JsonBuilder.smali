...
.method public final build$kotlinx_serialization_json()Lkotlinx/serialization/json/JsonConfiguration;
    ...
    .line 379
    .local v1, "$i$a$-require-JsonBuilder$build$1":I
    nop

    .line 378
    .end local v1    # "$i$a$-require-JsonBuilder$build$1":I
    ...
    .line 384
    .local v1, "$i$a$-require-JsonBuilder$build$2":I
    nop

    .line 383
    .end local v1    # "$i$a$-require-JsonBuilder$build$2":I
    new-instance v1, Ljava/lang/IllegalArgumentException;
    ...
    .line 388
    .local v8, "$i$a$-all-JsonBuilder$build$allWhitespaces$1":I
    const/16 v9, 0x20
    ...
    .line 426
    .end local v7    # "it":C
    .end local v8    # "$i$a$-all-JsonBuilder$build$allWhitespaces$1":I
    :cond_5
    :goto_2
    if-nez v6, :cond_6
    ...
    .line 390
    .local v2, "$i$a$-require-JsonBuilder$build$3":I
    new-instance v3, Ljava/lang/StringBuilder;

    invoke-direct {v3}, Ljava/lang/StringBuilder;-><init>()V

    const-string v4, "Only whitespace, tab, newline and carriage return are allowed as pretty print symbols. Had "

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    iget-object v4, v0, Lkotlinx/serialization/json/JsonBuilder;->prettyPrintIndent:Ljava/lang/String;
    ...
    .line 389
    .end local v2    # "$i$a$-require-JsonBuilder$build$3":I
    ...
    iget-boolean v2, v0, Lkotlinx/serialization/json/JsonBuilder;->useAlternativeNames:Z

    .line 399
    iget-object v3, v0, Lkotlinx/serialization/json/JsonBuilder;->namingStrategy:Lkotlinx/serialization/json/JsonNamingStrategy;

    iget-boolean v4, v0, Lkotlinx/serialization/json/JsonBuilder;->decodeEnumsCaseInsensitive:Z
    ...
    invoke-direct/range {v4 .. v18}, Lkotlinx/serialization/json/JsonConfiguration;-><init>(ZZZZZZLjava/lang/String;ZZLjava/lang/String;ZZLkotlinx/serialization/json/JsonNamingStrategy;Z)V
...
.method public final setNamingStrategy(Lkotlinx/serialization/json/JsonNamingStrategy;)V
    .locals 0
    .param p1, "<set-?>"    # Lkotlinx/serialization/json/JsonNamingStrategy;
