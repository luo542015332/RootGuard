...
.method public static parse(Ljava/lang/String;Ljava/text/ParsePosition;)Ljava/util/Date;
    ...
    move-result v12
    :try_end_37
    .catch Ljava/lang/IndexOutOfBoundsException; {:try_start_5 .. :try_end_37} :catch_223
    .catch Ljava/lang/NumberFormatException; {:try_start_5 .. :try_end_37} :catch_21e
    .catch Ljava/lang/IllegalArgumentException; {:try_start_5 .. :try_end_37} :catch_219
    ...
    move-result v17
    :try_end_cb
    .catch Ljava/lang/IndexOutOfBoundsException; {:try_start_3a .. :try_end_cb} :catch_5c
    .catch Ljava/lang/NumberFormatException; {:try_start_3a .. :try_end_cb} :catch_57
    .catch Ljava/lang/IllegalArgumentException; {:try_start_3a .. :try_end_cb} :catch_52

    .line 188
    .local v17, "fraction":I
    sub-int v18, v14, v13

    packed-switch v18, :pswitch_data_29a
    ...
    move-result v13
    :try_end_e7
    .catch Ljava/lang/IndexOutOfBoundsException; {:try_start_dc .. :try_end_e7} :catch_223
    .catch Ljava/lang/NumberFormatException; {:try_start_dc .. :try_end_e7} :catch_21e
    .catch Ljava/lang/IllegalArgumentException; {:try_start_dc .. :try_end_e7} :catch_219

    .line 212
    .local v13, "timezoneIndicator":C
    const/4 v14, 0x1

    if-ne v13, v15, :cond_f4

    .line 213
    :try_start_ea
    sget-object v15, Lcom/google/gson/internal/bind/util/ISO8601Utils;->TIMEZONE_UTC:Ljava/util/TimeZone;
    :try_end_ec
    .catch Ljava/lang/IndexOutOfBoundsException; {:try_start_ea .. :try_end_ec} :catch_5c
    .catch Ljava/lang/NumberFormatException; {:try_start_ea .. :try_end_ec} :catch_57
    .catch Ljava/lang/IllegalArgumentException; {:try_start_ea .. :try_end_ec} :catch_52
    ...
    if-eq v13, v15, :cond_120

    const/16 v15, 0x2d

    if-ne v13, v15, :cond_ff
    ...
    :try_end_106
    .catch Ljava/lang/IndexOutOfBoundsException; {:try_start_ff .. :try_end_106} :catch_223
    .catch Ljava/lang/NumberFormatException; {:try_start_ff .. :try_end_106} :catch_21e
    .catch Ljava/lang/IllegalArgumentException; {:try_start_ff .. :try_end_106} :catch_219
    ...
    throw v3
    :try_end_213
    .catch Ljava/lang/IndexOutOfBoundsException; {:try_start_108 .. :try_end_213} :catch_217
    .catch Ljava/lang/NumberFormatException; {:try_start_108 .. :try_end_213} :catch_215
    .catch Ljava/lang/IllegalArgumentException; {:try_start_108 .. :try_end_213} :catch_213
