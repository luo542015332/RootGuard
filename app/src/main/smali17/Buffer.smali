...
.method private final hmac(Ljava/lang/String;Lokio/ByteString;)Lokio/ByteString;
    ...
    invoke-direct {v1, v2}, Lokio/ByteString;-><init>([B)V
    :try_end_4e
    .catch Ljava/security/InvalidKeyException; {:try_start_1 .. :try_end_4e} :catch_4f
...
.method public readDecimalLong()J
    ...
    if-lt v15, v4, :cond_84

    const/16 v4, 0x39

    if-gt v15, v4, :cond_84
...
.method public writeUtf8(Ljava/lang/String;II)Lokio/Buffer;
    ...
    if-gt v8, v12, :cond_129

    const v12, 0xdc00

    if-gt v12, v5, :cond_d0
