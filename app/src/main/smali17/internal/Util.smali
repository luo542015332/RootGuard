...
.method public static final closeQuietly(Ljava/net/Socket;)V
    ...
    :try_end_9
    .catch Ljava/lang/AssertionError; {:try_start_6 .. :try_end_9} :catch_1b
    .catch Ljava/lang/RuntimeException; {:try_start_6 .. :try_end_9} :catch_c
    .catch Ljava/lang/Exception; {:try_start_6 .. :try_end_9} :catch_a
...
.method public static final isHealthy(Ljava/net/Socket;Lokio/BufferedSource;)Z
    ...
    move-result v1
    :try_end_11
    .catch Ljava/net/SocketTimeoutException; {:try_start_d .. :try_end_11} :catch_29
    .catch Ljava/io/IOException; {:try_start_d .. :try_end_11} :catch_25
    ...
    throw v2
    :try_end_25
    .catch Ljava/net/SocketTimeoutException; {:try_start_1a .. :try_end_25} :catch_29
    .catch Ljava/io/IOException; {:try_start_1a .. :try_end_25} :catch_25
...
.method public static final readFieldOrNull(Ljava/lang/Object;Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/Object;
    ...
    move-result-object v2
    :try_end_34
    .catch Ljava/lang/NoSuchFieldException; {:try_start_1d .. :try_end_34} :catch_35
...
.method public static final skipAll(Lokio/Source;ILjava/util/concurrent/TimeUnit;)Z
    ...
    :try_end_50
    .catch Ljava/io/InterruptedIOException; {:try_start_3c .. :try_end_50} :catch_80
    .catchall {:try_start_3c .. :try_end_50} :catchall_69
...
.method public static final toNonNegativeInt(Ljava/lang/String;I)I
    ...
    move-result-wide v0
    :try_end_7
    .catch Ljava/lang/NumberFormatException; {:try_start_3 .. :try_end_7} :catch_1d
