...
.method public intercept(Lokhttp3/Interceptor$Chain;)Lokhttp3/Response;
    ...
    :try_end_98
    .catch Ljava/io/IOException; {:try_start_29 .. :try_end_98} :catch_99
    ...
    invoke-virtual {v6}, Lokhttp3/internal/connection/Exchange;->responseHeadersStart()V
    :try_end_b6
    .catch Ljava/io/IOException; {:try_start_a9 .. :try_end_b6} :catch_b8
    ...
    move-result-object v0
    :try_end_d4
    .catch Ljava/io/IOException; {:try_start_c0 .. :try_end_d4} :catch_1e5
    ...
    :try_end_f6
    .catch Ljava/io/IOException; {:try_start_d7 .. :try_end_f6} :catch_1de
    ...
    move-result-object v0
    :try_end_11b
    .catch Ljava/io/IOException; {:try_start_105 .. :try_end_11b} :catch_137
    ...
    move-result v7
    :try_end_12f
    .catch Ljava/io/IOException; {:try_start_11e .. :try_end_12f} :catch_133
    ...
    if-eq v12, v3, :cond_195

    const/16 v3, 0xcd

    if-ne v12, v3, :cond_1d9
    ...
    throw v3
    :try_end_1d9
    .catch Ljava/io/IOException; {:try_start_143 .. :try_end_1d9} :catch_1da
