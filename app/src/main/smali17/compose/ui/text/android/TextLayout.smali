...
.method public constructor <init>(Ljava/lang/CharSequence;FLandroid/text/TextPaint;ILandroid/text/TextUtils$TruncateAt;IFFZZIIIIII[I[ILandroidx/compose/ui/text/android/LayoutIntrinsics;)V
    ...
    move-result-wide v2
    :try_end_69
    .catchall {:try_start_60 .. :try_end_69} :catchall_1bf
    ...
    :try_end_7b
    .catchall {:try_start_6d .. :try_end_7b} :catchall_b9
    ...
    :try_end_a4
    .catchall {:try_start_9e .. :try_end_a4} :catchall_a8
    ...
    move-result-wide v6
    :try_end_e2
    .catchall {:try_start_cd .. :try_end_e2} :catchall_1b9
    ...
    :try_end_121
    .catchall {:try_start_119 .. :try_end_121} :catchall_1b3
    ...
    .line 321
    # invokes: Landroidx/compose/ui/text/android/TextLayoutKt;->getVerticalPaddings(Landroidx/compose/ui/text/android/TextLayout;)J
    ...
    # invokes: Landroidx/compose/ui/text/android/TextLayoutKt;->getLineHeightSpans(Landroidx/compose/ui/text/android/TextLayout;)[Landroidx/compose/ui/text/android/style/LineHeightStyleSpan;
    ...
    .line 324
    # invokes: Landroidx/compose/ui/text/android/TextLayoutKt;->getLineHeightPaddings(Landroidx/compose/ui/text/android/TextLayout;[Landroidx/compose/ui/text/android/style/LineHeightStyleSpan;)J
    ...
    # invokes: Landroidx/compose/ui/text/android/TextLayoutKt;->getLastLineMetrics(Landroidx/compose/ui/text/android/TextLayout;Landroid/text/TextPaint;Landroid/text/TextDirectionHeuristic;[Landroidx/compose/ui/text/android/style/LineHeightStyleSpan;)Landroid/graphics/Paint$FontMetricsInt;
...
.method public final paint(Landroid/graphics/Canvas;)V
    ...
    .line 720
    :cond_17
    # getter for: Landroidx/compose/ui/text/android/TextLayoutKt;->SharedTextAndroidCanvas:Landroidx/compose/ui/text/android/TextAndroidCanvas;
