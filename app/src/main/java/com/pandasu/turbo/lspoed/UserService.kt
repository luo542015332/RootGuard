...
import com.pandasu.turbo.lspoed.BuildConfig
import rikka.hidden.compat.ActivityManagerApis
import rikka.hidden.compat.adapter.UidObserverAdapter

object UserService {

    private const val TAG = "Turbo-UserService"
    ...
    private val uidObserver = object : UidObserverAdapter() {
        override fun onUidActive(uid: Int) {
            ...
            try {
                ...
                val extras = Bundle()
                extras.putBinder("binder", TurboService.instance)
    ...
    fun register(pms: IPackageManager) {
        logI(TAG, "Initialize TurboService - Version ${BuildConfig.SERVICE_VERSION}")
        val service = TurboService(pms)
