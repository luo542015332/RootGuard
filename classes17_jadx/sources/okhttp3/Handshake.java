...
public final class Handshake {
    ...
    public final List<Certificate> m2671deprecated_peerCertificates() {
    ...
    public final Principal m2672deprecated_peerPrincipal() {
    ...
    public final List<Certificate> m2669deprecated_localCertificates() {
        return this.localCertificates;
    }
    ...
    public final Principal m2670deprecated_localPrincipal() {
    ...
    public String toString() {
        ...
        return append.append((List) destination$iv$iv2).append(AbstractJsonLexerKt.END_OBJ).toString();
    }
    ...
    public static final class Companion {
        ...
        public final Handshake m2674deprecated_get(SSLSession sslSession) throws IOException {
