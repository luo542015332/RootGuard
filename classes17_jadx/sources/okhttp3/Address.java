...
public final class Address {
    ...
    public final List<Protocol> m2631deprecated_protocols() {
        return this.protocols;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "connectionSpecs", imports = {}))
    /* renamed from: -deprecated_connectionSpecs, reason: not valid java name */
    public final List<ConnectionSpec> m2628deprecated_connectionSpecs() {
        return this.connectionSpecs;
    }
    ...
    public String toString() {
        ...
        Object obj;
        StringBuilder append2 = new StringBuilder().append("Address{").append(this.url.host()).append(AbstractJsonLexerKt.COLON).append(this.url.port()).append(", ");
        if (this.proxy != null) {
        ...
        return append2.append(append.append(obj).toString()).append(AbstractJsonLexerKt.END_OBJ).toString();
    }
}
