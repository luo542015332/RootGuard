...
public interface SendChannel<E> {
    ...
    Object mo2516trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object result = sendChannel.mo2516trySendJP2dKIU(e);
            if (ChannelResult.m2536isSuccessimpl(result)) {
                return true;
            }
            Throwable m2530exceptionOrNullimpl = ChannelResult.m2530exceptionOrNullimpl(result);
