...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            m1013constructorimpl = Result.m1013constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m1013constructorimpl = Result.m1013constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m1019isFailureimpl(m1013constructorimpl) ? null : m1013constructorimpl);
