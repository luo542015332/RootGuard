...
public final class PolymorphicModuleBuilder<Base> {
    ...
    public final void m2626default(Function1<? super String, ? extends DeserializationStrategy<? extends Base>> defaultSerializerProvider) {
    ...
    public final void buildTo(SerializersModuleBuilder builder) {
        ...
        for (Object element$iv : $this$forEach$iv) {
            ...
            KClass<Base> kClass2 = this.baseClass;
            ...
            SerializersModuleBuilder.registerPolymorphicSerializer$default(builder, kClass2, kclass, serializer, false, 8, null);
        }
