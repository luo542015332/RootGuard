...
public abstract class AbstractPolymorphicSerializer<T> implements KSerializer<T> {
    ...
    public final T deserialize(Decoder decoder) {
        ...
        if (beginStructure.decodeSequentially()) {
            obj = abstractPolymorphicSerializer.decodeSequentially(beginStructure);
        } else {
            Object obj2 = null;
            while (true) {
                ...
                switch (decodeElementIndex) {
                    case -1:
                        ...
                        Intrinsics.checkNotNull(obj3, "null cannot be cast to non-null type T of kotlinx.serialization.internal.AbstractPolymorphicSerializer.deserialize$lambda$3");
                        obj = obj3;
                        break;
                    case 0:
                    ...
                    case 1:
                        ...
                        objectRef.element = t;
                        obj2 = CompositeDecoder.DefaultImpls.decodeSerializableElement$default(beginStructure, getDescriptor(), decodeElementIndex, PolymorphicSerializerKt.findPolymorphicSerializer(abstractPolymorphicSerializer, beginStructure, (String) objectRef.element), null, 8, null);
                        abstractPolymorphicSerializer = this;
                    default:
