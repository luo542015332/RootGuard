...
public final class ULongSerializer implements KSerializer<ULong> {
    ...
    public /* bridge */ /* synthetic */ Object deserialize(Decoder decoder) {
        return ULong.m1181boximpl(m2611deserializeI7RO_PI(decoder));
    }

    @Override // kotlinx.serialization.SerializationStrategy
    public /* bridge */ /* synthetic */ void serialize(Encoder encoder, Object value) {
        m2612serialize2TYgG_w(encoder, ((ULong) value).getData());
    }
    ...
    public void m2612serialize2TYgG_w(Encoder encoder, long value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        encoder.encodeInline(getDescriptor()).encodeLong(value);
    }

    /* renamed from: deserialize-I7RO_PI, reason: not valid java name */
    public long m2611deserializeI7RO_PI(Decoder decoder) {
        Intrinsics.checkNotNullParameter(decoder, "decoder");
        return ULong.m1187constructorimpl(decoder.decodeInline(getDescriptor()).decodeLong());
    }
}
