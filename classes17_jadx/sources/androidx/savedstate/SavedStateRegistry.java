...
public final class SavedStateRegistry {
    ...
    public final void registerSavedStateProvider(String key, SavedStateProvider provider) {
        ...
        SavedStateProvider previous = (SavedStateProvider) this.components.putIfAbsent(key, provider);
        if (!(previous == null)) {
    ...
    public final SavedStateProvider getSavedStateProvider(String key) {
        ...
        while (it.hasNext()) {
            ...
            String k = (String) components.getKey();
            SavedStateProvider value = (SavedStateProvider) components.getValue();
    ...
    public final void performSave(Bundle outBundle) {
        ...
        while (it.hasNext()) {
            ...
            SavedStateProvider value = (SavedStateProvider) entry.getValue();
