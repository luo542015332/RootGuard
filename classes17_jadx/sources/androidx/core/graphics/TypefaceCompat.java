...
public class TypefaceCompat {
    ...
    public static Typeface findFromCache(Resources resources, int id, String path, int cookie, int style) {
        return (Typeface) sTypefaceCache.get(createResourceUid(resources, id, path, cookie, style));
    }
    ...
    public static class ResourcesCallbackAdapter extends FontsContractCompat.FontRequestCallback {
        ...
        public void onTypefaceRetrieved(Typeface typeface) {
            ...
            if (fontCallback != null) {
                fontCallback.m904x46c88379(typeface);
            }
        }
        ...
        public void onTypefaceRequestFailed(int reason) {
            ResourcesCompat.FontCallback fontCallback = this.mFontCallback;
            if (fontCallback != null) {
                fontCallback.m903xb24343b7(reason);
            }
        }
    }
}
