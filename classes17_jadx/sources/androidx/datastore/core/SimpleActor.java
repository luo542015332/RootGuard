...
public final class SimpleActor<T> {
    ...
    public SimpleActor(CoroutineScope scope, final Function1<? super Throwable, Unit> onComplete, final Function2<? super T, ? super Throwable, Unit> onUndeliveredElement, Function2<? super T, ? super Continuation<? super Unit>, ? extends Object> consumeMessage) {
        ...
        job.invokeOnCompletion(new Function1<Throwable, Unit>() { // from class: androidx.datastore.core.SimpleActor.1
            ...
            public final void invoke2(Throwable th) {
                ...
                do {
                    Object m2531getOrNullimpl = ChannelResult.m2531getOrNullimpl(((SimpleActor) this).messageQueue.mo2521tryReceivePtdJZtk());
                    if (m2531getOrNullimpl == null) {
                        obj = null;
                    } else {
                        onUndeliveredElement.invoke(m2531getOrNullimpl, th);
                        obj = Unit.INSTANCE;
                    }
                } while (obj != null);
            }
    ...
    public final void offer(T msg) {
        Object $this$onClosed$iv = this.messageQueue.mo2516trySendJP2dKIU(msg);
        if (!($this$onClosed$iv instanceof ChannelResult.Closed)) {
            if (!ChannelResult.m2536isSuccessimpl($this$onClosed$iv)) {
        ...
        Throwable it = ChannelResult.m2530exceptionOrNullimpl($this$onClosed$iv);
        if (it != null) {
            throw it;
        }
    }
