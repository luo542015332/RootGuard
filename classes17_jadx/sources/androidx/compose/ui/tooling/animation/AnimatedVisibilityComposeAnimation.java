...
public final class AnimatedVisibilityComposeAnimation implements ComposeAnimation {
    ...
    public AnimatedVisibilityComposeAnimation(Transition<Boolean> animationObject, String label) {
        ...
        this.states = SetsKt.setOf((Object[]) new AnimatedVisibilityState[]{AnimatedVisibilityState.m571boximpl(AnimatedVisibilityState.INSTANCE.m578getEnterjXw82LU()), AnimatedVisibilityState.m571boximpl(AnimatedVisibilityState.INSTANCE.m579getExitjXw82LU())});
    }

    /* renamed from: getAnimationObject, reason: merged with bridge method [inline-methods] */
    public Transition<Boolean> m564getAnimationObject() {
    ...
    public final Transition<Object> getChildTransition() {
        Object orNull = CollectionsKt.getOrNull(m564getAnimationObject().getTransitions(), 0);
