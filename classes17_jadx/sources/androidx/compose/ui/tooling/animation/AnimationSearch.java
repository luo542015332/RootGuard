    ...
    public static final class AnimateXAsStateSearch extends Search<AnimateXAsStateSearchInfo<?, ?>> {
        ...
        private final <T> List<AnimateXAsStateSearchInfo<T, AnimationVector>> findAnimations(Collection<? extends Group> groupsWithLocation) {
            ...
            for (T t2 : groupsWithLocation) {
                if (Intrinsics.areEqual(((Group) t2).getName(), "animateValueAsState")) {
                    arrayList3.add(t2);
                }
            }
            ...
            ArrayList<CallGroup> arrayList9 = arrayList7;
            for (CallGroup callGroup : arrayList9) {
                Animatable<T, AnimationVector> findAnimatable = animateXAsStateSearch.findAnimatable(callGroup);
                ArrayList arrayList10 = arrayList6;
                AnimationSpec<T> findAnimationSpec = animateXAsStateSearch.findAnimationSpec(callGroup);
                ...
                while (true) {
                    ...
                    int i2 = i;
                    MutableState mutableState3 = mutableState2 instanceof MutableState ? mutableState2 : null;
                    if (mutableState3 != null) {
                        arrayList11.add(mutableState3);
                    }
                    i = i2;
                    arrayList7 = arrayList2;
                }
                ...
                Collection<Group> collection = children;
                ...
                while (it4.hasNext()) {
                    ...
                    MutableState mutableState4 = (MutableState) t;
                    if (mutableState4 != null) {
                        arrayList20.add(mutableState4);
                    }
                    arrayList19 = arrayList21;
                    arrayList17 = arrayList;
                }
                MutableState mutableState5 = (MutableState) CollectionsKt.firstOrNull(CollectionsKt.plus((Collection) arrayList18, (Iterable) arrayList20));
                if (findAnimatable != null && findAnimationSpec != null && mutableState5 != null) {
                    if (mutableState5.getValue() == null) {
                        mutableState5.setValue(new ToolingState(findAnimatable.getValue()));
                    }
                    ...
                    mutableState = new AnimateXAsStateSearchInfo(findAnimatable, findAnimationSpec, (ToolingState) value);
                }
                if (mutableState != null) {
                    arrayList8.add(mutableState);
                }
