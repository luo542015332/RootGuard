...
public final class AnimatedVisibilityState implements ComposeAnimationState {
    ...
    private static final String Enter = m572constructorimpl("Enter");
    private static final String Exit = m572constructorimpl("Exit");
    private final String value;

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ AnimatedVisibilityState m571boximpl(String str) {
        return new AnimatedVisibilityState(str);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static String m572constructorimpl(String str) {
        return str;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m573equalsimpl(String str, Object obj) {
        return (obj instanceof AnimatedVisibilityState) && Intrinsics.areEqual(str, ((AnimatedVisibilityState) obj).m577unboximpl());
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m574equalsimpl0(String str, String str2) {
    ...
    public final /* synthetic */ String m577unboximpl() {
        return this.value;
    }
    ...
    public static String m576toStringimpl(String arg0) {
        return arg0;
    }
