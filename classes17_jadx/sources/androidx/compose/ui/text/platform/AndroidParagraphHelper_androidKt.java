...
public final class AndroidParagraphHelper_androidKt {
    ...
    public static final CharSequence createCharSequence(String text, float contextFontSize, TextStyle contextTextStyle, List<AnnotatedString.Range<SpanStyle>> spanStyles, List<AnnotatedString.Range<Placeholder>> placeholders, Density density, Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> resolveTypeface, boolean useEmojiCompat) {
        ...
        if (spanStyles.isEmpty() && placeholders.isEmpty() && Intrinsics.areEqual(contextTextStyle.getTextIndent(), TextIndent.INSTANCE.getNone()) && TextUnitKt.m847isUnspecifiedR2X_6o(contextTextStyle.m170getLineHeightXSAIIZE())) {
            return currentText;
        }
        ...
        if (isIncludeFontPaddingEnabled(contextTextStyle) && contextTextStyle.getLineHeightStyle() == null) {
            SpannableExtensions_androidKt.m393setLineHeightr9BaKPg(spannableString, contextTextStyle.m170getLineHeightXSAIIZE(), contextFontSize, density);
        } else {
            ...
            SpannableExtensions_androidKt.m392setLineHeightKmRG4DE(spannableString, contextTextStyle.m170getLineHeightXSAIIZE(), contextFontSize, density, lineHeightStyle2);
        }
