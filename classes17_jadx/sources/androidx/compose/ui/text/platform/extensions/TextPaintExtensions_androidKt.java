...
public final class TextPaintExtensions_androidKt {
    ...
    public static final SpanStyle applySpanStyle(AndroidTextPaint $this$applySpanStyle, SpanStyle style, Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> resolveTypeface, Density density, boolean requiresLetterSpacing) {
        ...
        long m828getTypeUIouoOA = TextUnit.m828getTypeUIouoOA(style.getFontSize());
        if (TextUnitType.m857equalsimpl0(m828getTypeUIouoOA, TextUnitType.INSTANCE.m862getSpUIouoOA())) {
            $this$applySpanStyle.setTextSize(density.m628toPxR2X_6o(style.getFontSize()));
        } else if (TextUnitType.m857equalsimpl0(m828getTypeUIouoOA, TextUnitType.INSTANCE.m861getEmUIouoOA())) {
            $this$applySpanStyle.setTextSize($this$applySpanStyle.getTextSize() * TextUnit.m829getValueimpl(style.getFontSize()));
        }
        if (hasFontAttributes(style)) {
            ...
            $this$applySpanStyle.setTypeface(resolveTypeface.invoke(fontFamily, fontWeight, m235boximpl, FontSynthesis.m244boximpl(fontSynthesis != null ? fontSynthesis.getValue() : FontSynthesis.INSTANCE.m253getAllGVVA2EU())));
        }
        ...
        $this$applySpanStyle.m379setColor8_81llA(style.m101getColor0d7_KjU());
        $this$applySpanStyle.m378setBrush12SF9DM(style.getBrush(), Size.Companion.getUnspecified-NH-jbRc(), style.getAlpha());
        ...
        if (TextUnitType.m857equalsimpl0(TextUnit.m828getTypeUIouoOA(style.getLetterSpacing()), TextUnitType.INSTANCE.m862getSpUIouoOA())) {
            if (!(TextUnit.m829getValueimpl(style.getLetterSpacing()) == 0.0f)) {
                float emWidth = $this$applySpanStyle.getTextSize() * $this$applySpanStyle.getTextScaleX();
                float letterSpacingPx = density.m628toPxR2X_6o(style.getLetterSpacing());
                if (!(emWidth == 0.0f)) {
                    $this$applySpanStyle.setLetterSpacing(letterSpacingPx / emWidth);
                }
                return m394generateFallbackSpanStyle62GTOB8(style.getLetterSpacing(), requiresLetterSpacing, style.getBackground(), style.getBaselineShift());
            }
        }
        if (TextUnitType.m857equalsimpl0(TextUnit.m828getTypeUIouoOA(style.getLetterSpacing()), TextUnitType.INSTANCE.m861getEmUIouoOA())) {
            $this$applySpanStyle.setLetterSpacing(TextUnit.m829getValueimpl(style.getLetterSpacing()));
        }
        return m394generateFallbackSpanStyle62GTOB8(style.getLetterSpacing(), requiresLetterSpacing, style.getBackground(), style.getBaselineShift());
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:17:0x0053, code lost:
        ...
        if (androidx.compose.ui.text.style.BaselineShift.m402equalsimpl0(r36.m405unboximpl(), androidx.compose.ui.text.style.BaselineShift.INSTANCE.m409getNoney9eOQZs()) == false) goto L24;
     */
    ...
    */
    private static final androidx.compose.ui.text.SpanStyle m394generateFallbackSpanStyle62GTOB8(long r31, boolean r33, long r34, androidx.compose.ui.text.style.BaselineShift r36) {
        /*
            r0 = r34
            r2 = 1
            r3 = 0
            if (r33 == 0) goto L26
            long r4 = androidx.compose.ui.unit.TextUnit.m828getTypeUIouoOA(r31)
            androidx.compose.ui.unit.TextUnitType$Companion r6 = androidx.compose.ui.unit.TextUnitType.INSTANCE
            long r6 = r6.m862getSpUIouoOA()
            boolean r4 = androidx.compose.ui.unit.TextUnitType.m857equalsimpl0(r4, r6)
            if (r4 == 0) goto L26
            float r4 = androidx.compose.ui.unit.TextUnit.m829getValueimpl(r31)
            r5 = 0
        ...
        L27:
            ...
            long r5 = r5.getUnspecified-0d7_KjU()
            boolean r5 = androidx.compose.ui.graphics.Color.equals-impl0(r0, r5)
            if (r5 != 0) goto L42
            androidx.compose.ui.graphics.Color$Companion r5 = androidx.compose.ui.graphics.Color.Companion
            long r5 = r5.getTransparent-0d7_KjU()
            boolean r5 = androidx.compose.ui.graphics.Color.equals-impl0(r0, r5)
            if (r5 != 0) goto L42
            r5 = r2
            goto L43
        ...
        L43:
            ...
            float r6 = r6.m409getNoney9eOQZs()
            float r7 = r36.m405unboximpl()
            boolean r6 = androidx.compose.ui.text.style.BaselineShift.m402equalsimpl0(r7, r6)
            if (r6 != 0) goto L56
            goto L57
        L56:
            r2 = r3
        ...
        L64:
            ...
            long r6 = r6.m840getUnspecifiedXSAIIZE()
            r18 = r6
        L6c:
            if (r5 == 0) goto L71
            r23 = r0
        ...
        L71:
            ...
            long r6 = r6.getUnspecified-0d7_KjU()
            r23 = r6
        L79:
            if (r2 == 0) goto L7e
            r20 = r36
        ...
        La5:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.text.platform.extensions.TextPaintExtensions_androidKt.m394generateFallbackSpanStyle62GTOB8(long, boolean, long, androidx.compose.ui.text.style.BaselineShift):androidx.compose.ui.text.SpanStyle");
    }
    ...
    public static final void setTextMotion(AndroidTextPaint $this$setTextMotion, TextMotion textMotion) {
        ...
        if (TextMotion.Linearity.m536equalsimpl0(linearity, TextMotion.Linearity.INSTANCE.m541getLinear4e0Vf04())) {
            $this$setTextMotion.setFlags($this$setTextMotion.getFlags() | 64);
            $this$setTextMotion.setHinting(0);
        } else if (TextMotion.Linearity.m536equalsimpl0(linearity, TextMotion.Linearity.INSTANCE.m540getFontHinting4e0Vf04())) {
            $this$setTextMotion.getFlags();
            $this$setTextMotion.setHinting(1);
        } else if (TextMotion.Linearity.m536equalsimpl0(linearity, TextMotion.Linearity.INSTANCE.m542getNone4e0Vf04())) {
            $this$setTextMotion.getFlags();
            $this$setTextMotion.setHinting(0);
        } else {
            $this$setTextMotion.getFlags();
