...
public final class SpannableExtensions_androidKt {
    ...
    public static final void setTextIndent(Spannable $this$setTextIndent, TextIndent textIndent, float contextFontSize, Density density) {
        ...
        if (textIndent != null) {
            if ((!TextUnit.m826equalsimpl0(textIndent.getFirstLine(), TextUnitKt.getSp(0)) || !TextUnit.m826equalsimpl0(textIndent.getRestLine(), TextUnitKt.getSp(0))) && !TextUnitKt.m847isUnspecifiedR2X_6o(textIndent.getFirstLine()) && !TextUnitKt.m847isUnspecifiedR2X_6o(textIndent.getRestLine())) {
                long m828getTypeUIouoOA = TextUnit.m828getTypeUIouoOA(textIndent.getFirstLine());
                float f = 0.0f;
                if (TextUnitType.m857equalsimpl0(m828getTypeUIouoOA, TextUnitType.INSTANCE.m862getSpUIouoOA())) {
                    firstLine = density.m628toPxR2X_6o(textIndent.getFirstLine());
                } else {
                    firstLine = TextUnitType.m857equalsimpl0(m828getTypeUIouoOA, TextUnitType.INSTANCE.m861getEmUIouoOA()) ? TextUnit.m829getValueimpl(textIndent.getFirstLine()) * contextFontSize : 0.0f;
                }
                long m828getTypeUIouoOA2 = TextUnit.m828getTypeUIouoOA(textIndent.getRestLine());
                if (TextUnitType.m857equalsimpl0(m828getTypeUIouoOA2, TextUnitType.INSTANCE.m862getSpUIouoOA())) {
                    f = density.m628toPxR2X_6o(textIndent.getRestLine());
                } else if (TextUnitType.m857equalsimpl0(m828getTypeUIouoOA2, TextUnitType.INSTANCE.m861getEmUIouoOA())) {
                    f = TextUnit.m829getValueimpl(textIndent.getRestLine()) * contextFontSize;
                }
                float restLine = f;
    ...
    public static final void m392setLineHeightKmRG4DE(Spannable setLineHeight, long lineHeight, float contextFontSize, Density density, LineHeightStyle lineHeightStyle) {
        Intrinsics.checkNotNullParameter(setLineHeight, "$this$setLineHeight");
        Intrinsics.checkNotNullParameter(density, "density");
        Intrinsics.checkNotNullParameter(lineHeightStyle, "lineHeightStyle");
        float resolvedLineHeight = m387resolveLineHeightInPxo2QH7mI(lineHeight, contextFontSize, density);
        if (!Float.isNaN(resolvedLineHeight)) {
            ...
            setSpan(setLineHeight, new LineHeightStyleSpan(resolvedLineHeight, 0, endIndex, LineHeightStyle.Trim.m491isTrimFirstLineTopimpl$ui_text_release(lineHeightStyle.getTrim()), LineHeightStyle.Trim.m492isTrimLastLineBottomimpl$ui_text_release(lineHeightStyle.getTrim()), lineHeightStyle.getAlignment()), 0, setLineHeight.length());
        }
    }

    /* renamed from: setLineHeight-r9BaKPg, reason: not valid java name */
    public static final void m393setLineHeightr9BaKPg(Spannable setLineHeight, long lineHeight, float contextFontSize, Density density) {
        Intrinsics.checkNotNullParameter(setLineHeight, "$this$setLineHeight");
        Intrinsics.checkNotNullParameter(density, "density");
        float resolvedLineHeight = m387resolveLineHeightInPxo2QH7mI(lineHeight, contextFontSize, density);
        if (!Float.isNaN(resolvedLineHeight)) {
    ...
    private static final float m387resolveLineHeightInPxo2QH7mI(long lineHeight, float contextFontSize, Density density) {
        long m828getTypeUIouoOA = TextUnit.m828getTypeUIouoOA(lineHeight);
        if (TextUnitType.m857equalsimpl0(m828getTypeUIouoOA, TextUnitType.INSTANCE.m862getSpUIouoOA())) {
            return density.m628toPxR2X_6o(lineHeight);
        }
        if (TextUnitType.m857equalsimpl0(m828getTypeUIouoOA, TextUnitType.INSTANCE.m861getEmUIouoOA())) {
            return TextUnit.m829getValueimpl(lineHeight) * contextFontSize;
        }
        return Float.NaN;
    }
    ...
    public static final void setSpanStyles(Spannable $this$setSpanStyles, TextStyle contextTextStyle, List<AnnotatedString.Range<SpanStyle>> spanStyles, Density density, Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> resolveTypeface) {
        ...
        if (hasLetterSpacing) {
            ...
            for (int i2 = 0; i2 < size2; i2++) {
                ...
                if (start2 >= 0 && start2 < $this$setSpanStyles.length() && end2 > start2 && end2 <= $this$setSpanStyles.length() && (it = m386createLetterSpacingSpaneAf_CNQ(style.getLetterSpacing(), density)) != null) {
    ...
    private static final void setSpanStyle(Spannable $this$setSpanStyle, AnnotatedString.Range<SpanStyle> range, Density density) {
        ...
        m389setBaselineShift0ocSgnM($this$setSpanStyle, style.getBaselineShift(), start, end);
        m390setColorRPmYEkk($this$setSpanStyle, style.m101getColor0d7_KjU(), start, end);
        ...
        m391setFontSizeKmRG4DE($this$setSpanStyle, style.getFontSize(), density, start, end);
        ...
        m388setBackgroundRPmYEkk($this$setSpanStyle, style.getBackground(), start, end);
    ...
    private static final void setFontAttributes(final Spannable $this$setFontAttributes, TextStyle contextTextStyle, List<AnnotatedString.Range<SpanStyle>> list, final Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> function4) {
        ...
        if (hasFontAttributes(contextTextStyle)) {
            contextFontSpanStyle = new SpanStyle(0L, 0L, contextTextStyle.getFontWeight(), contextTextStyle.m165getFontStyle4Lr2A7w(), contextTextStyle.m166getFontSynthesisZQGJjVo(), contextTextStyle.getFontFamily(), (String) null, 0L, (BaselineShift) null, (TextGeometricTransform) null, (LocaleList) null, 0L, (TextDecoration) null, (Shadow) null, (PlatformSpanStyle) null, (DrawStyle) null, 65475, (DefaultConstructorMarker) null);
        } else {
        ...
        flattenFontStylesAndApply(contextFontSpanStyle, fontRelatedSpanStyles, new Function3<SpanStyle, Integer, Integer, Unit>() { // from class: androidx.compose.ui.text.platform.extensions.SpannableExtensions_androidKt$setFontAttributes$1
            ...
            public final void invoke(SpanStyle spanStyle, int start, int end) {
                ...
                FontStyle m235boximpl = FontStyle.m235boximpl(fontStyle != null ? fontStyle.m241unboximpl() : FontStyle.INSTANCE.m243getNormal_LCdwA());
                FontSynthesis fontSynthesis = spanStyle.getFontSynthesis();
                spannable.setSpan(new TypefaceSpan(function42.invoke(fontFamily, fontWeight, m235boximpl, FontSynthesis.m244boximpl(fontSynthesis != null ? fontSynthesis.getValue() : FontSynthesis.INSTANCE.m253getAllGVVA2EU()))), start, end, 33);
            }
        });
    }
    ...
    private static final MetricAffectingSpan m386createLetterSpacingSpaneAf_CNQ(long letterSpacing, Density density) {
        long m828getTypeUIouoOA = TextUnit.m828getTypeUIouoOA(letterSpacing);
        if (TextUnitType.m857equalsimpl0(m828getTypeUIouoOA, TextUnitType.INSTANCE.m862getSpUIouoOA())) {
            return new LetterSpacingSpanPx(density.m628toPxR2X_6o(letterSpacing));
        }
        if (TextUnitType.m857equalsimpl0(m828getTypeUIouoOA, TextUnitType.INSTANCE.m861getEmUIouoOA())) {
            return new LetterSpacingSpanEm(TextUnit.m829getValueimpl(letterSpacing));
        }
        return null;
    }

    private static final boolean getNeedsLetterSpacingSpan(SpanStyle $this$needsLetterSpacingSpan) {
        return TextUnitType.m857equalsimpl0(TextUnit.m828getTypeUIouoOA($this$needsLetterSpacingSpan.getLetterSpacing()), TextUnitType.INSTANCE.m862getSpUIouoOA()) || TextUnitType.m857equalsimpl0(TextUnit.m828getTypeUIouoOA($this$needsLetterSpacingSpan.getLetterSpacing()), TextUnitType.INSTANCE.m861getEmUIouoOA());
    }

    private static final void setShadow(Spannable $this$setShadow, Shadow shadow, int start, int end) {
        if (shadow != null) {
            setSpan($this$setShadow, new ShadowSpan(ColorKt.toArgb-8_81llA(shadow.getColor-0d7_KjU()), Offset.getX-impl(shadow.getOffset-F1C5BW0()), Offset.getY-impl(shadow.getOffset-F1C5BW0()), TextPaintExtensions_androidKt.correctBlurRadius(shadow.getBlurRadius())), start, end);
        }
    }
    ...
    public static final void m388setBackgroundRPmYEkk(Spannable setBackground, long color, int start, int end) {
        Intrinsics.checkNotNullParameter(setBackground, "$this$setBackground");
        if (color != Color.Companion.getUnspecified-0d7_KjU()) {
            setSpan(setBackground, new BackgroundColorSpan(ColorKt.toArgb-8_81llA(color)), start, end);
        }
    }
    ...
    public static final void m391setFontSizeKmRG4DE(Spannable setFontSize, long fontSize, Density density, int start, int end) {
        Intrinsics.checkNotNullParameter(setFontSize, "$this$setFontSize");
        Intrinsics.checkNotNullParameter(density, "density");
        long m828getTypeUIouoOA = TextUnit.m828getTypeUIouoOA(fontSize);
        if (TextUnitType.m857equalsimpl0(m828getTypeUIouoOA, TextUnitType.INSTANCE.m862getSpUIouoOA())) {
            setSpan(setFontSize, new AbsoluteSizeSpan(MathKt.roundToInt(density.m628toPxR2X_6o(fontSize)), false), start, end);
        } else if (TextUnitType.m857equalsimpl0(m828getTypeUIouoOA, TextUnitType.INSTANCE.m861getEmUIouoOA())) {
            setSpan(setFontSize, new RelativeSizeSpan(TextUnit.m829getValueimpl(fontSize)), start, end);
        }
    }
    ...
    public static final void m390setColorRPmYEkk(Spannable setColor, long color, int start, int end) {
        Intrinsics.checkNotNullParameter(setColor, "$this$setColor");
        if (color != Color.Companion.getUnspecified-0d7_KjU()) {
            setSpan(setColor, new ForegroundColorSpan(ColorKt.toArgb-8_81llA(color)), start, end);
        }
    }

    /* renamed from: setBaselineShift-0ocSgnM, reason: not valid java name */
    private static final void m389setBaselineShift0ocSgnM(Spannable $this$setBaselineShift_u2d0ocSgnM, BaselineShift baselineShift, int start, int end) {
        if (baselineShift != null) {
            float it = baselineShift.m405unboximpl();
    ...
    private static final void setBrush(Spannable $this$setBrush, Brush brush, float alpha, int start, int end) {
        if (brush != null) {
            if (brush instanceof SolidColor) {
                m390setColorRPmYEkk($this$setBrush, ((SolidColor) brush).getValue-0d7_KjU(), start, end);
    ...
    private static final boolean hasFontAttributes(TextStyle $this$hasFontAttributes) {
        return TextPaintExtensions_androidKt.hasFontAttributes($this$hasFontAttributes.toSpanStyle()) || $this$hasFontAttributes.m166getFontSynthesisZQGJjVo() != null;
    }
