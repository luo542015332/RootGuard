...
public final class AndroidAccessibilitySpannableString_androidKt {
    public static final SpannableString toAccessibilitySpannableString(AnnotatedString $this$toAccessibilitySpannableString, Density density, FontFamily.Resolver fontFamilyResolver, URLSpanCache urlSpanCache) {
        ...
        if ($this$fastForEach$iv != null) {
            ...
            for (int index$iv = 0; index$iv < size; index$iv++) {
                ...
                SpanStyle noFontStyle = SpanStyle.m92copyGSF8kmg$default(style, 0L, 0L, null, null, null, null, null, 0L, null, null, null, 0L, null, null, null, null, 65503, null);
    ...
    private static final void setSpanStyle(SpannableString $this$setSpanStyle, SpanStyle spanStyle, int start, int end, Density density, FontFamily.Resolver fontFamilyResolver) {
        SpannableExtensions_androidKt.m390setColorRPmYEkk($this$setSpanStyle, spanStyle.m101getColor0d7_KjU(), start, end);
        SpannableExtensions_androidKt.m391setFontSizeKmRG4DE($this$setSpanStyle, spanStyle.getFontSize(), density, start, end);
        if (spanStyle.getFontWeight() != null || spanStyle.getFontStyle() != null) {
            ...
            int fontStyle2 = fontStyle != null ? fontStyle.m241unboximpl() : FontStyle.INSTANCE.m243getNormal_LCdwA();
            $this$setSpanStyle.setSpan(new StyleSpan(AndroidFontUtils_androidKt.m192getAndroidTypefaceStyleFO1MlWM(fontWeight, fontStyle2)), start, end, 33);
        }
        if (spanStyle.getFontFamily() != null) {
            if (spanStyle.getFontFamily() instanceof GenericFontFamily) {
                ...
                Object value = FontFamily.Resolver.m212resolveDPcqOEQ$default(fontFamilyResolver, fontFamily, null, 0, fontSynthesis != null ? fontSynthesis.getValue() : FontSynthesis.INSTANCE.m253getAllGVVA2EU(), 6, null).getValue();
        ...
        SpannableExtensions_androidKt.m388setBackgroundRPmYEkk($this$setSpanStyle, spanStyle.getBackground(), start, end);
    }
}
