...
public final class AndroidDefaultTypeface implements AndroidTypeface {
    ...
    public Typeface mo364getNativeTypefacePYhJU0U(FontWeight fontWeight, int fontStyle, int synthesis) {
        ...
        if (Build.VERSION.SDK_INT < 28) {
            Typeface defaultFromStyle = Typeface.defaultFromStyle(AndroidFontUtils_androidKt.m192getAndroidTypefaceStyleFO1MlWM(fontWeight, fontStyle));
        ...
        return typefaceHelperMethodsApi28.create(DEFAULT, fontWeight.getWeight(), FontStyle.m238equalsimpl0(fontStyle, FontStyle.INSTANCE.m242getItalic_LCdwA()));
    }
}
