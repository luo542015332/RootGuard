...
public final class AndroidTextStyle_androidKt {
    ...
    public static final PlatformParagraphStyle lerp(PlatformParagraphStyle start, PlatformParagraphStyle stop, float fraction) {
        ...
        return start.getIncludeFontPadding() == stop.getIncludeFontPadding() ? start : new PlatformParagraphStyle(((EmojiSupportMatch) SpanStyleKt.lerpDiscrete(EmojiSupportMatch.m18boximpl(start.getEmojiSupportMatch()), EmojiSupportMatch.m18boximpl(stop.getEmojiSupportMatch()), fraction)).getValue(), ((Boolean) SpanStyleKt.lerpDiscrete(Boolean.valueOf(start.getIncludeFontPadding()), Boolean.valueOf(stop.getIncludeFontPadding()), fraction)).booleanValue(), (DefaultConstructorMarker) null);
    }
