...
public final class TextPainterKt {
    ...
    public static final void m121drawTextJFhB2K4(DrawScope drawText, TextMeasurer textMeasurer, AnnotatedString text, long topLeft, TextStyle style, int overflow, boolean softWrap, int maxLines, List<AnnotatedString.Range<Placeholder>> placeholders, long size, int blendMode) {
        Intrinsics.checkNotNullParameter(drawText, "$this$drawText");
        Intrinsics.checkNotNullParameter(textMeasurer, "textMeasurer");
        Intrinsics.checkNotNullParameter(text, "text");
        Intrinsics.checkNotNullParameter(style, "style");
        Intrinsics.checkNotNullParameter(placeholders, "placeholders");
        TextLayoutResult textLayoutResult = TextMeasurer.m118measurexDpz5zY$default(textMeasurer, text, style, overflow, softWrap, maxLines, placeholders, m129textLayoutConstraintsv_w8tDc(drawText, size, topLeft), drawText.getLayoutDirection(), (Density) drawText, null, false, 1536, null);
        ...
        $this$drawText_JFhB2K4_u24lambda_u240.translate(Offset.getX-impl(topLeft), Offset.getY-impl(topLeft));
        clip($this$drawText_JFhB2K4_u24lambda_u240, textLayoutResult);
        textLayoutResult.getMultiParagraph().m32paintLG529CI(drawText.getDrawContext().getCanvas(), (r14 & 2) != 0 ? Color.Companion.getUnspecified-0d7_KjU() : 0L, (r14 & 4) != 0 ? null : null, (r14 & 8) != 0 ? null : null, (r14 & 16) == 0 ? null : null, (r14 & 32) != 0 ? DrawScope.Companion.getDefaultBlendMode-0nO6VwU() : blendMode);
    ...
    public static final void m125drawTextTPWCCtM(DrawScope drawText, TextMeasurer textMeasurer, String text, long topLeft, TextStyle style, int overflow, boolean softWrap, int maxLines, long size, int blendMode) {
        Intrinsics.checkNotNullParameter(drawText, "$this$drawText");
        Intrinsics.checkNotNullParameter(textMeasurer, "textMeasurer");
        Intrinsics.checkNotNullParameter(text, "text");
        Intrinsics.checkNotNullParameter(style, "style");
        TextLayoutResult textLayoutResult = TextMeasurer.m118measurexDpz5zY$default(textMeasurer, new AnnotatedString(text, null, null, 6, null), style, overflow, softWrap, maxLines, null, m129textLayoutConstraintsv_w8tDc(drawText, size, topLeft), drawText.getLayoutDirection(), (Density) drawText, null, false, 1568, null);
        DrawContext $this$withTransform_u24lambda_u246$iv = drawText.getDrawContext();
        long previousSize$iv = $this$withTransform_u24lambda_u246$iv.getSize-NH-jbRc();
        $this$withTransform_u24lambda_u246$iv.getCanvas().save();
        DrawTransform $this$drawText_TPWCCtM_u24lambda_u242 = $this$withTransform_u24lambda_u246$iv.getTransform();
        $this$drawText_TPWCCtM_u24lambda_u242.translate(Offset.getX-impl(topLeft), Offset.getY-impl(topLeft));
    ...
    public static final void m127drawTextd8rzKo(DrawScope drawText, TextLayoutResult textLayoutResult, long color, long topLeft, float alpha, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int blendMode) {
        Intrinsics.checkNotNullParameter(drawText, "$this$drawText");
        ...
        $this$drawText_d8_rzKo_u24lambda_u244.translate(Offset.getX-impl(topLeft), Offset.getY-impl(topLeft));
        clip($this$drawText_d8_rzKo_u24lambda_u244, textLayoutResult);
        Brush brush = textLayoutResult.getLayoutInput().getStyle().getBrush();
        if (brush != null) {
            if (color == Color.Companion.getUnspecified-0d7_KjU()) {
                textLayoutResult.getMultiParagraph().m34painthn5TExg(drawText.getDrawContext().getCanvas(), brush, !Float.isNaN(alpha) ? alpha : textLayoutResult.getLayoutInput().getStyle().getAlpha(), newShadow, newTextDecoration, newDrawStyle, blendMode);
                $this$withTransform_u24lambda_u246$iv.getCanvas().restore();
                $this$withTransform_u24lambda_u246$iv.setSize-uvyYCjk(previousSize$iv);
            }
        }
        ...
        if (!($this$takeOrElse_u2dDxMtmZc$iv != Color.Companion.getUnspecified-0d7_KjU())) {
            $this$takeOrElse_u2dDxMtmZc$iv = textLayoutResult.getLayoutInput().getStyle().m163getColor0d7_KjU();
        }
        multiParagraph.m32paintLG529CI(canvas, TextDrawStyleKt.m524modulateDxMtmZc($this$takeOrElse_u2dDxMtmZc$iv, alpha), newShadow, newTextDecoration, newDrawStyle, blendMode);
        $this$withTransform_u24lambda_u246$iv.getCanvas().restore();
        $this$withTransform_u24lambda_u246$iv.setSize-uvyYCjk(previousSize$iv);
    }

    /* renamed from: drawText-LVfH_YU, reason: not valid java name */
    public static final void m123drawTextLVfH_YU(DrawScope drawText, TextLayoutResult textLayoutResult, Brush brush, long topLeft, float alpha, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int blendMode) {
        Intrinsics.checkNotNullParameter(drawText, "$this$drawText");
        Intrinsics.checkNotNullParameter(textLayoutResult, "textLayoutResult");
        ...
        $this$drawText_LVfH_YU_u24lambda_u247.translate(Offset.getX-impl(topLeft), Offset.getY-impl(topLeft));
    ...
    private static final void clip(DrawTransform $this$clip, TextLayoutResult textLayoutResult) {
        if (textLayoutResult.getHasVisualOverflow() && !TextOverflow.m546equalsimpl0(textLayoutResult.getLayoutInput().getOverflow(), TextOverflow.INSTANCE.m555getVisiblegIe3tQ8())) {
            DrawTransform.clipRect-N_I0leg$default($this$clip, 0.0f, 0.0f, IntSize.m808getWidthimpl(textLayoutResult.getSize()), IntSize.m807getHeightimpl(textLayoutResult.getSize()), 0, 16, (Object) null);
        }
    }

    /* renamed from: textLayoutConstraints-v_w8tDc, reason: not valid java name */
    private static final long m129textLayoutConstraintsv_w8tDc(DrawScope $this$textLayoutConstraints_u2dv_w8tDc, long size, long topLeft) {
        int minWidth;
        int maxWidth;
        int minHeight;
        int maxHeight;
        boolean z = true;
        boolean isWidthNaN = ((size > Size.Companion.getUnspecified-NH-jbRc() ? 1 : (size == Size.Companion.getUnspecified-NH-jbRc() ? 0 : -1)) == 0) || Float.isNaN(Size.getWidth-impl(size));
        if (isWidthNaN) {
            minWidth = 0;
            maxWidth = MathKt.roundToInt((float) Math.ceil(Size.getWidth-impl($this$textLayoutConstraints_u2dv_w8tDc.getSize-NH-jbRc()) - Offset.getX-impl(topLeft)));
        } else {
            int fixedWidth = MathKt.roundToInt((float) Math.ceil(Size.getWidth-impl(size)));
            minWidth = fixedWidth;
            maxWidth = fixedWidth;
        }
        if ((size == Size.Companion.getUnspecified-NH-jbRc() ? 1 : 0) == 0 && !Float.isNaN(Size.getHeight-impl(size))) {
            z = false;
        }
        boolean isHeightNaN = z;
        if (isHeightNaN) {
            minHeight = 0;
            maxHeight = MathKt.roundToInt((float) Math.ceil(Size.getHeight-impl($this$textLayoutConstraints_u2dv_w8tDc.getSize-NH-jbRc()) - Offset.getY-impl(topLeft)));
        } else {
            int fixedHeight = MathKt.roundToInt((float) Math.ceil(Size.getHeight-impl(size)));
