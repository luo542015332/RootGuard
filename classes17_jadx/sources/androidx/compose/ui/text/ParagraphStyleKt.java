...
public final class ParagraphStyleKt {
    private static final long DefaultLineHeight = TextUnit.INSTANCE.m840getUnspecifiedXSAIIZE();
    ...
    public static final ParagraphStyle lerp(ParagraphStyle start, ParagraphStyle stop, float fraction) {
        ...
        long m107lerpTextUnitInheritableC3pnCVY = SpanStyleKt.m107lerpTextUnitInheritableC3pnCVY(start.getLineHeight(), stop.getLineHeight(), fraction);
    ...
    public static final ParagraphStyle resolveParagraphStyleDefaults(ParagraphStyle style, LayoutDirection direction) {
        ...
        TextAlign m499boximpl = TextAlign.m499boximpl(style.getTextAlignOrDefault());
        TextDirection m512boximpl = TextDirection.m512boximpl(TextStyleKt.m174resolveTextDirectionYj3eThk(direction, style.getTextDirection()));
        long lineHeight = TextUnitKt.m847isUnspecifiedR2X_6o(style.getLineHeight()) ? DefaultLineHeight : style.getLineHeight();
        ...
        LineBreak m427boximpl = LineBreak.m427boximpl(style.getLineBreakOrDefault());
        Hyphens m418boximpl = Hyphens.m418boximpl(style.getHyphensOrDefault());
        TextMotion textMotion = style.getTextMotion();
        if (textMotion == null) {
            textMotion = TextMotion.INSTANCE.getStatic();
        }
        return new ParagraphStyle(m499boximpl, m512boximpl, lineHeight, textIndent2, platformStyle, lineHeightStyle, m427boximpl, m418boximpl, textMotion, (DefaultConstructorMarker) null);
    }

    /* JADX WARN: Code restructure failed: missing block: B:40:0x003e, code lost:
    
        if (androidx.compose.ui.unit.TextUnit.m826equalsimpl0(r12, r26.getLineHeight()) != false) goto L14;
     */
