...
public final class TextLayoutInput {
    ...
    public final TextLayoutInput m109copyhu1Yfo(AnnotatedString text, TextStyle style, List<AnnotatedString.Range<Placeholder>> placeholders, int maxLines, boolean softWrap, int overflow, Density density, LayoutDirection layoutDirection, Font.ResourceLoader resourceLoader, long constraints) {
        Intrinsics.checkNotNullParameter(text, "text");
        Intrinsics.checkNotNullParameter(style, "style");
        Intrinsics.checkNotNullParameter(placeholders, "placeholders");
        Intrinsics.checkNotNullParameter(density, "density");
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof TextLayoutInput) && Intrinsics.areEqual(this.text, ((TextLayoutInput) other).text) && Intrinsics.areEqual(this.style, ((TextLayoutInput) other).style) && Intrinsics.areEqual(this.placeholders, ((TextLayoutInput) other).placeholders) && this.maxLines == ((TextLayoutInput) other).maxLines && this.softWrap == ((TextLayoutInput) other).softWrap && TextOverflow.m546equalsimpl0(this.overflow, ((TextLayoutInput) other).overflow) && Intrinsics.areEqual(this.density, ((TextLayoutInput) other).density) && this.layoutDirection == ((TextLayoutInput) other).layoutDirection && Intrinsics.areEqual(this.fontFamilyResolver, ((TextLayoutInput) other).fontFamilyResolver) && Constraints.m585equalsimpl0(this.constraints, ((TextLayoutInput) other).constraints);
    }

    public int hashCode() {
        int result = this.text.hashCode();
        return (((((((((((((((((result * 31) + this.style.hashCode()) * 31) + this.placeholders.hashCode()) * 31) + this.maxLines) * 31) + Boolean.hashCode(this.softWrap)) * 31) + TextOverflow.m547hashCodeimpl(this.overflow)) * 31) + this.density.hashCode()) * 31) + this.layoutDirection.hashCode()) * 31) + this.fontFamilyResolver.hashCode()) * 31) + Constraints.m595hashCodeimpl(this.constraints);
    }

    public String toString() {
        return "TextLayoutInput(text=" + ((Object) this.text) + ", style=" + this.style + ", placeholders=" + this.placeholders + ", maxLines=" + this.maxLines + ", softWrap=" + this.softWrap + ", overflow=" + ((Object) TextOverflow.m548toStringimpl(this.overflow)) + ", density=" + this.density + ", layoutDirection=" + this.layoutDirection + ", fontFamilyResolver=" + this.fontFamilyResolver + ", constraints=" + ((Object) Constraints.m597toStringimpl(this.constraints)) + ')';
    }
}
