...
public final class TextFieldValueKt {
    public static final AnnotatedString getTextBeforeSelection(TextFieldValue $this$getTextBeforeSelection, int maxChars) {
        ...
        return $this$getTextBeforeSelection.getText().subSequence(Math.max(0, TextRange.m140getMinimpl($this$getTextBeforeSelection.getSelection()) - maxChars), TextRange.m140getMinimpl($this$getTextBeforeSelection.getSelection()));
    }
    ...
    public static final AnnotatedString getTextAfterSelection(TextFieldValue $this$getTextAfterSelection, int maxChars) {
        ...
        return $this$getTextAfterSelection.getText().subSequence(TextRange.m139getMaximpl($this$getTextAfterSelection.getSelection()), Math.min(TextRange.m139getMaximpl($this$getTextAfterSelection.getSelection()) + maxChars, $this$getTextAfterSelection.getText().length()));
    }
    ...
    public static final AnnotatedString getSelectedText(TextFieldValue $this$getSelectedText) {
        ...
        return $this$getSelectedText.getText().m17subSequence5zctL8($this$getSelectedText.getSelection());
    }
}
