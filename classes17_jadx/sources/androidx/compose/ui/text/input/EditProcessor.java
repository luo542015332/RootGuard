...
public final class EditProcessor {
    ...
    private TextFieldValue mBufferState = new TextFieldValue(AnnotatedStringKt.emptyAnnotatedString(), TextRange.INSTANCE.m147getZerod9O1mEE(), (TextRange) null, (DefaultConstructorMarker) null);
    ...
    public final void reset(TextFieldValue value, TextInputSession textInputSession) {
        ...
        boolean compositionChanged = !Intrinsics.areEqual(value.getComposition(), this.mBuffer.m283getCompositionMzsxiRA$ui_text_release());
        if (!Intrinsics.areEqual(this.mBufferState.getText(), value.getText())) {
            ...
            textChanged = true;
        } else if (!TextRange.m135equalsimpl0(this.mBufferState.getSelection(), value.getSelection())) {
            this.mBuffer.setSelection$ui_text_release(TextRange.m140getMinimpl(value.getSelection()), TextRange.m139getMaximpl(value.getSelection()));
            selectionChanged = true;
        }
        if (value.getComposition() == null) {
            this.mBuffer.commitComposition$ui_text_release();
        } else if (!TextRange.m136getCollapsedimpl(value.getComposition().getPackedValue())) {
            this.mBuffer.setComposition$ui_text_release(TextRange.m140getMinimpl(value.getComposition().getPackedValue()), TextRange.m139getMaximpl(value.getComposition().getPackedValue()));
        }
        if (textChanged || (!selectionChanged && compositionChanged)) {
            this.mBuffer.commitComposition$ui_text_release();
            newValue = TextFieldValue.m356copy3r_uNRQ$default(value, (AnnotatedString) null, 0L, (TextRange) null, 3, (Object) null);
        } else {
            newValue = value;
        }
    ...
    public final TextFieldValue apply(List<? extends EditCommand> editCommands) {
        ...
        try {
            ...
            TextFieldValue newState = new TextFieldValue(this.mBuffer.toAnnotatedString$ui_text_release(), this.mBuffer.m284getSelectiond9O1mEE$ui_text_release(), this.mBuffer.m283getCompositionMzsxiRA$ui_text_release(), (DefaultConstructorMarker) null);
    ...
    private final String generateBatchErrorMessage(List<? extends EditCommand> editCommands, final EditCommand failedCommand) {
        ...
        StringBuilder append = $this$generateBatchErrorMessage_u24lambda_u241.append("Error while applying EditCommand batch to buffer (length=" + this.mBuffer.getLength$ui_text_release() + ", composition=" + this.mBuffer.m283getCompositionMzsxiRA$ui_text_release() + ", selection=" + ((Object) TextRange.m145toStringimpl(this.mBuffer.m284getSelectiond9O1mEE$ui_text_release())) + "):");
