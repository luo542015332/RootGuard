...
public final class AndroidFontLoader implements PlatformFontLoader {
    ...
    public android.graphics.Typeface loadBlocking(Font font) {
        ...
        } else if (FontLoadingStrategy.m225equalsimpl0(loadingStrategy, FontLoadingStrategy.INSTANCE.m231getOptionalLocalPKNRLFQ())) {
            try {
                ...
                m1013constructorimpl = Result.m1013constructorimpl(load);
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                m1013constructorimpl = Result.m1013constructorimpl(ResultKt.createFailure(th));
            }
            typeface = (android.graphics.Typeface) (Result.m1019isFailureimpl(m1013constructorimpl) ? null : m1013constructorimpl);
        } else {
            if (FontLoadingStrategy.m225equalsimpl0(loadingStrategy, FontLoadingStrategy.INSTANCE.m229getAsyncPKNRLFQ())) {
                throw new UnsupportedOperationException("Unsupported Async font load path");
            }
            throw new IllegalArgumentException("Unknown loading type " + ((Object) FontLoadingStrategy.m227toStringimpl(font.getLoadingStrategy())));
        }
