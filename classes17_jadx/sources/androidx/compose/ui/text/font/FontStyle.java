...
public final class FontStyle {
    ...
    private static final int Normal = m236constructorimpl(0);
    private static final int Italic = m236constructorimpl(1);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ FontStyle m235boximpl(int i) {
    ...
    public static boolean m237equalsimpl(int i, Object obj) {
        return (obj instanceof FontStyle) && i == ((FontStyle) obj).m241unboximpl();
    }
    ...
    public static String m240toStringimpl(int arg0) {
        return m238equalsimpl0(arg0, Normal) ? "Normal" : m238equalsimpl0(arg0, Italic) ? "Italic" : "Invalid";
    }
    ...
    public static final class Companion {
        ...
        public final int m243getNormal_LCdwA() {
            return FontStyle.Normal;
        }

        /* renamed from: getItalic-_-LCdwA, reason: not valid java name */
        public final int m242getItalic_LCdwA() {
            return FontStyle.Italic;
        }

        public final List<FontStyle> values() {
            return CollectionsKt.listOf((Object[]) new FontStyle[]{FontStyle.m235boximpl(m243getNormal_LCdwA()), FontStyle.m235boximpl(m242getItalic_LCdwA())});
        }
    }
}
