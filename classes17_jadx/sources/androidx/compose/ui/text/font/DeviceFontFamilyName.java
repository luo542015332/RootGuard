...
public final class DeviceFontFamilyName {
    ...
    public static final /* synthetic */ DeviceFontFamilyName m203boximpl(String str) {
        return new DeviceFontFamilyName(str);
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m205equalsimpl(String str, Object obj) {
        return (obj instanceof DeviceFontFamilyName) && Intrinsics.areEqual(str, ((DeviceFontFamilyName) obj).m209unboximpl());
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m206equalsimpl0(String str, String str2) {
    ...
    public boolean equals(Object obj) {
        return m205equalsimpl(this.name, obj);
    }

    public int hashCode() {
        return m207hashCodeimpl(this.name);
    }

    public String toString() {
        return m208toStringimpl(this.name);
    }
    ...
    public static String m204constructorimpl(String name) {
