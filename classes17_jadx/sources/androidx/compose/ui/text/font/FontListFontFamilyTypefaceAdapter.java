...
public final class FontListFontFamilyTypefaceAdapter implements FontFamilyTypefaceAdapter {
    ...
    public final Object preload(FontFamily family, PlatformFontLoader resourceLoader, Continuation<? super Unit> continuation) {
        ...
        while (index$iv$iv < size) {
            ...
            int $i$f$fastFilter3 = FontLoadingStrategy.INSTANCE.m229getAsyncPKNRLFQ();
            if (FontLoadingStrategy.m225equalsimpl0(loadingStrategy, $i$f$fastFilter3)) {
                target$iv.add(it);
            }
            index$iv$iv++;
        ...
        while (index$iv$iv2 < size2) {
            ...
            target$iv2.add(TuplesKt.to(it2.getWeight(), FontStyle.m235boximpl(it2.getStyle())));
            index$iv$iv2++;
        ...
        while (index$iv < size4) {
            ...
            int fontStyle = ((FontStyle) pair.component2()).m241unboximpl();
            List matched = fontMatcher.m234matchFontRetOiIg((List<? extends Font>) allFonts, fontWeight, fontStyle);
            int index$iv2 = index$iv;
            TypefaceRequest typeRequest = new TypefaceRequest(family, fontWeight, fontStyle, FontSynthesis.INSTANCE.m253getAllGVVA2EU(), resourceLoader.getCacheKey(), null);
    ...
    public TypefaceResult resolve(TypefaceRequest typefaceRequest, PlatformFontLoader platformFontLoader, Function1<? super TypefaceResult.Immutable, Unit> onAsyncCompletion, Function1<? super TypefaceRequest, ? extends Object> createDefaultTypeface) {
        ...
        List matched = fontMatcher.m234matchFontRetOiIg(((FontListFontFamily) typefaceRequest.getFontFamily()).getFonts(), typefaceRequest.getFontWeight(), typefaceRequest.m281getFontStyle_LCdwA());
