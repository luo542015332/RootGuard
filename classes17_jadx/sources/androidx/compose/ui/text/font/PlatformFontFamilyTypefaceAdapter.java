...
public final class PlatformFontFamilyTypefaceAdapter implements FontFamilyTypefaceAdapter {
    ...
    public TypefaceResult resolve(TypefaceRequest typefaceRequest, PlatformFontLoader platformFontLoader, Function1<? super TypefaceResult.Immutable, Unit> onAsyncCompletion, Function1<? super TypefaceRequest, ? extends Object> createDefaultTypeface) {
        ...
        if (fontFamily == null ? true : fontFamily instanceof DefaultFontFamily) {
            result = this.platformTypefaceResolver.mo263createDefaultFO1MlWM(typefaceRequest.getFontWeight(), typefaceRequest.m281getFontStyle_LCdwA());
        } else if (fontFamily instanceof GenericFontFamily) {
            result = this.platformTypefaceResolver.mo264createNamedRetOiIg((GenericFontFamily) typefaceRequest.getFontFamily(), typefaceRequest.getFontWeight(), typefaceRequest.m281getFontStyle_LCdwA());
        } else {
            ...
            result = ((AndroidTypeface) typeface).mo364getNativeTypefacePYhJU0U(typefaceRequest.getFontWeight(), typefaceRequest.m281getFontStyle_LCdwA(), typefaceRequest.m282getFontSynthesisGVVA2EU());
        }
