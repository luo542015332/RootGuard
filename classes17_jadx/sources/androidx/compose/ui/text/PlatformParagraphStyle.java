...
public final class PlatformParagraphStyle {
    ...
    public PlatformParagraphStyle(boolean includeFontPadding) {
        ...
        this.emojiSupportMatch = EmojiSupportMatch.INSTANCE.m25getDefault_3YsG6Y();
    }
    ...
    public /* synthetic */ PlatformParagraphStyle(int i, boolean z, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this((i2 & 1) != 0 ? EmojiSupportMatch.INSTANCE.m25getDefault_3YsG6Y() : i, (i2 & 2) != 0 ? true : z, (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ PlatformParagraphStyle(int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this((i2 & 1) != 0 ? EmojiSupportMatch.INSTANCE.m25getDefault_3YsG6Y() : i, (DefaultConstructorMarker) null);
    }

    public PlatformParagraphStyle() {
        this(EmojiSupportMatch.INSTANCE.m25getDefault_3YsG6Y(), true, (DefaultConstructorMarker) null);
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof PlatformParagraphStyle) && this.includeFontPadding == ((PlatformParagraphStyle) other).includeFontPadding && EmojiSupportMatch.m21equalsimpl0(this.emojiSupportMatch, ((PlatformParagraphStyle) other).emojiSupportMatch);
    }

    public int hashCode() {
        int result = Boolean.hashCode(this.includeFontPadding);
        return (result * 31) + EmojiSupportMatch.m22hashCodeimpl(this.emojiSupportMatch);
    }

    public String toString() {
        return "PlatformParagraphStyle(includeFontPadding=" + this.includeFontPadding + ", emojiSupportMatch=" + ((Object) EmojiSupportMatch.m23toStringimpl(this.emojiSupportMatch)) + ')';
    }
