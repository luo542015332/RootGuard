...
public final class LineBreak {
    ...
    private static final int Simple = m429constructorimpl(Strategy.INSTANCE.m452getSimplefcGXIks(), Strictness.INSTANCE.m462getNormalusljTpc(), WordBreak.INSTANCE.m471getDefaultjp8hJ3c());
    private static final int Heading = m429constructorimpl(Strategy.INSTANCE.m450getBalancedfcGXIks(), Strictness.INSTANCE.m461getLooseusljTpc(), WordBreak.INSTANCE.m472getPhrasejp8hJ3c());
    private static final int Paragraph = m429constructorimpl(Strategy.INSTANCE.m451getHighQualityfcGXIks(), Strictness.INSTANCE.m463getStrictusljTpc(), WordBreak.INSTANCE.m471getDefaultjp8hJ3c());

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ LineBreak m427boximpl(int i) {
    ...
    public boolean equals(Object obj) {
        return m432equalsimpl(this.mask, obj);
    }

    public int hashCode() {
        return m437hashCodeimpl(this.mask);
    }
    ...
    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m429constructorimpl(int strategy, int strictness, int wordBreak) {
        int packBytes;
        packBytes = LineBreak_androidKt.packBytes(strategy, strictness, wordBreak);
        return m428constructorimpl(packBytes);
    }

    /* renamed from: getStrategy-fcGXIks, reason: not valid java name */
    public static final int m434getStrategyfcGXIks(int arg0) {
        int unpackByte1;
        unpackByte1 = LineBreak_androidKt.unpackByte1(arg0);
        return Strategy.m444constructorimpl(unpackByte1);
    }

    /* renamed from: getStrictness-usljTpc, reason: not valid java name */
    public static final int m435getStrictnessusljTpc(int arg0) {
        int unpackByte2;
        unpackByte2 = LineBreak_androidKt.unpackByte2(arg0);
        return Strictness.m454constructorimpl(unpackByte2);
    }

    /* renamed from: getWordBreak-jp8hJ3c, reason: not valid java name */
    public static final int m436getWordBreakjp8hJ3c(int arg0) {
        int unpackByte3;
        unpackByte3 = LineBreak_androidKt.unpackByte3(arg0);
        return WordBreak.m465constructorimpl(unpackByte3);
    }

    /* renamed from: copy-gijOMQM$default, reason: not valid java name */
    public static /* synthetic */ int m431copygijOMQM$default(int i, int i2, int i3, int i4, int i5, Object obj) {
        if ((i5 & 1) != 0) {
            i2 = m434getStrategyfcGXIks(i);
        }
        if ((i5 & 2) != 0) {
            i3 = m435getStrictnessusljTpc(i);
        }
        if ((i5 & 4) != 0) {
            i4 = m436getWordBreakjp8hJ3c(i);
        }
        return m430copygijOMQM(i, i2, i3, i4);
    }

    /* renamed from: copy-gijOMQM, reason: not valid java name */
    public static final int m430copygijOMQM(int arg0, int strategy, int strictness, int wordBreak) {
        return m429constructorimpl(strategy, strictness, wordBreak);
    }

    public String toString() {
        return m438toStringimpl(this.mask);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m438toStringimpl(int arg0) {
        return "LineBreak(strategy=" + ((Object) Strategy.m448toStringimpl(m434getStrategyfcGXIks(arg0))) + ", strictness=" + ((Object) Strictness.m458toStringimpl(m435getStrictnessusljTpc(arg0))) + ", wordBreak=" + ((Object) WordBreak.m469toStringimpl(m436getWordBreakjp8hJ3c(arg0))) + ')';
    }
    ...
    public static final class Companion {
        ...
        public final int m442getSimplerAG3T2k() {
            return LineBreak.Simple;
        }

        /* renamed from: getHeading-rAG3T2k, reason: not valid java name */
        public final int m440getHeadingrAG3T2k() {
            return LineBreak.Heading;
        }

        /* renamed from: getParagraph-rAG3T2k, reason: not valid java name */
        public final int m441getParagraphrAG3T2k() {
    ...
    public static final class Strategy {
        ...
        /* renamed from: Companion, reason: from kotlin metadata */
        public static final Companion INSTANCE = new Companion(null);
        private static final int Simple = m444constructorimpl(1);
        private static final int HighQuality = m444constructorimpl(2);
        private static final int Balanced = m444constructorimpl(3);

        /* renamed from: box-impl, reason: not valid java name */
        public static final /* synthetic */ Strategy m443boximpl(int i) {
            return new Strategy(i);
        }

        /* renamed from: constructor-impl, reason: not valid java name */
        public static int m444constructorimpl(int i) {
            return i;
        }
        ...
        public static final class Companion {
            ...
            public final int m452getSimplefcGXIks() {
                return Strategy.Simple;
            }

            /* renamed from: getHighQuality-fcGXIks, reason: not valid java name */
            public final int m451getHighQualityfcGXIks() {
                return Strategy.HighQuality;
            }

            /* renamed from: getBalanced-fcGXIks, reason: not valid java name */
            public final int m450getBalancedfcGXIks() {
        ...
        /* renamed from: toString-impl, reason: not valid java name */
        public static String m448toStringimpl(int arg0) {
            return m446equalsimpl0(arg0, Simple) ? "Strategy.Simple" : m446equalsimpl0(arg0, HighQuality) ? "Strategy.HighQuality" : m446equalsimpl0(arg0, Balanced) ? "Strategy.Balanced" : "Invalid";
        }
    ...
    public static final class Strictness {
        ...
        /* renamed from: Companion, reason: from kotlin metadata */
        public static final Companion INSTANCE = new Companion(null);
        private static final int Default = m454constructorimpl(1);
        private static final int Loose = m454constructorimpl(2);
        private static final int Normal = m454constructorimpl(3);
        private static final int Strict = m454constructorimpl(4);
        private final int value;

        /* renamed from: box-impl, reason: not valid java name */
        public static final /* synthetic */ Strictness m453boximpl(int i) {
            return new Strictness(i);
        }

        /* renamed from: constructor-impl, reason: not valid java name */
        public static int m454constructorimpl(int i) {
            return i;
        }

        /* renamed from: equals-impl, reason: not valid java name */
        public static boolean m455equalsimpl(int i, Object obj) {
        ...
        /* renamed from: hashCode-impl, reason: not valid java name */
        public static int m457hashCodeimpl(int i) {
            return Integer.hashCode(i);
        }

        public boolean equals(Object obj) {
            return m455equalsimpl(this.value, obj);
        }
        ...
        public static final class Companion {
            ...
            public final int m460getDefaultusljTpc() {
                return Strictness.Default;
            }

            /* renamed from: getLoose-usljTpc, reason: not valid java name */
            public final int m461getLooseusljTpc() {
                return Strictness.Loose;
            }

            /* renamed from: getNormal-usljTpc, reason: not valid java name */
            public final int m462getNormalusljTpc() {
                return Strictness.Normal;
            }

            /* renamed from: getStrict-usljTpc, reason: not valid java name */
            public final int m463getStrictusljTpc() {
        ...
        /* renamed from: toString-impl, reason: not valid java name */
        public static String m458toStringimpl(int arg0) {
            return m456equalsimpl0(arg0, Default) ? "Strictness.None" : m456equalsimpl0(arg0, Loose) ? "Strictness.Loose" : m456equalsimpl0(arg0, Normal) ? "Strictness.Normal" : m456equalsimpl0(arg0, Strict) ? "Strictness.Strict" : "Invalid";
        }
    ...
    public static final class WordBreak {
        ...
        /* renamed from: Companion, reason: from kotlin metadata */
        public static final Companion INSTANCE = new Companion(null);
        private static final int Default = m465constructorimpl(1);
        private static final int Phrase = m465constructorimpl(2);
        private final int value;

        /* renamed from: box-impl, reason: not valid java name */
        public static final /* synthetic */ WordBreak m464boximpl(int i) {
        ...
        public static final class Companion {
            ...
            public final int m471getDefaultjp8hJ3c() {
                return WordBreak.Default;
            }

            /* renamed from: getPhrase-jp8hJ3c, reason: not valid java name */
            public final int m472getPhrasejp8hJ3c() {
        ...
        /* renamed from: toString-impl, reason: not valid java name */
        public static String m469toStringimpl(int arg0) {
            return m467equalsimpl0(arg0, Default) ? "WordBreak.None" : m467equalsimpl0(arg0, Phrase) ? "WordBreak.Phrase" : "Invalid";
        }
