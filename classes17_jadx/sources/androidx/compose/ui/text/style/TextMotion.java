...
public final class TextMotion {
    ...
    static {
        ...
        Static = new TextMotion(Linearity.INSTANCE.m540getFontHinting4e0Vf04(), false, defaultConstructorMarker);
        Animated = new TextMotion(Linearity.INSTANCE.m541getLinear4e0Vf04(), true, defaultConstructorMarker);
    }

    /* renamed from: copy-JdDtMQo$ui_text_release$default, reason: not valid java name */
    public static /* synthetic */ TextMotion m530copyJdDtMQo$ui_text_release$default(TextMotion textMotion, int i, boolean z, int i2, Object obj) {
        if ((i2 & 1) != 0) {
        ...
        return textMotion.m531copyJdDtMQo$ui_text_release(i, z);
    }

    /* renamed from: copy-JdDtMQo$ui_text_release, reason: not valid java name */
    public final TextMotion m531copyJdDtMQo$ui_text_release(int linearity, boolean subpixelTextPositioning) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof TextMotion) && Linearity.m536equalsimpl0(this.linearity, ((TextMotion) other).linearity) && this.subpixelTextPositioning == ((TextMotion) other).subpixelTextPositioning;
    }

    public int hashCode() {
        int result = Linearity.m537hashCodeimpl(this.linearity);
    ...
    public static final class Linearity {
        ...
        private static final int Linear = m534constructorimpl(1);
        private static final int FontHinting = m534constructorimpl(2);
        private static final int None = m534constructorimpl(3);

        /* renamed from: box-impl, reason: not valid java name */
        public static final /* synthetic */ Linearity m533boximpl(int i) {
            return new Linearity(i);
        }

        /* renamed from: constructor-impl, reason: not valid java name */
        private static int m534constructorimpl(int i) {
            return i;
        }

        /* renamed from: equals-impl, reason: not valid java name */
        public static boolean m535equalsimpl(int i, Object obj) {
            return (obj instanceof Linearity) && i == ((Linearity) obj).getValue();
        }

        /* renamed from: equals-impl0, reason: not valid java name */
        public static final boolean m536equalsimpl0(int i, int i2) {
            return i == i2;
        }
        ...
        public boolean equals(Object obj) {
            return m535equalsimpl(this.value, obj);
        }
        ...
        public static final class Companion {
            ...
            public final int m541getLinear4e0Vf04() {
                return Linearity.Linear;
            }

            /* renamed from: getFontHinting-4e0Vf04, reason: not valid java name */
            public final int m540getFontHinting4e0Vf04() {
                return Linearity.FontHinting;
            }

            /* renamed from: getNone-4e0Vf04, reason: not valid java name */
            public final int m542getNone4e0Vf04() {
        ...
        public static String m538toStringimpl(int arg0) {
            return m536equalsimpl0(arg0, Linear) ? "Linearity.Linear" : m536equalsimpl0(arg0, FontHinting) ? "Linearity.FontHinting" : m536equalsimpl0(arg0, None) ? "Linearity.None" : "Invalid";
        }
