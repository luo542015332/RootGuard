...
public final class TextDrawStyleKt {
    public static final TextForegroundStyle lerp(TextForegroundStyle start, TextForegroundStyle stop, float fraction) {
        ...
        if (!(start instanceof BrushStyle) && !(stop instanceof BrushStyle)) {
            return TextForegroundStyle.INSTANCE.m525from8_81llA(ColorKt.lerp-jxsXWHM(start.mo413getColor0d7_KjU(), stop.mo413getColor0d7_KjU(), fraction));
        }
        if ((start instanceof BrushStyle) && (stop instanceof BrushStyle)) {
    ...
    public static final long m524modulateDxMtmZc(long $this$modulate_u2dDxMtmZc, float alpha) {
        if (Float.isNaN(alpha) || alpha >= 1.0f) {
            return $this$modulate_u2dDxMtmZc;
        }
        return Color.copy-wmQWz5c$default($this$modulate_u2dDxMtmZc, Color.getAlpha-impl($this$modulate_u2dDxMtmZc) * alpha, 0.0f, 0.0f, 0.0f, 14, (Object) null);
    }
