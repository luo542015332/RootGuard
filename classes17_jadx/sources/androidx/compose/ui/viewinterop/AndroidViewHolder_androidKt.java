...
public final class AndroidViewHolder_androidKt {
    ...
    public static final void layoutAccordingTo(View $this$layoutAccordingTo, LayoutNode layoutNode) {
        ...
        int x = MathKt.roundToInt(Offset.getX-impl(position));
        int y = MathKt.roundToInt(Offset.getY-impl(position));
    ...
    public static final int toNestedScrollSource(int type) {
        return type == 0 ? NestedScrollSource.Companion.getDrag-WNlRxjI() : NestedScrollSource.Companion.getFling-WNlRxjI();
    }
}
