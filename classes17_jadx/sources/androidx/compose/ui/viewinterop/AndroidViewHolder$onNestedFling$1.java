        ...
        switch (this.label) {
            case 0:
                ...
                if (!this.$consumed) {
                    ...
                    this.label = 1;
                    if (nestedScrollDispatcher2.dispatchPostFling-RZ2iAVY(Velocity.INSTANCE.m884getZero9UxMQ8M(), this.$viewVelocity, this) != coroutine_suspended) {
                        break;
                    } else {
                    ...
                    this.label = 2;
                    if (nestedScrollDispatcher.dispatchPostFling-RZ2iAVY(this.$viewVelocity, Velocity.INSTANCE.m884getZero9UxMQ8M(), this) != coroutine_suspended) {
                        break;
                    } else {
                        return coroutine_suspended;
                    }
