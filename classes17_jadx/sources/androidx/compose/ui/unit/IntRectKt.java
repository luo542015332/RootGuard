...
public final class IntRectKt {
    ...
    public static final IntRect m798IntRectVbeCjmY(long offset, long size) {
        return new IntRect(IntOffset.m766getXimpl(offset), IntOffset.m767getYimpl(offset), IntOffset.m766getXimpl(offset) + IntSize.m808getWidthimpl(size), IntOffset.m767getYimpl(offset) + IntSize.m807getHeightimpl(size));
    }

    /* renamed from: IntRect-E1MhUcY, reason: not valid java name */
    public static final IntRect m797IntRectE1MhUcY(long topLeft, long bottomRight) {
        return new IntRect(IntOffset.m766getXimpl(topLeft), IntOffset.m767getYimpl(topLeft), IntOffset.m766getXimpl(bottomRight), IntOffset.m767getYimpl(bottomRight));
    }

    /* renamed from: IntRect-ar5cAso, reason: not valid java name */
    public static final IntRect m799IntRectar5cAso(long center, int radius) {
        return new IntRect(IntOffset.m766getXimpl(center) - radius, IntOffset.m767getYimpl(center) - radius, IntOffset.m766getXimpl(center) + radius, IntOffset.m767getYimpl(center) + radius);
    }
