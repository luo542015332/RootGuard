...
public class LifecycleRegistry extends Lifecycle {
    ...
    private final boolean isSynced() {
        ...
        Lifecycle.State eldestObserverState = ((ObserverWithState) eldest.getValue()).getState();
        Map.Entry newest = this.observerMap.newest();
        Intrinsics.checkNotNull(newest);
        Lifecycle.State newestObserverState = ((ObserverWithState) newest.getValue()).getState();
    ...
    private final Lifecycle.State calculateTargetState(LifecycleObserver observer) {
        ...
        Lifecycle.State siblingState = (map == null || (observerWithState = (ObserverWithState) map.getValue()) == null) ? null : observerWithState.getState();
    ...
    public void addObserver(LifecycleObserver observer) {
        ...
        ObserverWithState previous = (ObserverWithState) this.observerMap.putIfAbsent(observer, statefulObserver);
