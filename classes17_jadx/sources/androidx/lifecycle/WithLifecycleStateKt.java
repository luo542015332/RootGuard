            ...
            public void onStateChanged(LifecycleOwner source, Lifecycle.Event event) {
                ...
                if (event == Lifecycle.Event.INSTANCE.upTo(Lifecycle.State.this)) {
                    ...
                    try {
                        ...
                        m1013constructorimpl = Result.m1013constructorimpl(function02.invoke());
                    } catch (Throwable th) {
                        Result.Companion companion2 = Result.INSTANCE;
                        m1013constructorimpl = Result.m1013constructorimpl(ResultKt.createFailure(th));
                    }
                    continuation2.resumeWith(m1013constructorimpl);
                    return;
                }
                if (event == Lifecycle.Event.ON_DESTROY) {
                    ...
                    continuation3.resumeWith(Result.m1013constructorimpl(ResultKt.createFailure(new LifecycleDestroyedException())));
                }
            }
        };
        if (dispatchNeeded) {
            lifecycleDispatcher.mo2571dispatch(EmptyCoroutineContext.INSTANCE, new Runnable() { // from class: androidx.lifecycle.WithLifecycleStateKt$suspendWithStateAtLeastUnchecked$2$1
        ...
        co.invokeOnCancellation(new Function1<Throwable, Unit>() { // from class: androidx.lifecycle.WithLifecycleStateKt$suspendWithStateAtLeastUnchecked$2$2
            ...
            public final void invoke2(Throwable it) {
                if (CoroutineDispatcher.this.isDispatchNeeded(EmptyCoroutineContext.INSTANCE)) {
                    ...
                    coroutineDispatcher.mo2571dispatch(emptyCoroutineContext, new Runnable() { // from class: androidx.lifecycle.WithLifecycleStateKt$suspendWithStateAtLeastUnchecked$2$2.1
                        @Override // java.lang.Runnable
                        public final void run() {
