...
public final class UStringsKt {
    ...
    public static final String m2326toStringLxnNnR4(byte $this$toString_u2dLxnNnR4, int radix) {
    ...
    public static final String m2328toStringolVBNx4(short $this$toString_u2dolVBNx4, int radix) {
    ...
    public static final String m2327toStringV7xB4Y4(int $this$toString_u2dV7xB4Y4, int radix) {
    ...
    public static final String m2325toStringJSWoG40(long $this$toString_u2dJSWoG40, int radix) {
    ...
    public static final UByte toUByteOrNull(String $this$toUByteOrNull, int radix) {
        ...
        if (Integer.compareUnsigned(data, UInt.m1108constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m1025boximpl(UByte.m1031constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String $this$toUShortOrNull, int radix) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compareUnsigned(data, UInt.m1108constructorimpl(65535)) > 0) {
            return null;
        }
        return UShort.m1288boximpl(UShort.m1294constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String $this$toUIntOrNull, int radix) {
        ...
        int uradix = UInt.m1108constructorimpl(radix);
        int result = 0;
        for (int i = start; i < length; i++) {
            ...
            int result2 = UInt.m1108constructorimpl(result * uradix);
            result = UInt.m1108constructorimpl(UInt.m1108constructorimpl(digit) + result2);
            if (Integer.compareUnsigned(result, result2) < 0) {
                return null;
            }
        }
        return UInt.m1102boximpl(result);
    }
    ...
    public static final ULong toULongOrNull(String $this$toULongOrNull, int radix) {
        ...
        long uradix = ULong.m1187constructorimpl(i);
        long result = 0;
        int i2 = start;
        while (i2 < length) {
            int length2 = length;
            ...
            long result2 = ULong.m1187constructorimpl(result * uradix);
            result = ULong.m1187constructorimpl(ULong.m1187constructorimpl(UInt.m1108constructorimpl(digit) & 4294967295L) + result2);
        ...
        return ULong.m1181boximpl(result);
    }
}
