...
public interface TimeMark {
    ...
    TimeMark mo2330minusLRDsOJo(long duration);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo2332plusLRDsOJo(long duration);
    ...
    public static final class DefaultImpls {
        ...
        public static TimeMark m2477plusLRDsOJo(TimeMark $this, long duration) {
            return new AdjustedTimeMark($this, duration, null);
        }

        /* renamed from: minus-LRDsOJo, reason: not valid java name */
        public static TimeMark m2476minusLRDsOJo(TimeMark $this, long duration) {
            return $this.mo2332plusLRDsOJo(Duration.m2392unaryMinusUwyO8pc(duration));
        }

        public static boolean hasPassedNow(TimeMark $this) {
            return !Duration.m2372isNegativeimpl($this.mo2329elapsedNowUwyO8pc());
        }
