...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public /* bridge */ /* synthetic */ ComparableTimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m2479boximpl(m2473markNowz9LOYto());
    }
    ...
    public long m2473markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m2482constructorimpl(read());
    }

    /* renamed from: elapsedFrom-6eNON_k, reason: not valid java name */
    public final long m2472elapsedFrom6eNON_k(long timeMark) {
    ...
    public final long m2471differenceBetweenfRLX17w(long one, long another) {
        return LongSaturatedMathKt.saturatingOriginsDiff(one, another, DurationUnit.NANOSECONDS);
    }

    /* renamed from: adjustReading-6QKq23U, reason: not valid java name */
    public final long m2470adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m2482constructorimpl(LongSaturatedMathKt.m2468saturatingAddNuflL3o(timeMark, DurationUnit.NANOSECONDS, duration));
    }
}
