...
public interface ComparableTimeMark extends TimeMark, Comparable<ComparableTimeMark> {
    ...
    ComparableTimeMark mo2330minusLRDsOJo(long duration);

    /* renamed from: minus-UwyO8pc */
    long mo2331minusUwyO8pc(ComparableTimeMark other);

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    ComparableTimeMark mo2332plusLRDsOJo(long duration);
    ...
    public static final class DefaultImpls {
        ...
        public static ComparableTimeMark m2334minusLRDsOJo(ComparableTimeMark $this, long duration) {
            return $this.mo2332plusLRDsOJo(Duration.m2392unaryMinusUwyO8pc(duration));
        }

        public static int compareTo(ComparableTimeMark $this, ComparableTimeMark other) {
            Intrinsics.checkNotNullParameter(other, "other");
            return Duration.m2338compareToLRDsOJo($this.mo2331minusUwyO8pc(other), Duration.INSTANCE.m2442getZEROUwyO8pc());
        }
    }
}
