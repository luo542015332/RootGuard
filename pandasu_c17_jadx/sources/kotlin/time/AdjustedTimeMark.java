...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark mo2330minusLRDsOJo(long duration) {
        return TimeMark.DefaultImpls.m2476minusLRDsOJo(this, duration);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: elapsedNow-UwyO8pc */
    public long mo2329elapsedNowUwyO8pc() {
        return Duration.m2374minusLRDsOJo(this.mark.mo2329elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo2332plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m2375plusLRDsOJo(this.adjustment, duration), null);
    }
}
