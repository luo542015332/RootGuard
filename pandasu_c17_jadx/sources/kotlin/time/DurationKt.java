...
public final class DurationKt {
    ...
    private static final long m2466timesmvk6XK0(int $this$times_u2dmvk6XK0, long duration) {
        return Duration.m2377timesUwyO8pc(duration, $this$times_u2dmvk6XK0);
    }

    /* renamed from: times-kIfJnKk */
    private static final long m2465timeskIfJnKk(double $this$times_u2dkIfJnKk, long duration) {
        return Duration.m2376timesUwyO8pc(duration, $this$times_u2dkIfJnKk);
    }
    ...
    */
    ...
    public static final long durationOfNanos(long normalNanos) {
        return Duration.m2339constructorimpl(normalNanos << 1);
    }

    public static final long durationOfMillis(long normalMillis) {
        return Duration.m2339constructorimpl((normalMillis << 1) + 1);
    }

    public static final long durationOf(long normalValue, int unitDiscriminator) {
        return Duration.m2339constructorimpl((normalValue << 1) + unitDiscriminator);
    }
