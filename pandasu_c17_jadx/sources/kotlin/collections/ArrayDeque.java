...
public final class ArrayDeque<E> extends AbstractMutableList<E> {
    ...
    public <T> T[] toArray(T[] array) {
        ...
        int i = this.head;
        if (i < positiveMod) {
            ArraysKt.copyInto$default(this.elementData, arrayOfNulls, 0, i, positiveMod, 2, (Object) null);
        } else if (!isEmpty()) {
            Object[] objArr = this.elementData;
            ArraysKt.copyInto(objArr, arrayOfNulls, 0, this.head, objArr.length);
            Object[] objArr2 = this.elementData;
            ArraysKt.copyInto(objArr2, arrayOfNulls, objArr2.length - this.head, 0, positiveMod);
        }
