...
public final class DefaultCallAdapterFactory extends CallAdapter.Factory {
    ...
    public static final class ExecutorCallbackCall<T> implements Call<T> {
        ...
        public class AnonymousClass1 implements Callback<T> {
            ...
            public void onResponse(Call<T> call, final Response<T> response) {
                ...
                executor.execute(new Runnable() { // from class: retrofit2.DefaultCallAdapterFactory$ExecutorCallbackCall$1$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        DefaultCallAdapterFactory.ExecutorCallbackCall.AnonymousClass1.this.m2789xddacc936(callback, response);
                    }
                });
            }
            ...
            public /* synthetic */ void m2789xddacc936(Callback callback, Response response) {
            ...
            public /* synthetic */ void m2788x714e864(Callback callback, Throwable t) {
            ...
            public void onFailure(Call<T> call, final Throwable t) {
                ...
                executor.execute(new Runnable() { // from class: retrofit2.DefaultCallAdapterFactory$ExecutorCallbackCall$1$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
                        DefaultCallAdapterFactory.ExecutorCallbackCall.AnonymousClass1.this.m2788x714e864(callback, t);
                    }
                });
            }
        }
