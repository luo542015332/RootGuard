...
public final class SplashScreen {
    ...
    public static class Impl {
        ...
        public Impl(Activity activity) {
            ...
            this.splashScreenWaitPredicate = new KeepOnScreenCondition() { // from class: androidx.core.splashscreen.SplashScreen$Impl$$ExternalSyntheticLambda1
                ...
                public final boolean shouldKeepOnScreen() {
                    boolean m925splashScreenWaitPredicate$lambda0;
                    m925splashScreenWaitPredicate$lambda0 = SplashScreen.Impl.m925splashScreenWaitPredicate$lambda0();
                    return m925splashScreenWaitPredicate$lambda0;
                }
            };
        }
        ...
        public static final boolean m925splashScreenWaitPredicate$lambda0() {
            return false;
        }
        ...
        public final void dispatchOnExitAnimation(final SplashScreenViewProvider splashScreenViewProvider) {
            ...
            splashScreenViewProvider.getView().postOnAnimation(new Runnable() { // from class: androidx.core.splashscreen.SplashScreen$Impl$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    SplashScreen.Impl.m924dispatchOnExitAnimation$lambda3(SplashScreenViewProvider.this, finalListener);
                }
            });
        }
        ...
        public static final void m924dispatchOnExitAnimation$lambda3(SplashScreenViewProvider splashScreenViewProvider, OnExitAnimationListener finalListener) {
            Intrinsics.checkNotNullParameter(splashScreenViewProvider, "$splashScreenViewProvider");
    ...
    public static final class Impl31 extends Impl {
        ...
        public void setOnExitAnimationListener(final OnExitAnimationListener exitAnimationListener) {
            ...
            getActivity().getSplashScreen().setOnExitAnimationListener(new SplashScreen.OnExitAnimationListener() { // from class: androidx.core.splashscreen.SplashScreen$Impl31$$ExternalSyntheticLambda0
                ...
                public final void onSplashScreenExit(SplashScreenView splashScreenView) {
                    SplashScreen.Impl31.m927setOnExitAnimationListener$lambda0(SplashScreen.Impl31.this, exitAnimationListener, splashScreenView);
                }
            });
        }
        ...
        public static final void m927setOnExitAnimationListener$lambda0(Impl31 this$0, OnExitAnimationListener exitAnimationListener, SplashScreenView splashScreenView) {
        ...
        private final void applyAppSystemUiTheme() {
            ...
            if (theme.resolveAttribute(R.attr.statusBarColor, tv, true)) {
                window.setStatusBarColor(tv.data);
            }
            if (theme.resolveAttribute(R.attr.navigationBarColor, tv, true)) {
                window.setNavigationBarColor(tv.data);
            }
            if (theme.resolveAttribute(R.attr.windowDrawsSystemBarBackgrounds, tv, true)) {
                if (tv.data != 0) {
            ...
            if (theme.resolveAttribute(R.attr.enforceNavigationBarContrast, tv, true)) {
                window.setNavigationBarContrastEnforced(tv.data != 0);
            }
            if (theme.resolveAttribute(R.attr.enforceStatusBarContrast, tv, true)) {
