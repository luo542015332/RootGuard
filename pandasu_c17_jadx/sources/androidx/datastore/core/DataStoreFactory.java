...
public final class DataStoreFactory {
    ...
    public static /* synthetic */ DataStore create$default(DataStoreFactory dataStoreFactory, Serializer serializer, ReplaceFileCorruptionHandler replaceFileCorruptionHandler, List list, CoroutineScope coroutineScope, Function0 function0, int i, Object obj) {
        ...
        if ((i & 8) != 0) {
            ...
            coroutineScope2 = CoroutineScopeKt.CoroutineScope(Dispatchers.getIO().plus(SupervisorKt.SupervisorJob$default((Job) null, 1, (Object) null)));
        } else {
            coroutineScope2 = coroutineScope;
        }
        return dataStoreFactory.create(serializer, replaceFileCorruptionHandler2, emptyList, coroutineScope2, function0);
    }
