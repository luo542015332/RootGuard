...
public final class NavInflater {
    ...
    private final void inflateArgumentForDestination(Resources res, NavDestination dest, AttributeSet attrs, int graphResId) throws XmlPullParserException {
        ...
        String name = $this$use$iv.getString(R.styleable.NavArgument_android_name);
        if (name == null) {
    ...
    private final NavArgument inflateArgument(TypedArray a, Resources res, int graphResId) throws XmlPullParserException {
        ...
        int i = 0;
        builder.setIsNullable(a.getBoolean(R.styleable.NavArgument_nullable, false));
        ...
        Object obj = null;
        String string = a.getString(R.styleable.NavArgument_argType);
        if (string == null) {
            navType = null;
        } else {
            navType = NavType.INSTANCE.fromArgType(string, res.getResourcePackageName(graphResId));
        }
        if (a.getValue(R.styleable.NavArgument_android_defaultValue, typedValue)) {
            if (navType == NavType.ReferenceType) {
                ...
                obj = a.getString(R.styleable.NavArgument_android_defaultValue);
            } else {
                switch (typedValue.type) {
                    case 3:
                        ...
                        break;
                    case 4:
                        navType = INSTANCE.checkNavType$navigation_runtime_release(typedValue, navType, NavType.FloatType, string, "float");
                        obj = Float.valueOf(typedValue.getFloat());
                        break;
                    case 5:
                        navType = INSTANCE.checkNavType$navigation_runtime_release(typedValue, navType, NavType.IntType, string, "dimension");
                        obj = Integer.valueOf((int) typedValue.getDimension(res.getDisplayMetrics()));
                        break;
                    case 18:
                        navType = INSTANCE.checkNavType$navigation_runtime_release(typedValue, navType, NavType.BoolType, string, "boolean");
                    ...
                    default:
                        if (typedValue.type >= 16 && typedValue.type <= 31) {
                            if (navType == NavType.FloatType) {
                                ...
                                navType = INSTANCE.checkNavType$navigation_runtime_release(typedValue, navType, NavType.IntType, string, "integer");
    ...
    private final void inflateDeepLink(Resources res, NavDestination dest, AttributeSet attrs) throws XmlPullParserException {
        ...
        String uri = $this$use$iv.getString(R.styleable.NavDeepLink_uri);
        String action = $this$use$iv.getString(R.styleable.NavDeepLink_action);
        String mimeType = $this$use$iv.getString(R.styleable.NavDeepLink_mimeType);
        String str3 = uri;
        boolean z = true;
    ...
    private final void inflateAction(Resources res, NavDestination dest, AttributeSet attrs, XmlResourceParser parser, int graphResId) throws IOException, XmlPullParserException {
        ...
        int destId = $this$inflateAction_u24lambda_u2410.getResourceId(R.styleable.NavAction_destination, 0);
