...
public final class AndroidDialog_androidKt {
    public static final void Dialog(final Function0<Unit> onDismissRequest, DialogProperties dialogProperties, final Function2<? super Composer, ? super Integer, Unit> content, Composer composer, final int i, final int i2) {
        ...
        if ((i5 & 731) == 146 && startRestartGroup.getSkipping()) {
            ...
            UUID dialogId = (UUID) RememberSaveableKt.rememberSaveable(new Object[0], (Saver) null, (String) null, new Function0<UUID>() { // from class: androidx.compose.ui.window.AndroidDialog_androidKt$Dialog$dialogId$1
            ...
            if (changed || rememberedValue == Composer.Companion.getEmpty()) {
                ...
                dialogWrapper.setContent(rememberCompositionContext, (Function2) ComposableLambdaKt.composableLambdaInstance(488261145, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.ui.window.AndroidDialog_androidKt$Dialog$dialog$1$1$1
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.ui.window.AndroidDialog_androidKt$Dialog$3
            ...
            public final void invoke(Composer composer3, int i6) {
                AndroidDialog_androidKt.Dialog(onDismissRequest, dialogProperties5, content, composer3, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
            }
        });
    }
