...
public final /* data */ class IntRect {
    ...
    public final long m792getSizeYbymL2g() {
    ...
    public final IntRect m796translategyyYBs(long offset) {
        return new IntRect(this.left + IntOffset.m766getXimpl(offset), this.top + IntOffset.m767getYimpl(offset), this.right + IntOffset.m766getXimpl(offset), this.bottom + IntOffset.m767getYimpl(offset));
    }
