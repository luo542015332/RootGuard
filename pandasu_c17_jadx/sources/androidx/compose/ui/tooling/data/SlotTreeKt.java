...
public final class SlotTreeKt {
    ...
    */
    ...
    public static final IntRect boundsOfLayoutNode(LayoutInfo node) {
        ...
        long size = node.getCoordinates().getSize-YbymL2g();
        int left = MathKt.roundToInt(Offset.getX-impl(position));
        int top = MathKt.roundToInt(Offset.getY-impl(position));
        int right = IntSize.m808getWidthimpl(size) + left;
        int bottom = IntSize.m807getHeightimpl(size) + top;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX WARN: Removed duplicated region for block: B:104:? A[LOOP:0: B:4:0x0017->B:104:?, LOOP_END, SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:13:0x0044 A[EDGE_INSN: B:13:0x0044->B:14:0x0044 BREAK  A[LOOP:0: B:4:0x0017->B:104:?], SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:41:0x0108 A[Catch: all -> 0x0205, TryCatch #1 {all -> 0x0205, blocks: (B:33:0x00c1, B:35:0x00db, B:37:0x00ed, B:41:0x0108, B:43:0x010b, B:51:0x0119, B:53:0x0140, B:55:0x014a, B:57:0x0151, B:59:0x0159, B:60:0x0169, B:62:0x0174, B:65:0x018f, B:68:0x01aa, B:71:0x01b1, B:74:0x01ba, B:78:0x01e1, B:88:0x0162, B:93:0x0146), top: B:32:0x00c1 }] */
