...
public final class PreviewActivity extends ComponentActivity {
    ...
    private final void setComposableContent(String composableFqn) {
        ...
        if (parameterProvider != null) {
            ...
            ComponentActivityKt.setContent$default(this, (CompositionContext) null, ComposableLambdaKt.composableLambdaInstance(-161032931, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.ui.tooling.PreviewActivity$setComposableContent$2
    ...
    private final void setParameterizedContent(final String className, final String methodName, String parameterProvider) {
        ...
        if (previewParameters.length > 1) {
            ComponentActivityKt.setContent$default(this, (CompositionContext) null, ComposableLambdaKt.composableLambdaInstance(-1735847170, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.ui.tooling.PreviewActivity$setParameterizedContent$1
                /* JADX INFO: Access modifiers changed from: package-private */
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(2);
                ...
                public final void invoke(Composer $composer, int $changed) {
                    ...
                    Function2 composableLambda = ComposableLambdaKt.composableLambda($composer, 2137630662, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.ui.tooling.PreviewActivity$setParameterizedContent$1.1
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        {
                            super(2);
                        }
                        ...
                        public final void invoke(Composer $composer2, int $changed2) {
                            ...
                            if (($changed2 & 11) != 2 || !$composer2.getSkipping()) {
                                ...
                                Function2<Composer, Integer, Unit> m559getLambda1$ui_tooling_release = ComposableSingletons$PreviewActivityKt.INSTANCE.m559getLambda1$ui_tooling_release();
                                final MutableIntState mutableIntState = index;
                                final Object[] objArr2 = objArr;
                                FloatingActionButtonKt.ExtendedFloatingActionButton-wqdebIU(m559getLambda1$ui_tooling_release, new Function0<Unit>() { // from class: androidx.compose.ui.tooling.PreviewActivity.setParameterizedContent.1.1.1
                                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                    {
                                        super(0);
                                    }
            ...
            ComponentActivityKt.setContent$default(this, (CompositionContext) null, ComposableLambdaKt.composableLambdaInstance(1507674311, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.ui.tooling.PreviewActivity$setParameterizedContent$2
                /* JADX INFO: Access modifiers changed from: package-private */
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(2);
