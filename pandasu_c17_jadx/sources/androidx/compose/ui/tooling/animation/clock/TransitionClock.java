...
public final class TransitionClock<T> implements ComposeAnimationClock<TransitionBasedAnimation<T>, TargetState<T>> {
    ...
    public TransitionClock(TransitionBasedAnimation<T> animation) {
        ...
        this.state = new TargetState<>(getAnimation().m567getAnimationObject().getCurrentState(), getAnimation().m567getAnimationObject().getTargetState());
    }
    ...
    public List<ComposeAnimatedProperty> getAnimatedProperties() {
        Iterable $this$mapNotNull$iv = UtilsKt.allAnimations(getAnimation().m567getAnimationObject());
    ...
    public long getMaxDurationPerIteration() {
        return UtilsKt.nanosToMillis(getAnimation().m567getAnimationObject().getTotalDurationNanos());
    }
    ...
    public List<TransitionInfo> getTransitions(long stepMillis) {
        Transition transition = getAnimation().m567getAnimationObject();
    ...
    public void setClockTime(long animationTimeNanos) {
        getAnimation().m567getAnimationObject().seek(getState().getInitial(), getState().getTarget(), animationTimeNanos);
    }
}
