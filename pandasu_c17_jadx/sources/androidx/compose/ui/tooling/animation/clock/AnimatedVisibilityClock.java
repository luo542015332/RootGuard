...
public final class AnimatedVisibilityClock implements ComposeAnimationClock<AnimatedVisibilityComposeAnimation, AnimatedVisibilityState> {
    ...
    public AnimatedVisibilityClock(AnimatedVisibilityComposeAnimation animation) {
        String m578getEnterjXw82LU;
        Intrinsics.checkNotNullParameter(animation, "animation");
        this.animation = animation;
        if (((Boolean) getAnimation().m564getAnimationObject().getCurrentState()).booleanValue()) {
            m578getEnterjXw82LU = AnimatedVisibilityState.INSTANCE.m579getExitjXw82LU();
        } else {
            m578getEnterjXw82LU = AnimatedVisibilityState.INSTANCE.m578getEnterjXw82LU();
        }
        this.state = m578getEnterjXw82LU;
    }
    ...
    public /* bridge */ /* synthetic */ AnimatedVisibilityState getState() {
        return AnimatedVisibilityState.m571boximpl(getState());
    }

    @Override // androidx.compose.ui.tooling.animation.clock.ComposeAnimationClock
    public /* bridge */ /* synthetic */ void setState(AnimatedVisibilityState animatedVisibilityState) {
        m570setState7IW2chM(animatedVisibilityState.m577unboximpl());
    }
    ...
    public void m570setState7IW2chM(String value) {
    ...
    public void setStateParameters(Object par1, Object par2) {
        ...
        m570setState7IW2chM(((AnimatedVisibilityState) par1).m577unboximpl());
    }
    ...
    public void setClockTime(long animationTimeNanos) {
        Transition it = getAnimation().m564getAnimationObject();
        Pair<Boolean, Boolean> m568toCurrentTargetPair7IW2chM = m568toCurrentTargetPair7IW2chM(getState());
        boolean current = m568toCurrentTargetPair7IW2chM.component1().booleanValue();
        boolean target = m568toCurrentTargetPair7IW2chM.component2().booleanValue();
    ...
    private final Pair<Boolean, Boolean> m568toCurrentTargetPair7IW2chM(String $this$toCurrentTargetPair_u2d7IW2chM) {
        return AnimatedVisibilityState.m574equalsimpl0($this$toCurrentTargetPair_u2d7IW2chM, AnimatedVisibilityState.INSTANCE.m578getEnterjXw82LU()) ? TuplesKt.to(false, true) : TuplesKt.to(true, false);
    }
}
