...
public interface TextForegroundStyle {
    ...
    public static final class Unspecified implements TextForegroundStyle {
        ...
        /* renamed from: getColor-0d7_KjU */
        public long mo413getColor0d7_KjU() {
    ...
    public static final class Companion {
        ...
        public final TextForegroundStyle m525from8_81llA(long color) {
            return (color > Color.Companion.getUnspecified-0d7_KjU() ? 1 : (color == Color.Companion.getUnspecified-0d7_KjU() ? 0 : -1)) != 0 ? new ColorStyle(color, null) : Unspecified.INSTANCE;
        }
        ...
        public final TextForegroundStyle from(Brush brush, float alpha) {
            ...
            if (brush instanceof SolidColor) {
                return m525from8_81llA(TextDrawStyleKt.m524modulateDxMtmZc(((SolidColor) brush).getValue-0d7_KjU(), alpha));
            }
