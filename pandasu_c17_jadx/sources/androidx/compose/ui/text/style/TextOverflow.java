...
public final class TextOverflow {
    ...
    private static final int Clip = m544constructorimpl(1);
    private static final int Ellipsis = m544constructorimpl(2);
    private static final int Visible = m544constructorimpl(3);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ TextOverflow m543boximpl(int i) {
    ...
    public static String m548toStringimpl(int arg0) {
        return m546equalsimpl0(arg0, Clip) ? "Clip" : m546equalsimpl0(arg0, Ellipsis) ? "Ellipsis" : m546equalsimpl0(arg0, Visible) ? "Visible" : "Invalid";
    }
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void m550getClipgIe3tQ8$annotations() {
        }

        /* renamed from: getEllipsis-gIe3tQ8$annotations, reason: not valid java name */
        public static /* synthetic */ void m551getEllipsisgIe3tQ8$annotations() {
        }

        /* renamed from: getVisible-gIe3tQ8$annotations, reason: not valid java name */
        public static /* synthetic */ void m552getVisiblegIe3tQ8$annotations() {
        }
        ...
        public final int m553getClipgIe3tQ8() {
            return TextOverflow.Clip;
        }

        /* renamed from: getEllipsis-gIe3tQ8, reason: not valid java name */
        public final int m554getEllipsisgIe3tQ8() {
            return TextOverflow.Ellipsis;
        }

        /* renamed from: getVisible-gIe3tQ8, reason: not valid java name */
        public final int m555getVisiblegIe3tQ8() {
