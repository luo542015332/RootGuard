...
public final class LineHeightStyle {
    ...
    static {
        ...
        Default = new LineHeightStyle(Alignment.INSTANCE.m484getProportionalPIaL0Z0(), Trim.INSTANCE.m495getBothEVpEnUU(), defaultConstructorMarker);
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof LineHeightStyle) && Alignment.m478equalsimpl0(this.alignment, ((LineHeightStyle) other).alignment) && Trim.m489equalsimpl0(this.trim, ((LineHeightStyle) other).trim);
    }

    public int hashCode() {
        int result = Alignment.m479hashCodeimpl(this.alignment);
        return (result * 31) + Trim.m490hashCodeimpl(this.trim);
    }

    public String toString() {
        return "LineHeightStyle(alignment=" + ((Object) Alignment.m480toStringimpl(this.alignment)) + ", trim=" + ((Object) Trim.m493toStringimpl(this.trim)) + ')';
    }
    ...
    public static final class Trim {
        ...
        private static final int FirstLineTop = m487constructorimpl(1);
        private static final int LastLineBottom = m487constructorimpl(16);
        private static final int Both = m487constructorimpl(17);
        private static final int None = m487constructorimpl(0);

        /* renamed from: box-impl, reason: not valid java name */
        public static final /* synthetic */ Trim m486boximpl(int i) {
            return new Trim(i);
        }
        ...
        public static String m493toStringimpl(int arg0) {
        ...
        public static final class Companion {
            ...
            public final int m496getFirstLineTopEVpEnUU() {
                return Trim.FirstLineTop;
            }

            /* renamed from: getLastLineBottom-EVpEnUU, reason: not valid java name */
            public final int m497getLastLineBottomEVpEnUU() {
                return Trim.LastLineBottom;
            }

            /* renamed from: getBoth-EVpEnUU, reason: not valid java name */
            public final int m495getBothEVpEnUU() {
                return Trim.Both;
            }

            /* renamed from: getNone-EVpEnUU, reason: not valid java name */
            public final int m498getNoneEVpEnUU() {
                return Trim.None;
            }
        }

        /* renamed from: isTrimFirstLineTop-impl$ui_text_release, reason: not valid java name */
        public static final boolean m491isTrimFirstLineTopimpl$ui_text_release(int arg0) {
            return (arg0 & 1) > 0;
        }

        /* renamed from: isTrimLastLineBottom-impl$ui_text_release, reason: not valid java name */
        public static final boolean m492isTrimLastLineBottomimpl$ui_text_release(int arg0) {
            return (arg0 & 16) > 0;
        }
    }
    ...
    public static final class Alignment {
        ...
        /* renamed from: Companion, reason: from kotlin metadata */
        public static final Companion INSTANCE = new Companion(null);
        private static final float Top = m476constructorimpl(0.0f);
        private static final float Center = m476constructorimpl(0.5f);
        private static final float Proportional = m476constructorimpl(-1.0f);
        private static final float Bottom = m476constructorimpl(1.0f);

        /* renamed from: box-impl, reason: not valid java name */
        public static final /* synthetic */ Alignment m475boximpl(float f) {
            return new Alignment(f);
        }

        /* renamed from: equals-impl, reason: not valid java name */
        public static boolean m477equalsimpl(float f, Object obj) {
            return (obj instanceof Alignment) && Float.compare(f, ((Alignment) obj).getTopRatio()) == 0;
        }

        /* renamed from: equals-impl0, reason: not valid java name */
        public static final boolean m478equalsimpl0(float f, float f2) {
            return Float.compare(f, f2) == 0;
        }

        /* renamed from: hashCode-impl, reason: not valid java name */
        public static int m479hashCodeimpl(float f) {
            return Float.hashCode(f);
        }

        public boolean equals(Object obj) {
            return m477equalsimpl(this.topRatio, obj);
        }

        public int hashCode() {
            return m479hashCodeimpl(this.topRatio);
        }
        ...
        /* renamed from: constructor-impl, reason: not valid java name */
        public static float m476constructorimpl(float topRatio) {
            boolean z = true;
        ...
        public String toString() {
            return m480toStringimpl(this.topRatio);
        }

        /* renamed from: toString-impl, reason: not valid java name */
        public static String m480toStringimpl(float arg0) {
            if (arg0 == Top) {
        ...
        public static final class Companion {
            ...
            public final float m485getTopPIaL0Z0() {
                return Alignment.Top;
            }

            /* renamed from: getCenter-PIaL0Z0, reason: not valid java name */
            public final float m483getCenterPIaL0Z0() {
                return Alignment.Center;
            }

            /* renamed from: getProportional-PIaL0Z0, reason: not valid java name */
            public final float m484getProportionalPIaL0Z0() {
                return Alignment.Proportional;
            }

            /* renamed from: getBottom-PIaL0Z0, reason: not valid java name */
            public final float m482getBottomPIaL0Z0() {
