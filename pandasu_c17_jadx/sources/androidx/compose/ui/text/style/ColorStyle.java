...
final /* data */ class ColorStyle implements TextForegroundStyle {
    ...
    public static /* synthetic */ ColorStyle m414copy8_81llA$default(ColorStyle colorStyle, long j, int i, Object obj) {
        if ((i & 1) != 0) {
            j = colorStyle.value;
        }
        return colorStyle.m416copy8_81llA(j);
    }
    ...
    public final ColorStyle m416copy8_81llA(long value) {
    ...
    public final long m417getValue0d7_KjU() {
        return this.value;
    }
    ...
    public float getAlpha() {
        return Color.getAlpha-impl(mo413getColor0d7_KjU());
    }
}
