...
public final class TextIndent {
    ...
    */
    ...
    public static /* synthetic */ TextIndent m526copyNB67dxo$default(TextIndent textIndent, long j, long j2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return textIndent.m527copyNB67dxo(j, j2);
    }

    /* renamed from: copy-NB67dxo, reason: not valid java name */
    public final TextIndent m527copyNB67dxo(long firstLine, long restLine) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof TextIndent) && TextUnit.m826equalsimpl0(this.firstLine, ((TextIndent) other).firstLine) && TextUnit.m826equalsimpl0(this.restLine, ((TextIndent) other).restLine);
    }

    public int hashCode() {
        int result = TextUnit.m830hashCodeimpl(this.firstLine);
        return (result * 31) + TextUnit.m830hashCodeimpl(this.restLine);
    }

    public String toString() {
        return "TextIndent(firstLine=" + ((Object) TextUnit.m836toStringimpl(this.firstLine)) + ", restLine=" + ((Object) TextUnit.m836toStringimpl(this.restLine)) + ')';
    }
}
