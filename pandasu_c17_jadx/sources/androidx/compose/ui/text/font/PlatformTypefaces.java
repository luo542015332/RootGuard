...
public interface PlatformTypefaces {
    ...
    android.graphics.Typeface mo263createDefaultFO1MlWM(FontWeight fontWeight, int fontStyle);

    /* renamed from: createNamed-RetOiIg, reason: not valid java name */
    android.graphics.Typeface mo264createNamedRetOiIg(GenericFontFamily name, FontWeight fontWeight, int fontStyle);

    /* renamed from: optionalOnDeviceFontFamilyByName-78DK7lM, reason: not valid java name */
    android.graphics.Typeface mo265optionalOnDeviceFontFamilyByName78DK7lM(String familyName, FontWeight weight, int style, FontVariation.Settings variationSettings, Context context);
}
