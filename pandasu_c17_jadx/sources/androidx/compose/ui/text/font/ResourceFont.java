...
public final class ResourceFont implements Font {
    ...
    public static /* synthetic */ void m274getLoadingStrategyPKNRLFQ$annotations() {
    }
    ...
    */
    public /* synthetic */ ResourceFont(int r8, androidx.compose.ui.text.font.FontWeight r9, int r10, androidx.compose.ui.text.font.FontVariation.Settings r11, int r12, int r13, kotlin.jvm.internal.DefaultConstructorMarker r14) {
        ...
        Ld:
            ...
            int r10 = r9.m243getNormal_LCdwA()
            r3 = r10
            goto L1a
        L19:
            r3 = r10
        L1a:
            ...
            androidx.compose.ui.text.font.FontVariation$Settings r11 = r9.m258Settings6EWAqTQ(r2, r3, r10)
            r4 = r11
            goto L2a
        L29:
            r4 = r11
        L2a:
            ...
            int r12 = r9.m229getAsyncPKNRLFQ()
            r5 = r12
            goto L37
        L36:
            r5 = r12
    ...
    public static /* synthetic */ ResourceFont m273copyRetOiIg$default(ResourceFont resourceFont, int i, FontWeight fontWeight, int i2, int i3, Object obj) {
        if ((i3 & 1) != 0) {
        ...
        return resourceFont.m276copyRetOiIg(i, fontWeight, i2);
    }

    /* renamed from: copy-RetOiIg, reason: not valid java name */
    public final ResourceFont m276copyRetOiIg(int resId, FontWeight weight, int style) {
        Intrinsics.checkNotNullParameter(weight, "weight");
        return m272copyF3nL8kk$default(this, resId, weight, style, getLoadingStrategy(), null, 16, null);
    }

    /* renamed from: copy-F3nL8kk$default, reason: not valid java name */
    public static /* synthetic */ ResourceFont m272copyF3nL8kk$default(ResourceFont resourceFont, int i, FontWeight fontWeight, int i2, int i3, FontVariation.Settings settings, int i4, Object obj) {
        if ((i4 & 1) != 0) {
            i = resourceFont.resId;
        }
        return resourceFont.m275copyF3nL8kk(i, (i4 & 2) != 0 ? resourceFont.getWeight() : fontWeight, (i4 & 4) != 0 ? resourceFont.getStyle() : i2, (i4 & 8) != 0 ? resourceFont.getLoadingStrategy() : i3, (i4 & 16) != 0 ? resourceFont.variationSettings : settings);
    }

    /* renamed from: copy-F3nL8kk, reason: not valid java name */
    public final ResourceFont m275copyF3nL8kk(int resId, FontWeight weight, int style, int loadingStrategy, FontVariation.Settings variationSettings) {
        Intrinsics.checkNotNullParameter(weight, "weight");
        Intrinsics.checkNotNullParameter(variationSettings, "variationSettings");
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof ResourceFont) && this.resId == ((ResourceFont) other).resId && Intrinsics.areEqual(getWeight(), ((ResourceFont) other).getWeight()) && FontStyle.m238equalsimpl0(getStyle(), ((ResourceFont) other).getStyle()) && Intrinsics.areEqual(this.variationSettings, ((ResourceFont) other).variationSettings) && FontLoadingStrategy.m225equalsimpl0(getLoadingStrategy(), ((ResourceFont) other).getLoadingStrategy());
    }

    public int hashCode() {
        int result = this.resId;
        return (((((((result * 31) + getWeight().hashCode()) * 31) + FontStyle.m239hashCodeimpl(getStyle())) * 31) + FontLoadingStrategy.m226hashCodeimpl(getLoadingStrategy())) * 31) + this.variationSettings.hashCode();
    }

    public String toString() {
        return "ResourceFont(resId=" + this.resId + ", weight=" + getWeight() + ", style=" + ((Object) FontStyle.m240toStringimpl(getStyle())) + ", loadingStrategy=" + ((Object) FontLoadingStrategy.m227toStringimpl(getLoadingStrategy())) + ')';
    }
}
