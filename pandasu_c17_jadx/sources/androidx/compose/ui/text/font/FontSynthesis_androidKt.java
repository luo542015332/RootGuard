...
public final class FontSynthesis_androidKt {
    ...
    public static final Object m257synthesizeTypefaceFxwP2eA(int $this$synthesizeTypeface_u2dFxwP2eA, Object typeface, Font font, FontWeight requestedWeight, int requestedStyle) {
        int finalFontWeight;
        ...
        boolean synthesizeWeight = FontSynthesis.m250isWeightOnimpl$ui_text_release($this$synthesizeTypeface_u2dFxwP2eA) && !Intrinsics.areEqual(font.getWeight(), requestedWeight) && requestedWeight.compareTo(AndroidFontUtils_androidKt.getAndroidBold(FontWeight.INSTANCE)) >= 0 && font.getWeight().compareTo(AndroidFontUtils_androidKt.getAndroidBold(FontWeight.INSTANCE)) < 0;
        boolean synthesizeStyle = FontSynthesis.m249isStyleOnimpl$ui_text_release($this$synthesizeTypeface_u2dFxwP2eA) && !FontStyle.m238equalsimpl0(requestedStyle, font.getStyle());
        if (!synthesizeStyle && !synthesizeWeight) {
            return typeface;
        }
        if (Build.VERSION.SDK_INT < 28) {
            int targetStyle = AndroidFontUtils_androidKt.getAndroidTypefaceStyle(synthesizeWeight, synthesizeStyle && FontStyle.m238equalsimpl0(requestedStyle, FontStyle.INSTANCE.m242getItalic_LCdwA()));
            ...
            if (synthesizeStyle) {
                finalFontStyle = FontStyle.m238equalsimpl0(requestedStyle, FontStyle.INSTANCE.m242getItalic_LCdwA());
            } else {
                finalFontStyle = FontStyle.m238equalsimpl0(font.getStyle(), FontStyle.INSTANCE.m242getItalic_LCdwA());
            }
