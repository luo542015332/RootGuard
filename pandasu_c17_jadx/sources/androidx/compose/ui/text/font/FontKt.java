...
public final class FontKt {
    ...
    public static /* synthetic */ Font m219FontRetOiIg$default(int i, FontWeight fontWeight, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            fontWeight = FontWeight.INSTANCE.getNormal();
        }
        if ((i3 & 4) != 0) {
            i2 = FontStyle.INSTANCE.m243getNormal_LCdwA();
        }
        return m218FontRetOiIg(i, fontWeight, i2);
    }
    ...
    public static final /* synthetic */ Font m218FontRetOiIg(int resId, FontWeight weight, int style) {
        Intrinsics.checkNotNullParameter(weight, "weight");
        return new ResourceFont(resId, weight, style, null, FontLoadingStrategy.INSTANCE.m230getBlockingPKNRLFQ(), 8, null);
    }

    /* renamed from: Font-YpTlLL0$default, reason: not valid java name */
    public static /* synthetic */ Font m221FontYpTlLL0$default(int i, FontWeight fontWeight, int i2, int i3, int i4, Object obj) {
        if ((i4 & 2) != 0) {
            fontWeight = FontWeight.INSTANCE.getNormal();
        }
        if ((i4 & 4) != 0) {
        ...
        if ((i4 & 8) != 0) {
            i3 = FontLoadingStrategy.INSTANCE.m230getBlockingPKNRLFQ();
        }
        return m220FontYpTlLL0(i, fontWeight, i2, i3);
    }

    /* renamed from: Font-YpTlLL0, reason: not valid java name */
    public static final Font m220FontYpTlLL0(int resId, FontWeight weight, int style, int loadingStrategy) {
        Intrinsics.checkNotNullParameter(weight, "weight");
    ...
    public static /* synthetic */ Font m217FontF3nL8kk$default(int i, FontWeight fontWeight, int i2, int i3, FontVariation.Settings settings, int i4, Object obj) {
        if ((i4 & 2) != 0) {
            fontWeight = FontWeight.INSTANCE.getNormal();
        }
        if ((i4 & 4) != 0) {
        ...
        if ((i4 & 16) != 0) {
            settings = FontVariation.INSTANCE.m258Settings6EWAqTQ(fontWeight, i2, new FontVariation.Setting[0]);
        }
        return m216FontF3nL8kk(i, fontWeight, i2, i3, settings);
    }

    /* renamed from: Font-F3nL8kk, reason: not valid java name */
    public static final Font m216FontF3nL8kk(int resId, FontWeight weight, int style, int loadingStrategy, FontVariation.Settings variationSettings) {
        Intrinsics.checkNotNullParameter(weight, "weight");
