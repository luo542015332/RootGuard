...
public final class FontVariation {
    ...
    private static final class SettingTextUnit implements Setting {
        ...
        public float toVariationValue(Density density) {
            if (density != null) {
                return TextUnit.m829getValueimpl(this.value) * density.getFontScale();
            }
        ...
        public boolean equals(Object other) {
            ...
            return (other instanceof SettingTextUnit) && Intrinsics.areEqual(getAxisName(), ((SettingTextUnit) other).getAxisName()) && TextUnit.m826equalsimpl0(this.value, ((SettingTextUnit) other).value);
        }

        public int hashCode() {
            int result = getAxisName().hashCode();
            return (result * 31) + TextUnit.m830hashCodeimpl(this.value);
        }

        public String toString() {
            return "FontVariation.Setting(axisName='" + getAxisName() + "', value=" + ((Object) TextUnit.m836toStringimpl(this.value)) + ')';
        }
    }
    ...
    public final Setting m259opticalSizingR2X_6o(long textSize) {
        if (!TextUnit.m832isSpimpl(textSize)) {
    ...
    public final Settings m258Settings6EWAqTQ(FontWeight weight, int style, Setting... settings) {
