...
public final class FontListFontFamilyTypefaceAdapterKt {
    ...
    public static final Pair<List<Font>, Object> firstImmediatelyAvailable(List<? extends Font> list, TypefaceRequest typefaceRequest, AsyncTypefaceCache asyncTypefaceCache, PlatformFontLoader platformFontLoader, Function1<? super TypefaceRequest, ? extends Object> function1) {
        ...
        for (int idx = 0; idx < size; idx++) {
            ...
            if (!FontLoadingStrategy.m225equalsimpl0(loadingStrategy, FontLoadingStrategy.INSTANCE.m230getBlockingPKNRLFQ())) {
                if (!FontLoadingStrategy.m225equalsimpl0(loadingStrategy, FontLoadingStrategy.INSTANCE.m231getOptionalLocalPKNRLFQ())) {
                    if (!FontLoadingStrategy.m225equalsimpl0(loadingStrategy, FontLoadingStrategy.INSTANCE.m229getAsyncPKNRLFQ())) {
                        throw new IllegalStateException("Unknown font type " + font);
                    }
                    AsyncTypefaceCache.AsyncTypefaceResult cacheResult = asyncTypefaceCache.m194get1ASDuI8(font, platformFontLoader);
                    if (cacheResult == null) {
                    ...
                    } else if (!AsyncTypefaceCache.AsyncTypefaceResult.m200isPermanentFailureimpl(cacheResult.m202unboximpl()) && cacheResult.m202unboximpl() != null) {
                        return TuplesKt.to(asyncFontsToLoad, FontSynthesis_androidKt.m257synthesizeTypefaceFxwP2eA(typefaceRequest.m282getFontSynthesisGVVA2EU(), cacheResult.m202unboximpl(), font, typefaceRequest.getFontWeight(), typefaceRequest.m281getFontStyle_LCdwA()));
                    }
                } else {
                    ...
                    synchronized (lock$iv$iv) {
                        ...
                        if (priorResult$iv == null) {
                            ...
                            try {
                                ...
                                it$iv = Result.m1013constructorimpl(platformFontLoader.loadBlocking(font));
                            } catch (Throwable th) {
                                Result.Companion companion2 = Result.INSTANCE;
                                it$iv = Result.m1013constructorimpl(ResultKt.createFailure(th));
                            }
                            if (Result.m1019isFailureimpl(it$iv)) {
                                it$iv = null;
                            }
                            AsyncTypefaceCache.put$default(asyncTypefaceCache, font, platformFontLoader, it$iv, false, 8, null);
                            obj = it$iv;
                        } else {
                            obj = priorResult$iv.m202unboximpl();
                        }
                    }
                    Object result2 = obj;
                    if (result2 != null) {
                        return TuplesKt.to(asyncFontsToLoad, FontSynthesis_androidKt.m257synthesizeTypefaceFxwP2eA(typefaceRequest.m282getFontSynthesisGVVA2EU(), result2, font, typefaceRequest.getFontWeight(), typefaceRequest.m281getFontStyle_LCdwA()));
                    }
                }
            } else {
                ...
                synchronized (lock$iv$iv2) {
                    ...
                    if (priorResult$iv2 == null) {
                        ...
                        result = priorResult$iv2.m202unboximpl();
                    }
                }
                if (result == null) {
                    throw new IllegalStateException("Unable to load font " + font);
                }
                return TuplesKt.to(asyncFontsToLoad, FontSynthesis_androidKt.m257synthesizeTypefaceFxwP2eA(typefaceRequest.m282getFontSynthesisGVVA2EU(), result, font, typefaceRequest.getFontWeight(), typefaceRequest.m281getFontStyle_LCdwA()));
            }
        }
