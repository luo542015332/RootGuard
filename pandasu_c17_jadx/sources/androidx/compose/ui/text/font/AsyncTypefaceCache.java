...
public final class AsyncTypefaceCache {
    private final Object PermanentFailure = AsyncTypefaceResult.m196constructorimpl(null);
    ...
    public static final class AsyncTypefaceResult {
        ...
        public static final /* synthetic */ AsyncTypefaceResult m195boximpl(Object obj) {
            return new AsyncTypefaceResult(obj);
        }

        /* renamed from: constructor-impl, reason: not valid java name */
        public static Object m196constructorimpl(Object obj) {
            return obj;
        }

        /* renamed from: equals-impl, reason: not valid java name */
        public static boolean m197equalsimpl(Object obj, Object obj2) {
            return (obj2 instanceof AsyncTypefaceResult) && Intrinsics.areEqual(obj, ((AsyncTypefaceResult) obj2).m202unboximpl());
        }

        /* renamed from: equals-impl0, reason: not valid java name */
        public static final boolean m198equalsimpl0(Object obj, Object obj2) {
            return Intrinsics.areEqual(obj, obj2);
        }

        /* renamed from: hashCode-impl, reason: not valid java name */
        public static int m199hashCodeimpl(Object obj) {
            if (obj == null) {
                return 0;
            }
            return obj.hashCode();
        ...
        public static String m201toStringimpl(Object obj) {
            return "AsyncTypefaceResult(result=" + obj + ')';
        }

        public boolean equals(Object obj) {
            return m197equalsimpl(this.result, obj);
        }

        public int hashCode() {
            return m199hashCodeimpl(this.result);
        }

        public String toString() {
            return m201toStringimpl(this.result);
        }

        /* renamed from: unbox-impl, reason: not valid java name */
        public final /* synthetic */ Object m202unboximpl() {
            return this.result;
        }
        ...
        public static final boolean m200isPermanentFailureimpl(Object arg0) {
            return arg0 == null;
        }
    }
    ...
    public final void put(Font font, PlatformFontLoader platformFontLoader, Object result, boolean forever) {
        ...
        synchronized (lock$iv) {
            try {
                if (result == null) {
                    this.permanentCache.put(key, AsyncTypefaceResult.m195boximpl(this.PermanentFailure));
                } else if (forever) {
                    this.permanentCache.put(key, AsyncTypefaceResult.m195boximpl(AsyncTypefaceResult.m196constructorimpl(result)));
                } else {
                    this.resultCache.put(key, AsyncTypefaceResult.m195boximpl(AsyncTypefaceResult.m196constructorimpl(result)));
                }
            } catch (Throwable th) {
                throw th;
            }
    ...
    public final AsyncTypefaceResult m194get1ASDuI8(Font font, PlatformFontLoader platformFontLoader) {
    ...
    */
    public final java.lang.Object runCached(androidx.compose.ui.text.font.Font r8, androidx.compose.ui.text.font.PlatformFontLoader r9, boolean r10, kotlin.jvm.functions.Function1<? super kotlin.coroutines.Continuation<java.lang.Object>, ? extends java.lang.Object> r11, kotlin.coroutines.Continuation<java.lang.Object> r12) {
        ...
        L63:
            if (r5 == 0) goto L6b
            java.lang.Object r9 = r5.m202unboximpl()     // Catch: java.lang.Throwable -> Lbd
            monitor-exit(r8)
            return r9
        L6b:
        ...
        L7f:
            ...
            androidx.compose.ui.text.font.AsyncTypefaceCache$AsyncTypefaceResult r11 = androidx.compose.ui.text.font.AsyncTypefaceCache.AsyncTypefaceResult.m195boximpl(r11)     // Catch: java.lang.Throwable -> L95
        ...
        L97:
            if (r10 == 0) goto La8
            androidx.compose.ui.text.caches.SimpleArrayMap<androidx.compose.ui.text.font.AsyncTypefaceCache$Key, androidx.compose.ui.text.font.AsyncTypefaceCache$AsyncTypefaceResult> r10 = r2.permanentCache     // Catch: java.lang.Throwable -> L95
            java.lang.Object r6 = androidx.compose.ui.text.font.AsyncTypefaceCache.AsyncTypefaceResult.m196constructorimpl(r11)     // Catch: java.lang.Throwable -> L95
            androidx.compose.ui.text.font.AsyncTypefaceCache$AsyncTypefaceResult r6 = androidx.compose.ui.text.font.AsyncTypefaceCache.AsyncTypefaceResult.m195boximpl(r6)     // Catch: java.lang.Throwable -> L95
    ...
    public final Object runCachedBlocking(Font font, PlatformFontLoader platformFontLoader, Function0<? extends Object> block) {
        ...
        synchronized (lock$iv) {
            try {
                ...
                if (priorResult != null) {
                    Object m202unboximpl = priorResult.m202unboximpl();
                    InlineMarker.finallyStart(2);
                    InlineMarker.finallyEnd(2);
                    return m202unboximpl;
                }
