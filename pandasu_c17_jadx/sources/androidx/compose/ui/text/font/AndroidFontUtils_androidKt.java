...
public final class AndroidFontUtils_androidKt {
    ...
    public static final int m192getAndroidTypefaceStyleFO1MlWM(FontWeight fontWeight, int fontStyle) {
        Intrinsics.checkNotNullParameter(fontWeight, "fontWeight");
        boolean isBold = fontWeight.compareTo(getAndroidBold(FontWeight.INSTANCE)) >= 0;
        boolean isItalic = FontStyle.m238equalsimpl0(fontStyle, FontStyle.INSTANCE.m242getItalic_LCdwA());
