...
public final class FontLoadingStrategy {
    ...
    private static final int Blocking = m223constructorimpl(0);
    private static final int OptionalLocal = m223constructorimpl(1);
    private static final int Async = m223constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ FontLoadingStrategy m222boximpl(int i) {
    ...
    public static boolean m224equalsimpl(int i, Object obj) {
        return (obj instanceof FontLoadingStrategy) && i == ((FontLoadingStrategy) obj).m228unboximpl();
    }
    ...
    public static String m227toStringimpl(int arg0) {
        return m225equalsimpl0(arg0, Blocking) ? "Blocking" : m225equalsimpl0(arg0, OptionalLocal) ? "Optional" : m225equalsimpl0(arg0, Async) ? "Async" : "Invalid(value=" + arg0 + ')';
    }
    ...
    public static final class Companion {
        ...
        public final int m230getBlockingPKNRLFQ() {
            return FontLoadingStrategy.Blocking;
        }

        /* renamed from: getOptionalLocal-PKNRLFQ, reason: not valid java name */
        public final int m231getOptionalLocalPKNRLFQ() {
            return FontLoadingStrategy.OptionalLocal;
        }

        /* renamed from: getAsync-PKNRLFQ, reason: not valid java name */
        public final int m229getAsyncPKNRLFQ() {
