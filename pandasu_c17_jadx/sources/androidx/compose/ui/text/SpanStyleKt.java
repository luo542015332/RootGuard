...
public final class SpanStyleKt {
    ...
    public static final long m107lerpTextUnitInheritableC3pnCVY(long a, long b, float t) {
        if (TextUnitKt.m847isUnspecifiedR2X_6o(a) || TextUnitKt.m847isUnspecifiedR2X_6o(b)) {
            return ((TextUnit) lerpDiscrete(TextUnit.m819boximpl(a), TextUnit.m819boximpl(b), t)).getPackedValue();
        }
        return TextUnitKt.m849lerpC3pnCVY(a, b, t);
    }
    ...
    public static final SpanStyle lerp(SpanStyle start, SpanStyle stop, float fraction) {
        ...
        long m107lerpTextUnitInheritableC3pnCVY = m107lerpTextUnitInheritableC3pnCVY(start.getFontSize(), stop.getFontSize(), fraction);
        ...
        long m107lerpTextUnitInheritableC3pnCVY2 = m107lerpTextUnitInheritableC3pnCVY(start.getLetterSpacing(), stop.getLetterSpacing(), fraction);
        BaselineShift baselineShift = start.getBaselineShift();
        float m405unboximpl = baselineShift != null ? baselineShift.m405unboximpl() : BaselineShift.m400constructorimpl(0.0f);
        BaselineShift baselineShift2 = stop.getBaselineShift();
        float m412lerpjWV1Mfo = BaselineShiftKt.m412lerpjWV1Mfo(m405unboximpl, baselineShift2 != null ? baselineShift2.m405unboximpl() : BaselineShift.m400constructorimpl(0.0f), fraction);
        ...
        long j = ColorKt.lerp-jxsXWHM(start.getBackground(), stop.getBackground(), fraction);
        ...
        return new SpanStyle(lerp, m107lerpTextUnitInheritableC3pnCVY, lerp2, fontStyle, fontSynthesis, fontFamily, str, m107lerpTextUnitInheritableC3pnCVY2, BaselineShift.m399boximpl(m412lerpjWV1Mfo), lerp3, localeList, j, textDecoration, ShadowKt.lerp(shadow, shadow2, fraction), lerpPlatformStyle(start.getPlatformStyle(), stop.getPlatformStyle(), fraction), (DrawStyle) lerpDiscrete(start.getDrawStyle(), stop.getDrawStyle(), fraction), (DefaultConstructorMarker) null);
    }
    ...
    public static final SpanStyle resolveSpanStyleDefaults(SpanStyle style) {
        ...
        TextForegroundStyle takeOrElse = style.getTextForegroundStyle().takeOrElse(new Function0<TextForegroundStyle>() { // from class: androidx.compose.ui.text.SpanStyleKt$resolveSpanStyleDefaults$1
            ...
            public final TextForegroundStyle invoke() {
                ...
                return companion.m525from8_81llA(j);
            }
        });
        long fontSize = TextUnitKt.m847isUnspecifiedR2X_6o(style.getFontSize()) ? DefaultFontSize : style.getFontSize();
        ...
        FontSynthesis m244boximpl = FontSynthesis.m244boximpl(fontSynthesis != null ? fontSynthesis.getValue() : FontSynthesis.INSTANCE.m253getAllGVVA2EU());
        ...
        if (TextUnitKt.m847isUnspecifiedR2X_6o(style.getLetterSpacing())) {
            letterSpacing = DefaultLetterSpacing;
        } else {
            letterSpacing = style.getLetterSpacing();
        }
        BaselineShift baselineShift = style.getBaselineShift();
        BaselineShift m399boximpl = BaselineShift.m399boximpl(baselineShift != null ? baselineShift.m405unboximpl() : BaselineShift.INSTANCE.m409getNoney9eOQZs());
        ...
        long j = ($this$takeOrElse_u2dDxMtmZc$iv > Color.Companion.getUnspecified-0d7_KjU() ? 1 : ($this$takeOrElse_u2dDxMtmZc$iv == Color.Companion.getUnspecified-0d7_KjU() ? 0 : -1)) != 0 ? $this$takeOrElse_u2dDxMtmZc$iv : DefaultBackgroundColor;
        ...
        return new SpanStyle(takeOrElse, fontSize, fontWeight2, m235boximpl, m244boximpl, fontFamily2, str, letterSpacing, m399boximpl, textGeometricTransform2, localeList2, j, textDecoration2, shadow2, platformStyle, drawStyle, (DefaultConstructorMarker) null);
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:67:0x0059, code lost:
        ...
        if (r40 == androidx.compose.ui.graphics.Color.Companion.getUnspecified-0d7_KjU()) goto L13;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:71:0x006d, code lost:
        ...
        if (androidx.compose.ui.graphics.Color.equals-impl0(r40, r39.getTextForegroundStyle().mo413getColor0d7_KjU()) == false) goto L18;
     */
