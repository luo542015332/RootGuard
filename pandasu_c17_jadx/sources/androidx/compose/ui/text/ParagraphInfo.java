...
public final /* data */ class ParagraphInfo {
    ...
    public final long m39toLocalMKHz9U(long $this$toLocal_u2dMK_u2dHz9U) {
        return OffsetKt.Offset(Offset.getX-impl($this$toLocal_u2dMK_u2dHz9U), Offset.getY-impl($this$toLocal_u2dMK_u2dHz9U) - this.top);
    }

    public final Rect toGlobal(Rect $this$toGlobal) {
        Intrinsics.checkNotNullParameter($this$toGlobal, "<this>");
        return $this$toGlobal.translate-k-4lQ0M(OffsetKt.Offset(0.0f, this.top));
    }

    public final Path toGlobal(Path $this$toGlobal) {
        Intrinsics.checkNotNullParameter($this$toGlobal, "<this>");
        $this$toGlobal.translate-k-4lQ0M(OffsetKt.Offset(0.0f, this.top));
        return $this$toGlobal;
    }

    /* renamed from: toGlobal-GEjPoXI, reason: not valid java name */
    public final long m38toGlobalGEjPoXI(long $this$toGlobal_u2dGEjPoXI) {
        return TextRangeKt.TextRange(toGlobalIndex(TextRange.m142getStartimpl($this$toGlobal_u2dGEjPoXI)), toGlobalIndex(TextRange.m137getEndimpl($this$toGlobal_u2dGEjPoXI)));
    }
}
