...
public final class Placeholder {
    ...
    private Placeholder(long width, long height, int placeholderVerticalAlign) {
        ...
        if (!(!TextUnitKt.m847isUnspecifiedR2X_6o(width))) {
            throw new IllegalArgumentException("width cannot be TextUnit.Unspecified".toString());
        }
        if (!(!TextUnitKt.m847isUnspecifiedR2X_6o(height))) {
    ...
    public final Placeholder m62copyK8Q__8(long width, long height, int placeholderVerticalAlign) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof Placeholder) && TextUnit.m826equalsimpl0(this.width, ((Placeholder) other).width) && TextUnit.m826equalsimpl0(this.height, ((Placeholder) other).height) && PlaceholderVerticalAlign.m69equalsimpl0(this.placeholderVerticalAlign, ((Placeholder) other).placeholderVerticalAlign);
    }

    public int hashCode() {
        int result = TextUnit.m830hashCodeimpl(this.width);
        return (((result * 31) + TextUnit.m830hashCodeimpl(this.height)) * 31) + PlaceholderVerticalAlign.m70hashCodeimpl(this.placeholderVerticalAlign);
    }

    public String toString() {
        return "Placeholder(width=" + ((Object) TextUnit.m836toStringimpl(this.width)) + ", height=" + ((Object) TextUnit.m836toStringimpl(this.height)) + ", placeholderVerticalAlign=" + ((Object) PlaceholderVerticalAlign.m71toStringimpl(this.placeholderVerticalAlign)) + ')';
    }
}
