...
public final class AndroidMultiParagraphDrawKt {
    ...
    public static final void m366drawMultiParagraph7AXcY_I(MultiParagraph drawMultiParagraph, Canvas canvas, Brush brush, float alpha, Shadow shadow, TextDecoration decoration, DrawStyle drawStyle, int blendMode) {
        Intrinsics.checkNotNullParameter(drawMultiParagraph, "$this$drawMultiParagraph");
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        Intrinsics.checkNotNullParameter(brush, "brush");
        canvas.save();
        if (drawMultiParagraph.getParagraphInfoList$ui_text_release().size() <= 1) {
            m368drawParagraphs7AXcY_I(drawMultiParagraph, canvas, brush, alpha, shadow, decoration, drawStyle, blendMode);
            ...
            Shader shader = ((ShaderBrush) brush).createShader-uvyYCjk(SizeKt.Size(width, height));
            ...
            for (int size2 = $this$fastForEach$iv2.size(); index$iv2 < size2; size2 = size2) {
                ...
                it2.getParagraph().mo6painthn5TExg(canvas, (Brush) BrushKt.ShaderBrush(shader), alpha, shadow, decoration, drawStyle, blendMode);
    ...
    private static final void m368drawParagraphs7AXcY_I(MultiParagraph $this$drawParagraphs_u2d7AXcY_I, Canvas canvas, Brush brush, float alpha, Shadow shadow, TextDecoration decoration, DrawStyle drawStyle, int blendMode) {
        List $this$fastForEach$iv = $this$drawParagraphs_u2d7AXcY_I.getParagraphInfoList$ui_text_release();
        int size = $this$fastForEach$iv.size();
        for (int index$iv = 0; index$iv < size; index$iv++) {
            Object item$iv = $this$fastForEach$iv.get(index$iv);
            ParagraphInfo it = (ParagraphInfo) item$iv;
            it.getParagraph().mo6painthn5TExg(canvas, brush, alpha, shadow, decoration, drawStyle, blendMode);
