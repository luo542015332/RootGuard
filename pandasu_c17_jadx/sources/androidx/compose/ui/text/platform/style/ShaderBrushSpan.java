...
public final class ShaderBrushSpan extends CharacterStyle implements UpdateAppearance {
    ...
    public final void m398setSizeuvyYCjk(long j) {
        this.size = j;
    }
    ...
    public void updateDrawState(TextPaint textPaint) {
        ...
        if ($this$isUnspecified$iv == Size.Companion.getUnspecified-NH-jbRc()) {
            return;
        }
        Pair finalCachedShader = this.cachedShader;
        if (finalCachedShader == null || !Size.equals-impl0(finalCachedShader.getFirst().unbox-impl(), this.size)) {
            shader = this.shaderBrush.createShader-uvyYCjk(this.size);
        } else {
