...
public final class AndroidParagraph implements Paragraph {
    ...
    private AndroidParagraph(AndroidParagraphIntrinsics paragraphIntrinsics, int maxLines, boolean ellipsis, long constraints) {
        ...
        if (!(Constraints.m593getMinHeightimpl(constraints) == 0 && Constraints.m594getMinWidthimpl(constraints) == 0)) {
        ...
        int alignment = AndroidParagraph_androidKt.m7access$toLayoutAlignAMY3VfE(style.m171getTextAlignbuA522U());
        TextAlign m171getTextAlignbuA522U = style.m171getTextAlignbuA522U();
        int justificationMode = m171getTextAlignbuA522U == null ? false : TextAlign.m502equalsimpl0(m171getTextAlignbuA522U.getValue(), TextAlign.INSTANCE.m508getJustifye0LSkKk()) ? 1 : 0;
        int hyphens = AndroidParagraph_androidKt.m9access$toLayoutHyphenationFrequency0_XeFpE(style.getParagraphStyle().getHyphens());
        LineBreak m169getLineBreakLgCVezo = style.m169getLineBreakLgCVezo();
        int breakStrategy = AndroidParagraph_androidKt.m8access$toLayoutBreakStrategyu6PBz3U(m169getLineBreakLgCVezo != null ? LineBreak.Strategy.m443boximpl(LineBreak.m434getStrategyfcGXIks(m169getLineBreakLgCVezo.getMask())) : null);
        LineBreak m169getLineBreakLgCVezo2 = style.m169getLineBreakLgCVezo();
        int lineBreakStyle = AndroidParagraph_androidKt.m10access$toLayoutLineBreakStyle4a2g8L8(m169getLineBreakLgCVezo2 != null ? LineBreak.Strictness.m453boximpl(LineBreak.m435getStrictnessusljTpc(m169getLineBreakLgCVezo2.getMask())) : null);
        LineBreak m169getLineBreakLgCVezo3 = style.m169getLineBreakLgCVezo();
        int lineBreakWordStyle = AndroidParagraph_androidKt.m11access$toLayoutLineBreakWordStylegvcdTPQ(m169getLineBreakLgCVezo3 != null ? LineBreak.WordBreak.m464boximpl(LineBreak.m436getWordBreakjp8hJ3c(m169getLineBreakLgCVezo3.getMask())) : null);
        if (ellipsis) {
        ...
        if (!ellipsis || firstLayout.getHeight() <= Constraints.m591getMaxHeightimpl(constraints) || maxLines <= 1) {
            i = 0;
            this.layout = firstLayout;
        } else {
            int calculatedMaxLines = AndroidParagraph_androidKt.access$numberOfLinesThatFitMaxHeight(firstLayout, Constraints.m591getMaxHeightimpl(constraints));
        ...
        getTextPaint$ui_text_release().m378setBrush12SF9DM(style.getBrush(), SizeKt.Size(getWidth(), getHeight()), style.getAlpha());
        ShaderBrushSpan[] shaderBrushSpans = getShaderBrushSpans(this.layout);
        int length = shaderBrushSpans.length;
        for (int i3 = i; i3 < length; i3++) {
            shaderBrushSpans[i3].m398setSizeuvyYCjk(SizeKt.Size(getWidth(), getHeight()));
        }
    ...
    public float getWidth() {
        return Constraints.m592getMaxWidthimpl(this.constraints);
    }
    ...
    public int mo2getOffsetForPositionk4lQ0M(long position) {
        int line = this.layout.getLineForVertical((int) Offset.getY-impl(position));
        return this.layout.getOffsetForHorizontal(line, Offset.getX-impl(position));
    }
    ...
    public final void m0fillBoundingBoxes8ffj60Q(long range, float[] array, int arrayStart) {
        Intrinsics.checkNotNullParameter(array, "array");
        this.layout.fillBoundingBoxes(TextRange.m140getMinimpl(range), TextRange.m139getMaximpl(range), array, arrayStart);
    }
    ...
    public long mo3getWordBoundaryjx7JFs(int offset) {
    ...
    public void mo5paintRPmYEkk(Canvas canvas, long color, Shadow shadow, TextDecoration textDecoration) {
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        AndroidTextPaint $this$paint_RPmYEkk_u24lambda_u248 = getTextPaint$ui_text_release();
        $this$paint_RPmYEkk_u24lambda_u248.m379setColor8_81llA(color);
    ...
    public void mo4paintLG529CI(Canvas canvas, long color, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int blendMode) {
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        int currBlendMode = getTextPaint$ui_text_release().m376getBlendMode0nO6VwU();
        AndroidTextPaint $this$paint_LG529CI_u24lambda_u249 = getTextPaint$ui_text_release();
        $this$paint_LG529CI_u24lambda_u249.m379setColor8_81llA(color);
        ...
        $this$paint_LG529CI_u24lambda_u249.m377setBlendModes9anfk8(blendMode);
        paint(canvas);
        getTextPaint$ui_text_release().m377setBlendModes9anfk8(currBlendMode);
    }

    @Override // androidx.compose.ui.text.Paragraph
    /* renamed from: paint-hn5TExg, reason: not valid java name */
    public void mo6painthn5TExg(Canvas canvas, Brush brush, float alpha, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int blendMode) {
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        Intrinsics.checkNotNullParameter(brush, "brush");
        int currBlendMode = getTextPaint$ui_text_release().m376getBlendMode0nO6VwU();
        AndroidTextPaint $this$paint_hn5TExg_u24lambda_u2410 = getTextPaint$ui_text_release();
        $this$paint_hn5TExg_u24lambda_u2410.m378setBrush12SF9DM(brush, SizeKt.Size(getWidth(), getHeight()), alpha);
        ...
        $this$paint_hn5TExg_u24lambda_u2410.m377setBlendModes9anfk8(blendMode);
        paint(canvas);
        getTextPaint$ui_text_release().m377setBlendModes9anfk8(currBlendMode);
    }
