    ...
    public TextInputServiceAndroid(View view, InputMethodManager inputMethodManager, PlatformTextInput platformTextInput, Executor inputCommandProcessorExecutor) {
        ...
        this.onImeActionPerformed = new Function1<ImeAction, Unit>() { // from class: androidx.compose.ui.text.input.TextInputServiceAndroid$onImeActionPerformed$1
            ...
            public /* bridge */ /* synthetic */ Unit invoke(ImeAction imeAction) {
                m362invokeKlQnJC8(imeAction.getValue());
                return Unit.INSTANCE;
            }

            /* renamed from: invoke-KlQnJC8, reason: not valid java name */
            public final void m362invokeKlQnJC8(int it) {
            }
        };
        this.state = new TextFieldValue("", TextRange.INSTANCE.m147getZerod9O1mEE(), (TextRange) null, 4, (DefaultConstructorMarker) null);
    ...
    */
    ...
    public final InputConnection createInputConnection(EditorInfo outAttrs) {
        ...
        RecordingInputConnection it = new RecordingInputConnection(this.state, new InputEventCallback2() { // from class: androidx.compose.ui.text.input.TextInputServiceAndroid$createInputConnection$1
            ...
            public void mo315onImeActionKlQnJC8(int imeAction) {
                Function1 function1;
                function1 = TextInputServiceAndroid.this.onImeActionPerformed;
                function1.invoke(ImeAction.m286boximpl(imeAction));
            }
    ...
    public void stopInput() {
        ...
        this.onImeActionPerformed = new Function1<ImeAction, Unit>() { // from class: androidx.compose.ui.text.input.TextInputServiceAndroid$stopInput$2
            @Override // kotlin.jvm.functions.Function1
            public /* bridge */ /* synthetic */ Unit invoke(ImeAction imeAction) {
                m363invokeKlQnJC8(imeAction.getValue());
                return Unit.INSTANCE;
            }

            /* renamed from: invoke-KlQnJC8, reason: not valid java name */
            public final void m363invokeKlQnJC8(int it) {
            }
        };
    ...
    public void updateState(TextFieldValue oldValue, TextFieldValue newValue) {
        ...
        boolean needUpdateSelection = (TextRange.m135equalsimpl0(this.state.getSelection(), newValue.getSelection()) && Intrinsics.areEqual(this.state.getComposition(), newValue.getComposition())) ? false : true;
        this.state = newValue;
        ...
        if (Intrinsics.areEqual(oldValue, newValue)) {
            if (needUpdateSelection) {
                ...
                int m140getMinimpl = TextRange.m140getMinimpl(newValue.getSelection());
                int m139getMaximpl = TextRange.m139getMaximpl(newValue.getSelection());
                TextRange composition = this.state.getComposition();
                int m140getMinimpl2 = composition != null ? TextRange.m140getMinimpl(composition.getPackedValue()) : -1;
                TextRange composition2 = this.state.getComposition();
                inputMethodManager.updateSelection(m140getMinimpl, m139getMaximpl, m140getMinimpl2, composition2 != null ? TextRange.m139getMaximpl(composition2.getPackedValue()) : -1);
                return;
            }
            return;
        }
        if (oldValue != null && (!Intrinsics.areEqual(oldValue.getText(), newValue.getText()) || (TextRange.m135equalsimpl0(oldValue.getSelection(), newValue.getSelection()) && !Intrinsics.areEqual(oldValue.getComposition(), newValue.getComposition())))) {
            restartInput = true;
        }
        if (restartInput) {
            restartInputImmediately();
