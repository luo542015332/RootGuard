...
public final class ImeOptions {
    ...
    public /* synthetic */ ImeOptions(boolean z, int i, boolean z2, int i2, int i3, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? false : z, (i4 & 2) != 0 ? KeyboardCapitalization.INSTANCE.m328getNoneIUNYP9k() : i, (i4 & 4) != 0 ? true : z2, (i4 & 8) != 0 ? KeyboardType.INSTANCE.m354getTextPjHm6EE() : i2, (i4 & 16) != 0 ? ImeAction.INSTANCE.m301getDefaulteUduSuo() : i3, null);
    }
    ...
    public static /* synthetic */ ImeOptions m309copyuxg59PA$default(ImeOptions imeOptions, boolean z, int i, boolean z2, int i2, int i3, int i4, Object obj) {
        if ((i4 & 1) != 0) {
            z = imeOptions.singleLine;
        }
        return imeOptions.m310copyuxg59PA(z, (i4 & 2) != 0 ? imeOptions.capitalization : i, (i4 & 4) != 0 ? imeOptions.autoCorrect : z2, (i4 & 8) != 0 ? imeOptions.keyboardType : i2, (i4 & 16) != 0 ? imeOptions.imeAction : i3);
    }

    /* renamed from: copy-uxg59PA, reason: not valid java name */
    public final ImeOptions m310copyuxg59PA(boolean singleLine, int capitalization, boolean autoCorrect, int keyboardType, int imeAction) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof ImeOptions) && this.singleLine == ((ImeOptions) other).singleLine && KeyboardCapitalization.m319equalsimpl0(this.capitalization, ((ImeOptions) other).capitalization) && this.autoCorrect == ((ImeOptions) other).autoCorrect && KeyboardType.m334equalsimpl0(this.keyboardType, ((ImeOptions) other).keyboardType) && ImeAction.m289equalsimpl0(this.imeAction, ((ImeOptions) other).imeAction);
    }

    public int hashCode() {
        int result = Boolean.hashCode(this.singleLine);
        return (((((((result * 31) + KeyboardCapitalization.m320hashCodeimpl(this.capitalization)) * 31) + Boolean.hashCode(this.autoCorrect)) * 31) + KeyboardType.m335hashCodeimpl(this.keyboardType)) * 31) + ImeAction.m290hashCodeimpl(this.imeAction);
    }

    public String toString() {
        return "ImeOptions(singleLine=" + this.singleLine + ", capitalization=" + ((Object) KeyboardCapitalization.m321toStringimpl(this.capitalization)) + ", autoCorrect=" + this.autoCorrect + ", keyboardType=" + ((Object) KeyboardType.m336toStringimpl(this.keyboardType)) + ", imeAction=" + ((Object) ImeAction.m291toStringimpl(this.imeAction)) + ')';
    }
}
