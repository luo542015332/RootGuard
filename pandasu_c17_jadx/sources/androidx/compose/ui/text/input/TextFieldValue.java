...
public final class TextFieldValue {
    ...
    private static final Saver<TextFieldValue, Object> Saver = SaverKt.Saver(new Function2<SaverScope, TextFieldValue, Object>() { // from class: androidx.compose.ui.text.input.TextFieldValue$Companion$Saver$1
        ...
        public final Object invoke(SaverScope Saver2, TextFieldValue it) {
            ...
            return CollectionsKt.arrayListOf(SaversKt.save(it.getText(), SaversKt.getAnnotatedStringSaver(), Saver2), SaversKt.save(TextRange.m130boximpl(it.getSelection()), SaversKt.getSaver(TextRange.INSTANCE), Saver2));
        }
        ...
        public final TextFieldValue invoke(Object it) {
            ...
            if (Intrinsics.areEqual(value$iv, (Object) false)) {
                ...
                annotatedString = value$iv != null ? (AnnotatedString) saver$iv.restore(value$iv) : null;
            }
            ...
            if (!Intrinsics.areEqual(value$iv2, (Object) false) && value$iv2 != null) {
                textRange = (TextRange) saver$iv2.restore(value$iv2);
            }
    ...
    private TextFieldValue(AnnotatedString annotatedString, long selection, TextRange composition) {
        ...
        this.selection = TextRangeKt.m148coerceIn8ffj60Q(selection, 0, getText().length());
        this.composition = composition != null ? TextRange.m130boximpl(TextRangeKt.m148coerceIn8ffj60Q(composition.getPackedValue(), 0, getText().length())) : null;
    }
    ...
    */
    ...
    public /* synthetic */ TextFieldValue(String str, long j, TextRange textRange, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? "" : str, (i & 2) != 0 ? TextRange.INSTANCE.m147getZerod9O1mEE() : j, (i & 4) != 0 ? null : textRange, (DefaultConstructorMarker) null);
    }
    ...
    public static /* synthetic */ TextFieldValue m356copy3r_uNRQ$default(TextFieldValue textFieldValue, AnnotatedString annotatedString, long j, TextRange textRange, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return textFieldValue.m358copy3r_uNRQ(annotatedString, j, textRange);
    }

    /* renamed from: copy-3r_uNRQ, reason: not valid java name */
    public final TextFieldValue m358copy3r_uNRQ(AnnotatedString annotatedString, long selection, TextRange composition) {
        Intrinsics.checkNotNullParameter(annotatedString, "annotatedString");
        return new TextFieldValue(annotatedString, selection, composition, (DefaultConstructorMarker) null);
    }

    /* renamed from: copy-3r_uNRQ$default, reason: not valid java name */
    public static /* synthetic */ TextFieldValue m357copy3r_uNRQ$default(TextFieldValue textFieldValue, String str, long j, TextRange textRange, int i, Object obj) {
        if ((i & 2) != 0) {
            j = textFieldValue.selection;
        }
        if ((i & 4) != 0) {
        ...
        return textFieldValue.m359copy3r_uNRQ(str, j, textRange);
    }

    /* renamed from: copy-3r_uNRQ, reason: not valid java name */
    public final TextFieldValue m359copy3r_uNRQ(String text, long selection, TextRange composition) {
        Intrinsics.checkNotNullParameter(text, "text");
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof TextFieldValue) {
            return TextRange.m135equalsimpl0(this.selection, ((TextFieldValue) other).selection) && Intrinsics.areEqual(this.composition, ((TextFieldValue) other).composition) && Intrinsics.areEqual(this.text, ((TextFieldValue) other).text);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        int result2 = ((result * 31) + TextRange.m143hashCodeimpl(this.selection)) * 31;
        TextRange textRange = this.composition;
        return result2 + (textRange != null ? TextRange.m143hashCodeimpl(textRange.getPackedValue()) : 0);
    }

    public String toString() {
        return "TextFieldValue(text='" + ((Object) this.text) + "', selection=" + ((Object) TextRange.m145toStringimpl(this.selection)) + ", composition=" + this.composition + ')';
    }
