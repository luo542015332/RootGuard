...
public final class EditingBuffer {
    ...
    private EditingBuffer(AnnotatedString text, long selection) {
        ...
        this.selectionStart = TextRange.m140getMinimpl(selection);
        this.selectionEnd = TextRange.m139getMaximpl(selection);
        this.compositionStart = -1;
        this.compositionEnd = -1;
        int start = TextRange.m140getMinimpl(selection);
        int end = TextRange.m139getMaximpl(selection);
    ...
    public final TextRange m283getCompositionMzsxiRA$ui_text_release() {
        if (hasComposition$ui_text_release()) {
            return TextRange.m130boximpl(TextRangeKt.TextRange(this.compositionStart, this.compositionEnd));
        }
        return null;
    }

    /* renamed from: getSelection-d9O1mEE$ui_text_release, reason: not valid java name */
    public final long m284getSelectiond9O1mEE$ui_text_release() {
    ...
    public final void delete$ui_text_release(int start, int end) {
        ...
        long newSelection = EditingBufferKt.m285updateRangeAfterDeletepWDy79M(TextRangeKt.TextRange(this.selectionStart, this.selectionEnd), deleteRange);
        setSelectionStart(TextRange.m140getMinimpl(newSelection));
        setSelectionEnd(TextRange.m139getMaximpl(newSelection));
        if (hasComposition$ui_text_release()) {
            long compositionRange = TextRangeKt.TextRange(this.compositionStart, this.compositionEnd);
            long newComposition = EditingBufferKt.m285updateRangeAfterDeletepWDy79M(compositionRange, deleteRange);
            if (TextRange.m136getCollapsedimpl(newComposition)) {
                commitComposition$ui_text_release();
            } else {
                this.compositionStart = TextRange.m140getMinimpl(newComposition);
                this.compositionEnd = TextRange.m139getMaximpl(newComposition);
            }
        }
    }
