...
public abstract class FragmentManager implements FragmentResultOwner {
    ...
    private final Consumer<Configuration> mOnConfigurationChangedListener = new Consumer() { // from class: androidx.fragment.app.FragmentManager$$ExternalSyntheticLambda0
        ...
        public final void accept(Object obj) {
            FragmentManager.this.m942lambda$new$0$androidxfragmentappFragmentManager((Configuration) obj);
        }
    };
    private final Consumer<Integer> mOnTrimMemoryListener = new Consumer() { // from class: androidx.fragment.app.FragmentManager$$ExternalSyntheticLambda1
        @Override // androidx.core.util.Consumer
        public final void accept(Object obj) {
            FragmentManager.this.m943lambda$new$1$androidxfragmentappFragmentManager((Integer) obj);
        }
    };
    private final Consumer<MultiWindowModeChangedInfo> mOnMultiWindowModeChangedListener = new Consumer() { // from class: androidx.fragment.app.FragmentManager$$ExternalSyntheticLambda2
        @Override // androidx.core.util.Consumer
        public final void accept(Object obj) {
            FragmentManager.this.m944lambda$new$2$androidxfragmentappFragmentManager((MultiWindowModeChangedInfo) obj);
        }
    };
    private final Consumer<PictureInPictureModeChangedInfo> mOnPictureInPictureModeChangedListener = new Consumer() { // from class: androidx.fragment.app.FragmentManager$$ExternalSyntheticLambda3
        @Override // androidx.core.util.Consumer
        public final void accept(Object obj) {
            FragmentManager.this.m945lambda$new$3$androidxfragmentappFragmentManager((PictureInPictureModeChangedInfo) obj);
        }
    };
    ...
    public /* synthetic */ void m943lambda$new$1$androidxfragmentappFragmentManager(Integer level) {
    ...
    public /* synthetic */ void m944lambda$new$2$androidxfragmentappFragmentManager(MultiWindowModeChangedInfo info) {
    ...
    public /* synthetic */ void m945lambda$new$3$androidxfragmentappFragmentManager(PictureInPictureModeChangedInfo info) {
    ...
    public Parcelable saveAllState() {
        ...
        Bundle savedState = m941lambda$attachController$4$androidxfragmentappFragmentManager();
    ...
    public Bundle m941lambda$attachController$4$androidxfragmentappFragmentManager() {
        int size;
    ...
    public void attachController(FragmentHostCallback<?> fragmentHostCallback, FragmentContainer container, final Fragment parent) {
        ...
        if ((obj instanceof SavedStateRegistryOwner) && parent == null) {
            ...
            registry.registerSavedStateProvider(SAVED_STATE_TAG, new SavedStateRegistry.SavedStateProvider() { // from class: androidx.fragment.app.FragmentManager$$ExternalSyntheticLambda4
                ...
                public final Bundle saveState() {
                    return FragmentManager.this.m941lambda$attachController$4$androidxfragmentappFragmentManager();
                }
            });
        ...
        if (activityResultRegistryOwner instanceof ActivityResultRegistryOwner) {
            ActivityResultRegistry registry2 = activityResultRegistryOwner.getActivityResultRegistry();
        ...
        ActivityResultRegistry registry3 = this.mHost;
        if (registry3 instanceof OnConfigurationChangedProvider) {
            OnConfigurationChangedProvider onConfigurationChangedProvider = (OnConfigurationChangedProvider) registry3;
        ...
        if (obj2 instanceof OnTrimMemoryProvider) {
            OnTrimMemoryProvider onTrimMemoryProvider = (OnTrimMemoryProvider) obj2;
        ...
        if ((obj5 instanceof MenuHost) && parent == null) {
            ((MenuHost) obj5).addMenuProvider(this.mMenuProvider);
        }
    }
    ...
    public void m942lambda$new$0$androidxfragmentappFragmentManager(Configuration newConfig) {
        for (Fragment f : this.mFragmentStore.getFragments()) {
            if (f != null) {
    ...
    public static class FragmentIntentSenderContract extends ActivityResultContract<IntentSenderRequest, ActivityResult> {
        ...
        public ActivityResult m946parseResult(int resultCode, Intent intent) {
