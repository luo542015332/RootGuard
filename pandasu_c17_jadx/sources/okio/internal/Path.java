...
public final class Path {
    ...
    public static final ByteString getSlash(okio.Path $this$slash) {
        ByteString bytes = $this$slash.getBytes();
        ByteString byteString = SLASH;
        if (ByteString.indexOf$default(bytes, byteString, 0, 2, (Object) null) != -1) {
            return byteString;
        }
        ByteString bytes2 = $this$slash.getBytes();
    ...
    public static final okio.Path toPath(Buffer $this$toPath, boolean normalize) {
        ...
        while (true) {
            if (!$this$toPath.rangeEquals(0L, SLASH)) {
                byteString = BACKSLASH;
                if (!$this$toPath.rangeEquals(0L, byteString)) {
                    break;
                }
            }
        ...
        boolean windowsUncPath = leadingSlashCount >= 2 && Intrinsics.areEqual(slash, byteString);
        long j = -1;
        if (windowsUncPath) {
            ...
            if (slash != null) {
                ...
                byteString2 = limit == -1 ? toSlash(okio.Path.DIRECTORY_SEPARATOR) : toSlash($this$toPath.getByte(limit));
            }
            slash = byteString2;
        ...
        while (!$this$toPath.exhausted()) {
            ...
            if (Intrinsics.areEqual(part, byteString3)) {
                if (!absolute || !canonicalParts.isEmpty()) {
                    if (!normalize || (!absolute && (canonicalParts.isEmpty() || Intrinsics.areEqual(CollectionsKt.last(canonicalParts), byteString3)))) {
