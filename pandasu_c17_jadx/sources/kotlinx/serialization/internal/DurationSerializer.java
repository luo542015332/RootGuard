...
public final class DurationSerializer implements KSerializer<Duration> {
    ...
    public /* bridge */ /* synthetic */ Object deserialize(Decoder decoder) {
        return Duration.m2337boximpl(m2585deserialize5sfh64U(decoder));
    }

    @Override // kotlinx.serialization.SerializationStrategy
    public /* bridge */ /* synthetic */ void serialize(Encoder encoder, Object value) {
        m2586serializeHG0u8IE(encoder, ((Duration) value).getRawValue());
    }
    ...
    public void m2586serializeHG0u8IE(Encoder encoder, long value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        encoder.encodeString(Duration.m2384toIsoStringimpl(value));
    }

    /* renamed from: deserialize-5sfh64U, reason: not valid java name */
    public long m2585deserialize5sfh64U(Decoder decoder) {
        Intrinsics.checkNotNullParameter(decoder, "decoder");
        return Duration.INSTANCE.m2459parseIsoStringUwyO8pc(decoder.decodeString());
    }
}
