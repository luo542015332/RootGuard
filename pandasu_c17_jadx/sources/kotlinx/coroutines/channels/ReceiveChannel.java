...
public interface ReceiveChannel<E> {
    ...
    Object mo2520receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);

    @Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated in favor of 'receiveCatching'. Please note that the provided replacement does not rethrow channel's close cause as 'receiveOrNull' did, for the detailed replacement please refer to the 'receiveOrNull' documentation", replaceWith = @ReplaceWith(expression = "receiveCatching().getOrNull()", imports = {}))
    Object receiveOrNull(Continuation<? super E> continuation);

    /* renamed from: tryReceive-PtdJZtk */
    Object mo2521tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) {
            Object mo2521tryReceivePtdJZtk = receiveChannel.mo2521tryReceivePtdJZtk();
            if (ChannelResult.m2536isSuccessimpl(mo2521tryReceivePtdJZtk)) {
                return (E) ChannelResult.m2532getOrThrowimpl(mo2521tryReceivePtdJZtk);
            }
            Throwable m2530exceptionOrNullimpl = ChannelResult.m2530exceptionOrNullimpl(mo2521tryReceivePtdJZtk);
            if (m2530exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(m2530exceptionOrNullimpl);
        }
        ...
        */
        public static <E> java.lang.Object receiveOrNull(kotlinx.coroutines.channels.ReceiveChannel<? extends E> r3, kotlin.coroutines.Continuation<? super E> r4) {
            ...
            L38:
                ...
                r2 = 1
                r4.label = r2
                java.lang.Object r3 = r3.mo2520receiveCatchingJP2dKIU(r4)
                if (r3 != r1) goto L45
                return r1
            L45:
                java.lang.Object r3 = kotlinx.coroutines.channels.ChannelResult.m2531getOrNullimpl(r3)
                return r3
            */
